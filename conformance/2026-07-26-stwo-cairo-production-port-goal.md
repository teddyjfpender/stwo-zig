...
| Metal execution | process-owned shared runtime, proof-scoped telemetry, strict lifecycle shutdown, and exact all-opcodes parity now use the focused generic Metal PCS path; substantial older SN2 machinery remains outside the product closure | first focused product evidence complete; full-corpus and authenticated-AOT evidence remain |
