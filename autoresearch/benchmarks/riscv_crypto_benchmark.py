...
from autoresearch.benchmarks.riscv_stark_v_benchmark import (  # noqa: E402
    ANSI_RE,
...
from autoresearch.benchmarks.riscv_benchmark_host_contract import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    validate_host_environment(host_environment, "report.host_environment")
    report = {
        "schema": SCHEMA,
