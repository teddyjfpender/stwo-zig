...
root=campaign/'metal-field4-segment9-selected-v2'; root.mkdir()
...
del reference_bytes
exe=repo/'.git/local-ethereum/real-leaf-metal-product-v4/bin/stage101-metal-autoresearch-v1'
if hashlib.sha256(exe.read_bytes()).hexdigest()!='2508075106915ff951ee685849283b9d5e75cd8043c8d72ad8abbf2441e88dcd':raise SystemExit('Frozen Metal v4 executable identity changed')
