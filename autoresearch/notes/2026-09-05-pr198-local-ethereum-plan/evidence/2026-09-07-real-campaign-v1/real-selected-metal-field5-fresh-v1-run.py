...
produced = base / 'metal-field5-segment9-selected-v2'
exe = repo / '.git/local-ethereum/fixed-program-native-verifier-v1/bin/ethereum-full-leaf-bundle-verify-v1'
out = repo / '.git/local-ethereum/selected-real-metal-field5-fresh-v1'
