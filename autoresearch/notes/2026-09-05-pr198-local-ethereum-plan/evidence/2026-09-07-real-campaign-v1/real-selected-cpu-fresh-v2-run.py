...
repo=pathlib.Path.cwd();out=repo/".git/local-ethereum/selected-real-cpu-leaf-fresh-v2"
base=repo/".git/local-ethereum/retained-campaign-v2-rw-heap-121x2097152-20260907"
exe=out/"verifier.bin"
proof=base/"cpu-field4-segment9-selected-v5/segment-000009.stwief04"
