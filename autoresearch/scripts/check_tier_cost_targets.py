...
Wiring: an owner-installed autoresearch workflow may run
``python3 -m unittest discover -s autoresearch/tests``. Production CI does not
import this research policy.
Run it directly with::

    python3 autoresearch/scripts/check_tier_cost_targets.py
    python3 autoresearch/scripts/check_tier_cost_targets.py --report /tmp/tier-costs.json
"""
