...
out=Path('/tmp/pr198-shared-tracker-ladder-20260918-v1');out.mkdir(exist_ok=False)
products={b:Path('/tmp/pr198-product-'+b+'-shared-tracker-20260918-v1') for b in ['cpu','metal']}
