...
class RecursionOwnershipTest(unittest.TestCase):
    ...
    def test_canonical_poseidon_identity_has_only_equation_and_core_dependencies(self) -> None:
        root = Path(__file__).resolve().parents[2]
        files = (
