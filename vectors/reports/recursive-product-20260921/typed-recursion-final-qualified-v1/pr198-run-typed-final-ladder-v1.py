...
out=Path('/tmp/pr198-typed-final-ladder-20260921-v1');out.mkdir(exist_ok=False)
products={b:Path('/tmp/pr198-product-'+b+'-typed-final-20260921-v1') for b in ['cpu','metal']}
