...
-- 64 columns, 341 nodes, 78 constraint roots, 16 lookups.
def loadStoreCircuit : MulhCircuit where
  ...
  constraints := [
    ...
    274, 276, 277, 278, 279, 104, 326, 328,
    330, 332, 334, 336, 338, 340
  ]
  lookups := [
    { domain := .programAccess, role := .request,
      numerator := 293, tuple := [1, 316, 12, 32, 33] }, -- lookup 0
    { domain := .registersState, role := .consumed,
      numerator := 293, tuple := [1, 0] }, -- lookup 1
    { domain := .registersState, role := .emitted,
      numerator := 63, tuple := [317, 318] }, -- lookup 2
    { domain := .memoryAccess, role := .consumed,
      numerator := 293, tuple := [70, 12, 17, 13, 14, 15, 16] }, -- lookup 3
    { domain := .memoryAccess, role := .emitted,
      numerator := 63, tuple := [70, 12, 284, 18, 19, 20, 21] }, -- lookup 4
    { domain := .rangeCheck20, role := .request,
      numerator := 293, tuple := [286] }, -- lookup 5
    { domain := .rangeCheck20, role := .request,
      numerator := 293, tuple := [103] }, -- lookup 6
    { domain := .rangeCheckM31, role := .request,
      numerator := 293, tuple := [18, 21] }, -- lookup 7
    { domain := .memoryAccess, role := .consumed,
      numerator := 293, tuple := [88, 36, 27, 23, 24, 25, 26] }, -- lookup 8
    { domain := .memoryAccess, role := .emitted,
      numerator := 63, tuple := [88, 36, 287, 28, 29, 30, 31] }, -- lookup 9
    { domain := .rangeCheck20, role := .request,
      numerator := 293, tuple := [289] }, -- lookup 10
    { domain := .memoryAccess, role := .consumed,
      numerator := 293, tuple := [69, 37, 7, 3, 4, 5, 6] }, -- lookup 11
    { domain := .memoryAccess, role := .emitted,
      numerator := 63, tuple := [69, 37, 290, 8, 9, 10, 11] }, -- lookup 12
    { domain := .rangeCheck20, role := .request,
      numerator := 293, tuple := [292] }, -- lookup 13
    { domain := .rangeCheckM31, role := .request,
      numerator := 323, tuple := [70, 321] }, -- lookup 14
    { domain := .rangeCheckM31, role := .request,
      numerator := 324, tuple := [70, 322] } -- lookup 15
  ]
...
#guard loadStoreCircuit.nodes.length == 341
#guard loadStoreCircuit.constraints.length == 78
