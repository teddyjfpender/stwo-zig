...
pub const LogupError = @import("logup_equations.zig").LogupError;

pub const liftPoint = @import("logup_equations.zig").liftPoint;
pub const prevRowPoint = @import("logup_equations.zig").prevRowPoint;

/// One pairs-batched row: the fraction n1/d1 + n2/d2. Single-fraction rows
/// set `n2 = 0, d2 = 1`.
pub const RowPairFor = @import("logup_equations.zig").RowPairFor;
pub const RowPair = @import("logup_equations.zig").RowPair;
...
pub const pairConstraint = @import("logup_equations.zig").pairConstraint;
...
pub const pairConstraintGeneric = @import("logup_equations.zig").pairConstraintGeneric;
