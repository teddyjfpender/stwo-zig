//! Canonical fixed polynomial shell for typed Poseidon2 materialization layouts.
//! Callers insert admitted equality roots between this prefix and suffix.
//! Historical scope and digest identities remain unchanged for compatibility.
