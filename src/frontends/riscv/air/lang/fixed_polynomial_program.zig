//! Validated fixed polynomial programs independent of materialization selection.
//! Stable committed-column roles and ordered prefix/suffix roots are shared by
//! production lowering and cost analysis. Fixed nodes are not witness definitions.
