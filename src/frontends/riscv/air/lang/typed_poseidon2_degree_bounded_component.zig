//! Candidate-native degree-six Poseidon2 component.
//!
//! This is an append-only proof component for the 161-column degree-six
...
pub const PROFILE = candidate_mod.Profile.degree6;
pub const MAIN_COLUMNS: usize = 161;
pub const INTERACTION_COLUMNS: usize = candidate_mod.INTERACTION_COLUMNS;
pub const PERMUTATION_CONSTRAINTS: usize = 146;
...
pub const QUOTIENT_EXPANSION_BITS: u32 = 3;
pub const COMPOSITION_LOG_SPLIT: u32 = PROFILE.compositionLogSplit();
pub const MAX_DIRECT_NODES: usize = 2_608;
...
const prepared_impl = @import("typed_poseidon2_degree_bounded_prepared_domain.zig").Namespace(.{
    .std = std,
    .M31 = M31,
    .QM31 = QM31,
...
comptime {
    ...
    {
        @compileError("degree-six Poseidon component geometry drifted");
    }
}
