//! Canonical hash-consed direct-polynomial graph shared by execution and analysis.
//! Node creation and root folding are distinct ordered events. Structural counts
//! describe this graph; no cost policy, search result or proposal is admitted here.
