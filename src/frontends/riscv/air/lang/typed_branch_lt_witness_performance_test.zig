//! ReleaseFast paired throughput and scaling admission for BRANCH_LT.
...
test "typed BRANCH_LT hot rows retain paired legacy throughput and scaling" {
    ...
    for (log_rows, 0..) |log_size, case_index| {
        ...
        std.debug.print(
            "\n  typed BRANCH_LT log_rows={d}: generated={d} ns " ++
