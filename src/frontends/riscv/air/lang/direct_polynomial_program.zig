//! Owned typed-to-direct polynomial lowering shared by production and tooling.
//! Caller-admitted equality cuts and fixed roots lower into one hash-consed graph.
//! Root order, repeated uses and semantic-to-physical column bindings are exact.
//! This compiler does not select cuts or consume experimental proposal artifacts.
