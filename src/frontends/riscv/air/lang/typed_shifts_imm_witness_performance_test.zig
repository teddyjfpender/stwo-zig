//! ReleaseFast paired throughput and scaling admission for SHIFTS_IMM.
...
test "typed SHIFTS_IMM hot rows retain paired legacy throughput and scaling" {
    ...
    for (log_rows, 0..) |log_size, case_index| {
        ...
        std.debug.print(
            "\n  typed SHIFTS_IMM log_rows={d}: generated={d} ns " ++
