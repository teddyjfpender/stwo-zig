...
const legacy = @import("../../runner/witness/base_alu_imm_legacy_test_oracle.zig");
...
pub fn result(opcode: Opcode, source: u32, immediate: i32) u32 {
...
pub fn makeRow(
    ...
    const output = result(opcode, source, immediate);
