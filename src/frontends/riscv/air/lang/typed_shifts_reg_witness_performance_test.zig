//! ReleaseFast paired throughput and scaling admission for SHIFTS_REG.
...
test "typed SHIFTS_REG hot rows retain paired legacy throughput and scaling" {
    ...
    for (log_rows, 0..) |log_size, case_index| {
        ...
        std.debug.print(
            "\n  typed SHIFTS_REG log_rows={d}: generated={d} ns " ++
