...
const production = @import("../memory_commitment/poseidon2_layout.zig");
...
pub const MAXIMUM_CONSTRAINT_DEGREE = @import("../memory_commitment/poseidon2_layout.zig").MAXIMUM_CONSTRAINT_DEGREE;
