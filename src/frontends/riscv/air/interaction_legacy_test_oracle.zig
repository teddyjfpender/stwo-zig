//! Test-only oracle for the retired monolithic opcode interaction route.
//! Production uses typed lookup components and program/interaction.zig.
//!
...
pub const OPCODE_INTERACTION_COLS: usize = 8 + N_COLUMNS;
...
pub fn genOpcodeInteraction(
    ...
    const memory = try generateMemory(
        allocator,
        rows,
