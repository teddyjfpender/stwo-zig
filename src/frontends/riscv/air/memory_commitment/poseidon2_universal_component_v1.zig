...
const shared = @import("poseidon2_degree3_component.zig").Namespace(@import("poseidon2_universal_equations_v1.zig"), @import("poseidon2_narrow_backend_v1.zig").Universal);
