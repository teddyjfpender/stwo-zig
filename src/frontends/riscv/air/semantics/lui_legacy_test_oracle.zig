//! Retired Stark-V-shaped LUI evaluator retained only as a differential oracle.
//!
//! Production direct constraints and ordered relations are owned by
//! `air/lang/typed_lui_authority.zig`. No production module imports this file;
//! focused witness tests keep it independent so correlated generation cannot
//! masquerade as parity evidence.
