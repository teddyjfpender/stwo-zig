//! Test-only oracle for retired Stark-V-shaped AUIPC semantics and lookups.
//!
//! Production direct roots and ordered relations are owned by
//! `lang/typed_auipc_authority.zig`. This independent implementation remains
//! rooted only by differential and compatibility tests.
