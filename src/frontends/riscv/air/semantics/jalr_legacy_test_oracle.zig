//! Retired Sail-shaped JALR evaluator retained as an independent test oracle.
//!
//! Production AIR, relation construction, witness generation, and retirement
//! are owned by `typed_jalr_authority.zig`. Keeping this evaluator outside the
//! production semantic registry makes any accidental fallback source-visible.
//!
