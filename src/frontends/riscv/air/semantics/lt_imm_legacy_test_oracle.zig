//! Retired LT_IMM semantic evaluator retained only as a differential oracle.
//!
//! Production retirement, witness projection, direct roots, ordered lookups,
//! and formal extraction are owned by `typed_lt_imm_authority.zig`. Keeping
//! this implementation under an explicit legacy name prevents it from being
//! mistaken for a second production source of truth.
