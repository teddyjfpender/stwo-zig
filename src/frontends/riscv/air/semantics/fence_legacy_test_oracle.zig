//! Retired Stark-V-shaped FENCE evaluator kept only as a differential oracle.
//!
//! Production direct constraints and ordered relations are owned by
//! `air/lang/typed_fence_authority.zig`. No production module imports this
//! file. Sail treats every funct3=000 MISC-MEM encoding as FENCE, including
//! forward-compatible values of fm, pred/succ, rs1, and rd; this independent
//! oracle preserves that exact former production shape for differential tests.
