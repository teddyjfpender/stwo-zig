//! Table-side LogUp materializer for the throughput Keccak candidate.
...
const counters_mod = @import("keccakf_throughput_multiplicities_v1.zig");
...
comptime {
    if (column_count != 4 or production_active)
        @compileError("Keccak throughput table interaction drifted");
}
