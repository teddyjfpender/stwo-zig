...
pub fn For(comptime leaf_outer: type, comptime core_mod: type) type {
    return struct {
        ...
        const COMPONENT_COUNT = contract.COMPONENT_COUNT;
        const CORE_FIRST_ROW = contract.CORE_FIRST_ROW;
        const CORE_ROW_MASK = contract.CORE_ROW_MASK;
        const ALL_COMPONENT_MASK = contract.ALL_COMPONENT_MASK;
        ...
        pub fn coreInputs(
            ...
            transcript_prepared: *const @import("segment_transcript_outer_source_v2.zig").PreparedV2,
        ...
        pub fn collectClosure(
            self: anytype,
            generated: *const contract.GeneratedInteractionsV2,
