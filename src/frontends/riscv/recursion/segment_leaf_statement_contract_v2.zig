//! Shared statement-source geometry, key authority, and temporal context.
//! Native preparation and detached verification use these exact identities.
...
const segment_v2 = @import("segment_statement_v2_wire.zig");
...
pub const SEGMENT_V2_VERIFIER_ID = @import("segment_leaf_layout_v2.zig").SEGMENT_V2_VERIFIER_ID;
pub const PUBLIC_LOGUP_V2_KIND = @import("segment_leaf_layout_v2.zig").PUBLIC_LOGUP_V2_KIND; // "LUP2"
/// Recursion-local custody bridge from source component 37 to rows 12--14.
pub const PUBLICATION_BRIDGE_CIRCUIT_ID = @import("segment_leaf_layout_v2.zig").PUBLICATION_BRIDGE_CIRCUIT_ID;
...
pub const LOGUP_PUBLICATION_WORD_COUNT = @import("segment_leaf_layout_v2.zig").LOGUP_PUBLICATION_WORD_COUNT;
pub const PREPROCESSED_COLUMN_COUNT = @import("segment_leaf_layout_v2.zig").PREPROCESSED_COLUMN_COUNT;
pub const MAIN_COLUMN_COUNT = @import("segment_leaf_layout_v2.zig").MAIN_COLUMN_COUNT;
pub const INTERACTION_COLUMN_COUNT = @import("segment_leaf_layout_v2.zig").INTERACTION_COLUMN_COUNT;
pub const DIRECT_CONSTRAINT_COUNT = @import("segment_leaf_layout_v2.zig").DIRECT_CONSTRAINT_COUNT;
