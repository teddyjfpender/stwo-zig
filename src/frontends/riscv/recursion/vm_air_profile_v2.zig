...
const identity = @import("vm_air_profile_v2_identity.zig");

pub const FORMAT_VERSION: u16 = 2;
pub const SCHEMA_VERSION: u16 = 1;
pub const CIRCUIT_SCHEMA_VERSION: u16 = 2;
pub const PROFILE_DOMAIN = identity.PROFILE_DOMAIN;
pub const CIRCUIT_PROFILE_DOMAIN = identity.CIRCUIT_PROFILE_DOMAIN;
...
fn deriveFromSource(
    ...
    for (statement.infra_descs[0..statement.n_infra], 0..) |descriptor, ordinal| {
        try @import("../air/native_infrastructure_typed_admission.zig").validateKind(descriptor.kind, allocator);
