...
pub const base = @import("universal_manifest_contract.zig");
...
pub const boundary_v2 = @import("../segment_leaf_outer_geometry_v2.zig");
...
pub const AuthorityIds = struct {
    transcript_manifest_id: boundary_v2.NativeDigest,
    statement_manifest_id: boundary_v2.NativeDigest,
    public_manifest_id: boundary_v2.NativeDigest,
