...
pub const PUBLIC_TERM_COUNT = air.PUBLIC_TERM_COUNT;
pub const LOGICAL_ROW_COUNT = air.LOGICAL_ROW_COUNT;
pub const TRACE_LOG_SIZE = air.TRACE_LOG_SIZE;
pub const TRACE_ROW_COUNT = air.TRACE_ROW_COUNT;
pub const ACTIVE_RELATION_EVENT_COUNT = air.ACTIVE_RELATION_EVENT_COUNT;
