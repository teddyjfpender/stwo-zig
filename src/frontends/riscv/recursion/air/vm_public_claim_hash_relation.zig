//! Authenticated multi-relation interaction for universal row 13.

const air = @import("vm_public_claim_hash.zig");
...
comptime {
    ...
    {
        @compileError("VM public-claim hash interaction geometry drifted");
    }
}
