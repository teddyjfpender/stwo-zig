//! Authenticated multi-relation interaction for universal row 14.

const air = @import("vm_public_io_hash.zig");
...
comptime {
    ...
    {
        @compileError("VM public-I/O hash interaction geometry drifted");
    }
}
