...
pub const MIN_LOG_SIZE = query_profile.MIN_LOG_SIZE;
pub const MAX_LOG_SIZE = query_profile.MAX_LOG_SIZE;
pub const SEGMENT_VERIFIER_ID: u32 = 0;
pub const LEFT_RECURSION_VERIFIER_ID: u32 = 1;
pub const RIGHT_RECURSION_VERIFIER_ID: u32 = 2;
pub const RAW_QUERY_KIND = query_profile.RAW_QUERY_KIND;
...
pub const REFERENCE_FORMAT_VERSION = query_profile.REFERENCE_FORMAT_VERSION;
pub const REFERENCE_DOMAIN = query_profile.REFERENCE_DOMAIN;
...
pub const parameterValues = query_profile.parameterValues;
...
pub const LaneProfile = query_profile.LaneProfile;
pub const Reference = query_profile.Reference;
const validateProfiles = query_profile.validateProfiles;
const totalRows = query_profile.totalRows;
