...
const shape_contract = @import("segment_publication_input_provider_shape_v2.zig");
pub const FORMAT_VERSION = shape_contract.FORMAT_VERSION;
pub const SCHEMA_VERSION = shape_contract.SCHEMA_VERSION;
pub const PROPOSED_ROSTER_ROW = shape_contract.PROPOSED_ROSTER_ROW;
pub const LUP2_WORD_COUNT = shape_contract.LUP2_WORD_COUNT;
pub const SECURE_LIMB_COUNT = shape_contract.SECURE_LIMB_COUNT;
pub const Shape = shape_contract.Shape;
pub const DETAILED_CLAIM_COUNT = shape_contract.DETAILED_CLAIM_COUNT;
pub const LEGACY_SHAPE = shape_contract.LEGACY_SHAPE;
pub const DETAILED_LIMB_COUNT = shape_contract.DETAILED_LIMB_COUNT;
pub const LOGICAL_ROW_COUNT = shape_contract.LOGICAL_ROW_COUNT;
pub const TRACE_LOG_SIZE = shape_contract.TRACE_LOG_SIZE;
pub const TRACE_ROW_COUNT = shape_contract.TRACE_ROW_COUNT;
pub const ACTIVE_RELATION_EVENT_COUNT = shape_contract.ACTIVE_RELATION_EVENT_COUNT;
