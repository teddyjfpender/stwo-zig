    ...
    return struct {
        ...
        pub const frontend = struct {
            ...
            pub const air = struct {
                ...
                pub const typed_poseidon2_authority = @import("../air/lang/typed_poseidon2_authority.zig");
            };
        };
