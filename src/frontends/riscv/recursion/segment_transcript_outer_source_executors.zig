...
pub const domain_audit = @import("segment_transcript_outer_source_domain_audit.zig");

pub const component_init = @import("segment_transcript_outer_source_component_init.zig");
...
pub const segment_witness = @import("segment_transcript_witness.zig");
