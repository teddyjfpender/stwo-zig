//! Shared ownership of a verified native leaf and its recursive preparation.
//! Capture custody transfers only after all derived sources validate. The
//! integration supplies a capture type and the core preflight interface; this
//! owner neither selects a concrete backend nor imports an integration module.
...
const recursion = struct {
    ...
    const vm_air_composition_circuit = @import("vm_air_composition_circuit.zig");
    const vm_air_composition_prepared_v2 = @import("vm_air_composition_prepared_v2.zig");
};
const shared_schedule_v2 = @import("segment_shared_poseidon_schedule_v2.zig");
const transcript_v2 = @import("transcript_program_v2.zig");
...
/// CorePreflight supplies the sealed rows-18--34 and rows-18--35 preflight
/// receipt types, their constructors, verifier plans, and roster constants.
/// Its concrete authority implementation remains an explicit caller dependency.
pub fn Preparation(comptime Capture: type, comptime CorePreflight: type) type {
    return struct {
        pub const NativeCapture = Capture;
        ...
        pub const PreparedNativeV2LeafOuter = struct {
            ...
            rows_18_34_core: CorePreflight.V2CoreRows18Through34PreflightReceipt,
            rows_18_35: CorePreflight.V2Rows18Through35PreflightReceipt,
            ...
            pub fn init(
                ...
                verifier_keys: source_v2.VerifierKeyAuthorityV2,
                outer_relations: universal.UniversalRelations,
                verifier_plans: CorePreflight.VerifierPlans,
                ...
                const owned_plans = CorePreflight.VerifierPlans{
                    .vm = &vm_plan,
                ...
                const native_relations = relation_challenges.Relations
                ...
                const rows_18_35 = try CorePreflight.preflightV2Rows18Through35(
                    &captured_fri,
                    .{ .borrowed = &vm_air },
                    owned_plans,
                    pcs_config,
                ...
                const rows_18_34_core =
                    try CorePreflight.preflightV2CoreRows18Through34(
                        allocator,
                        &captured_fri,
                        .{ .borrowed = &vm_air },
                        owned_plans,
