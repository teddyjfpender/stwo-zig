//! Shared leaf noncore owner; the caller supplies the prepared leaf types.
pub fn For(comptime leaf_outer: type) type {
    return struct {
        ...
        const transcript_source = @import("segment_transcript_outer_source_v2.zig");
        ...
        const boundary_components = @import("air/segment_boundary_components_v2.zig");
        ...
        const input_provider_air = @import("air/segment_publication_input_provider_v2.zig");
        ...
        const runtime = @import("detached_leaf_noncore_runtime_v2.zig").For(leaf_outer);
        ...
        pub const PreflightV2 = struct {
            ...
            pub fn init(prepared: *const PreparedNativeV2LeafOuter) !PreflightV2 {
                ...
                const result = PreflightV2{
                    ...
                    .input_provider_shape = (try @import("air/segment_publication_input_provider_witness_v2.zig").preflight(.{
            ...
            pub fn validateAgainst(
                ...
                const provider_source = try @import("air/segment_publication_input_provider_witness_v2.zig").preflight(.{
                    .capture = &prepared.authority_prepared,
                    .vm_context = &prepared.capture.vm_air,
                });
        ...
        pub const Owner = struct {
            ...
            pub fn prepareInteractionsWithGenerator(
                ...
                return runtime.prepareInteractionsWithGenerator(self, audit_allocator, relations, provider_relations, generator);
            }
