...
const recursion = struct {
    ...
    const segment_outer_cohort_v2 = @import("segment_public_wire_boundary_v2.zig");
    const air = struct {
        const segment_outer_adapter_manifest_v2 = @import("air/segment_outer_manifest_contract_v2.zig");
...
pub fn testNoDetachedMint() !void {
