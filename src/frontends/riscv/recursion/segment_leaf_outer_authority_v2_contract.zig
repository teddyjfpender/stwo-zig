...
pub const COMPONENT_COUNT = @import("segment_leaf_outer_geometry_v2.zig").COMPONENT_COUNT;
pub const PUBLIC_LOGUP_LOGICAL_ROWS = @import("segment_leaf_outer_geometry_v2.zig").PUBLIC_LOGUP_LOGICAL_ROWS;
pub const PUBLIC_LOGUP_TRACE_LOG_SIZE = @import("segment_leaf_outer_geometry_v2.zig").PUBLIC_LOGUP_TRACE_LOG_SIZE;
pub const PUBLIC_LOGUP_TRACE_ROWS = @import("segment_leaf_outer_geometry_v2.zig").PUBLIC_LOGUP_TRACE_ROWS;

pub const STATEMENT_COMPONENT_TAG = @import("segment_leaf_outer_geometry_v2.zig").STATEMENT_COMPONENT_TAG; // "S2ST"
pub const PUBLIC_LOGUP_COMPONENT_TAG = @import("segment_leaf_outer_geometry_v2.zig").PUBLIC_LOGUP_COMPONENT_TAG; // "S2LU"
...
const geometry = @import("segment_leaf_outer_geometry_v2.zig");
pub const ComponentKindV2 = geometry.ComponentKindV2;
pub const ComponentGeometryV2 = geometry.ComponentGeometryV2;
