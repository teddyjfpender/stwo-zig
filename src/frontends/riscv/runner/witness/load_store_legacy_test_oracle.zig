//! Test-only oracle for the retired handwritten load/store witness writer.
//!
//! Production code must not import this module. Its independent implementation
//! preserves the pre-cutover row algorithm for exact differential evidence.

const std = @import("std");
const M31 = @import("stwo_core").fields.m31.M31;
const QM31 = @import("stwo_core").fields.qm31.QM31;
const Opcode = @import("../decode.zig").Opcode;
const load_store_semantics_module =
    @import("../../air/semantics/load_store_legacy_test_oracle.zig");
const load_store_semantics = load_store_semantics_module.Semantics(QM31);
