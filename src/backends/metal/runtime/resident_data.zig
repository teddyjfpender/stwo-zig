...
pub extern fn stwo_zig_metal_leaf_absorb_v2(
    runtime: *anyopaque,
    arena: *anyopaque,
    column_offsets: [*]const u32,
    column_logs: [*]const u32,
...
pub extern fn stwo_zig_metal_leaf_absorb_compact_v2(
    runtime: *anyopaque,
    arena: *anyopaque,
    column_offsets: [*]const u32,
    column_logs: [*]const u32,
...
pub extern fn stwo_zig_metal_parent_seeded_v2(
    runtime: *anyopaque,
    arena: *anyopaque,
    child_offset: u32,
    destination_offset: u32,
...
pub extern fn stwo_zig_metal_merkle_commit(
    ...
    backing_words: ?[*]const [*]const u32,
    backing_word_counts: ?[*]const usize,
    backing_count: u32,
    column_count: u32,
...
pub extern fn stwo_zig_metal_merkle_commit_v2(
    runtime: *anyopaque,
    columns: [*]const [*]const u32,
    column_lengths: [*]const usize,
    column_log_sizes: [*]const u32,
