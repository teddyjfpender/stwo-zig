...
int stwo_ntt_b2n_composition_split_depth_two_on(
    uint32_t *coordinate_values,
    size_t coordinate_capacity_words,
    size_t coordinate_stride_words,
    uint32_t *coefficients,
...
STUB(stwo_accumulate_quotient_numerator_addressed_on)
...
STUB(stwo_blake2s_progressive_absorb_lifted_on)
...
STUB(stwo_combine_quotients_from_compact_numerators_on)
