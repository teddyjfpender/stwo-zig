//! Structural AOT binding for statement-independent constant-QM31 AIRs.
...
pub const cache_key: u64 = 0xd363e2a1d1c6b31d;
...
const Arguments = struct {
    ...
    constant_composition: field.SecureField,
    coordinate_slab: [*]u32,
    ...
    fn pointers(self: *Arguments) [argument_count]?*anyopaque {
        return .{
            ...
            @ptrCast(&self.constant_composition),
...
pub fn prepare(
    ...
    try validateConstant(constant_composition);
    ...
    return .{
        ...
        .arguments = .{
            ...
            .constant_composition = constant_composition,
...
fn validateConstant(value: field.SecureField) runtime_error.Error!void {
...
test "constant-QM31 descriptor is structural and covers each row once" {
...
test "constant-QM31 binding admits zero and nonzero preprocessed widths" {
...
test "constant-QM31 binding rejects invalid geometry ranges and aliases" {
    var session = TestSession{};
    const buffers = testBuffers();
