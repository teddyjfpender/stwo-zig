...
stwo_cairo_cuda_eval_v1_53660e5a838d3ee1(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b9 = 0u;
    unsigned b10 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b11 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b12 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b13 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    unsigned b14 = stwo_trace_value(arena, *args, 2u, 4u, row, 0);
    unsigned b15 = stwo_trace_value(arena, *args, 2u, 5u, row, 0);
    unsigned b16 = stwo_trace_value(arena, *args, 2u, 6u, row, 0);
    unsigned b17 = stwo_trace_value(arena, *args, 2u, 7u, row, 0);
    unsigned b18 = stwo_trace_value(arena, *args, 2u, 8u, row, 0);
    unsigned b19 = stwo_trace_value(arena, *args, 2u, 9u, row, 0);
    unsigned b20 = stwo_trace_value(arena, *args, 2u, 10u, row, 0);
    unsigned b21 = stwo_trace_value(arena, *args, 2u, 11u, row, 0);
    unsigned b22 = stwo_trace_value(arena, *args, 2u, 12u, row, -1);
    unsigned b23 = stwo_trace_value(arena, *args, 2u, 12u, row, 0);
    unsigned b24 = stwo_trace_value(arena, *args, 2u, 13u, row, -1);
    unsigned b25 = stwo_trace_value(arena, *args, 2u, 13u, row, 0);
    unsigned b26 = stwo_trace_value(arena, *args, 2u, 14u, row, -1);
    unsigned b27 = stwo_trace_value(arena, *args, 2u, 14u, row, 0);
    unsigned b28 = stwo_trace_value(arena, *args, 2u, 15u, row, -1);
    unsigned b29 = stwo_trace_value(arena, *args, 2u, 15u, row, 0);
    StwoCairoQm31 e0 = { b1, b9, b9, b9 };
    StwoCairoQm31 e1 = stwo_qm31_neg(e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e2 = { b0, b9, b9, b9 };
    ...
    e6 = { b4, b9, b9, b9 };
    e4 = stwo_qm31_neg(e6);
    e6 = stwo_load_qm31(arena, args->ext_params + 9u * 4u);
    StwoCairoQm31 e8 = { b0, b9, b9, b9 };
    ...
    StwoCairoQm31 e12 = { b0, b9, b9, b9 };
    StwoCairoQm31 e13 = stwo_qm31_mul(e10, e12);
    e12 = stwo_load_qm31(arena, args->ext_params + 16u * 4u);
    e10 = stwo_qm31_add(e12, e13);
    e12 = stwo_load_qm31(arena, args->ext_params + 17u * 4u);
    e13 = stwo_qm31_sub(e10, e12);
    e12 = { b7, b9, b9, b9 };
    e10 = stwo_qm31_neg(e12);
    e12 = stwo_load_qm31(arena, args->ext_params + 18u * 4u);
    StwoCairoQm31 e14 = { b0, b9, b9, b9 };
    StwoCairoQm31 e15 = stwo_qm31_mul(e12, e14);
    e14 = stwo_load_qm31(arena, args->ext_params + 19u * 4u);
    e12 = stwo_qm31_add(e14, e15);
    e14 = stwo_load_qm31(arena, args->ext_params + 20u * 4u);
    e15 = stwo_qm31_sub(e12, e14);
    e14 = { b8, b9, b9, b9 };
    e12 = stwo_qm31_neg(e14);
    e14 = stwo_load_qm31(arena, args->ext_params + 21u * 4u);
    StwoCairoQm31 e16 = { b0, b9, b9, b9 };
    StwoCairoQm31 e17 = stwo_qm31_mul(e14, e16);
    e16 = stwo_load_qm31(arena, args->ext_params + 22u * 4u);
    e14 = stwo_qm31_add(e16, e17);
    e16 = stwo_load_qm31(arena, args->ext_params + 23u * 4u);
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e17, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 3u) * 4u)));
