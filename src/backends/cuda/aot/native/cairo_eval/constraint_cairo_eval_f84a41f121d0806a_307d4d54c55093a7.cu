...
stwo_cairo_cuda_eval_v1_8242c9aca7a7f061(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 183u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 184u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 185u, row, 0);
    unsigned b97 = 0u;
