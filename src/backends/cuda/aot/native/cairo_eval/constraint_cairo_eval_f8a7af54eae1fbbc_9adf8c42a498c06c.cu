...
stwo_cairo_cuda_eval_v1_0ad290804c557980(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b63 = stwo_trace_value(arena, *args, 1u, 110u, row, 0);
    unsigned b64 = stwo_trace_value(arena, *args, 1u, 111u, row, 0);
    unsigned b65 = stwo_trace_value(arena, *args, 1u, 112u, row, 0);
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 167u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 168u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 169u, row, 0);
    unsigned b97 = 0u;
    ...
    b32 = stwo_m31_mul(b67, b34);
    b31 = stwo_m31_add(b65, b32);
    b32 = stwo_m31_mul(b68, b33);
    b65 = stwo_m31_add(b31, b32);
    b32 = stwo_m31_mul(b69, b98);
    b31 = stwo_m31_add(b65, b32);
    b32 = stwo_m31_mul(b66, b36);
    b65 = stwo_m31_mul(b67, b35);
    b30 = stwo_m31_add(b32, b65);
    b65 = stwo_m31_mul(b68, b34);
    b32 = stwo_m31_add(b30, b65);
    b65 = stwo_m31_mul(b69, b33);
    b30 = stwo_m31_add(b32, b65);
    b65 = stwo_m31_mul(b70, b98);
    b32 = stwo_m31_add(b30, b65);
    b65 = stwo_m31_mul(b66, b37);
    b30 = stwo_m31_mul(b67, b36);
    b29 = stwo_m31_add(b65, b30);
    b30 = stwo_m31_mul(b68, b35);
    b65 = stwo_m31_add(b29, b30);
    b30 = stwo_m31_mul(b69, b34);
    b29 = stwo_m31_add(b65, b30);
    b30 = stwo_m31_mul(b70, b33);
    b65 = stwo_m31_add(b29, b30);
    b30 = stwo_m31_mul(b71, b98);
    b29 = stwo_m31_add(b65, b30);
    ...
    b65 = stwo_m31_mul(b71, b38);
    b28 = stwo_m31_mul(b72, b37);
    b27 = stwo_m31_add(b65, b28);
    b28 = stwo_m31_mul(b72, b38);
    b65 = stwo_m31_mul(b73, b42);
    b26 = stwo_m31_mul(b74, b41);
    b25 = stwo_m31_add(b65, b26);
    b26 = stwo_m31_mul(b75, b40);
    b65 = stwo_m31_add(b25, b26);
    b26 = stwo_m31_mul(b76, b39);
    b25 = stwo_m31_add(b65, b26);
    b26 = stwo_m31_mul(b73, b43);
    b65 = stwo_m31_mul(b74, b42);
    b24 = stwo_m31_add(b26, b65);
    b65 = stwo_m31_mul(b75, b41);
    b26 = stwo_m31_add(b24, b65);
    b65 = stwo_m31_mul(b76, b40);
    b24 = stwo_m31_add(b26, b65);
    b65 = stwo_m31_mul(b77, b39);
    b26 = stwo_m31_add(b24, b65);
    b65 = stwo_m31_mul(b73, b44);
    b24 = stwo_m31_mul(b74, b43);
    b23 = stwo_m31_add(b65, b24);
    b24 = stwo_m31_mul(b75, b42);
    b65 = stwo_m31_add(b23, b24);
    b24 = stwo_m31_mul(b76, b41);
    b23 = stwo_m31_add(b65, b24);
    b24 = stwo_m31_mul(b77, b40);
    b65 = stwo_m31_add(b23, b24);
    b24 = stwo_m31_mul(b78, b39);
    b23 = stwo_m31_add(b65, b24);
    b24 = stwo_m31_mul(b78, b45);
    b65 = stwo_m31_mul(b79, b44);
    b22 = stwo_m31_add(b24, b65);
    b65 = stwo_m31_mul(b79, b45);
    ...
    b21 = stwo_m31_add(b72, b79);
    b20 = stwo_m31_add(b98, b39);
    ...
    b18 = stwo_m31_mul(b24, b34);
    b17 = stwo_m31_mul(b66, b33);
    b16 = stwo_m31_add(b18, b17);
    b17 = stwo_m31_mul(b67, b98);
    b18 = stwo_m31_add(b16, b17);
    b17 = stwo_m31_mul(b68, b20);
    b16 = stwo_m31_add(b18, b17);
    b17 = stwo_m31_sub(b16, b31);
    b16 = stwo_m31_sub(b17, b25);
    b17 = stwo_m31_add(b30, b16);
    b16 = stwo_m31_mul(b24, b35);
    b30 = stwo_m31_mul(b66, b34);
    b25 = stwo_m31_add(b16, b30);
    b30 = stwo_m31_mul(b67, b33);
    b16 = stwo_m31_add(b25, b30);
    b30 = stwo_m31_mul(b68, b98);
    b25 = stwo_m31_add(b16, b30);
    b30 = stwo_m31_mul(b69, b20);
    b16 = stwo_m31_add(b25, b30);
    b30 = stwo_m31_sub(b16, b32);
    b16 = stwo_m31_sub(b30, b26);
    b30 = stwo_m31_add(b27, b16);
    b16 = stwo_m31_mul(b24, b36);
    b24 = stwo_m31_mul(b66, b35);
    b35 = stwo_m31_add(b16, b24);
    b24 = stwo_m31_mul(b67, b34);
    b34 = stwo_m31_add(b35, b24);
    b24 = stwo_m31_mul(b68, b33);
    b33 = stwo_m31_add(b34, b24);
    b24 = stwo_m31_mul(b69, b98);
    b98 = stwo_m31_add(b33, b24);
    b24 = stwo_m31_mul(b70, b20);
    b20 = stwo_m31_add(b98, b24);
    b24 = stwo_m31_sub(b20, b29);
    b20 = stwo_m31_sub(b24, b23);
    b24 = stwo_m31_add(b28, b20);
    b20 = stwo_m31_mul(b70, b19);
    b70 = stwo_m31_mul(b21, b36);
    b36 = stwo_m31_add(b20, b70);
    b70 = stwo_m31_sub(b36, b27);
    b36 = stwo_m31_sub(b70, b22);
    b70 = stwo_m31_add(b26, b36);
    b36 = stwo_m31_mul(b21, b19);
    b19 = stwo_m31_sub(b36, b28);
    b36 = stwo_m31_sub(b19, b65);
    b19 = stwo_m31_add(b23, b36);
    b36 = stwo_m31_mul(b80, b50);
    b23 = stwo_m31_mul(b81, b49);
    b65 = stwo_m31_add(b36, b23);
    b23 = stwo_m31_mul(b82, b48);
    b36 = stwo_m31_add(b65, b23);
    b23 = stwo_m31_mul(b83, b47);
    b65 = stwo_m31_add(b36, b23);
    b23 = stwo_m31_mul(b84, b46);
    b36 = stwo_m31_add(b65, b23);
    b23 = stwo_m31_mul(b80, b51);
    b80 = stwo_m31_mul(b81, b50);
    b50 = stwo_m31_add(b23, b80);
    b80 = stwo_m31_mul(b82, b49);
    b49 = stwo_m31_add(b50, b80);
    b80 = stwo_m31_mul(b83, b48);
    b48 = stwo_m31_add(b49, b80);
    b80 = stwo_m31_mul(b84, b47);
    b47 = stwo_m31_add(b48, b80);
    b80 = stwo_m31_mul(b85, b46);
    b46 = stwo_m31_add(b47, b80);
    b80 = stwo_m31_mul(b85, b52);
    b47 = stwo_m31_mul(b86, b51);
    b48 = stwo_m31_add(b80, b47);
    b47 = stwo_m31_mul(b86, b52);
    b80 = stwo_m31_mul(b87, b57);
    b84 = stwo_m31_mul(b88, b56);
    b49 = stwo_m31_add(b80, b84);
    b84 = stwo_m31_mul(b89, b55);
    b80 = stwo_m31_add(b49, b84);
    b84 = stwo_m31_mul(b90, b54);
    b49 = stwo_m31_add(b80, b84);
    b84 = stwo_m31_mul(b91, b53);
    b80 = stwo_m31_add(b49, b84);
    b84 = stwo_m31_mul(b87, b58);
    b49 = stwo_m31_mul(b88, b57);
    b83 = stwo_m31_add(b84, b49);
    b49 = stwo_m31_mul(b89, b56);
    b84 = stwo_m31_add(b83, b49);
    b49 = stwo_m31_mul(b90, b55);
    b83 = stwo_m31_add(b84, b49);
    b49 = stwo_m31_mul(b91, b54);
    b84 = stwo_m31_add(b83, b49);
    b49 = stwo_m31_mul(b92, b53);
    b83 = stwo_m31_add(b84, b49);
    b49 = stwo_m31_mul(b92, b59);
    b84 = stwo_m31_mul(b93, b58);
    b50 = stwo_m31_add(b49, b84);
    b84 = stwo_m31_mul(b93, b59);
    b49 = stwo_m31_add(b85, b92);
    b82 = stwo_m31_add(b86, b93);
    b23 = stwo_m31_add(b51, b58);
    b81 = stwo_m31_add(b52, b59);
    b65 = stwo_m31_mul(b49, b81);
    b49 = stwo_m31_mul(b82, b23);
    b23 = stwo_m31_add(b65, b49);
    b49 = stwo_m31_sub(b23, b48);
    b23 = stwo_m31_sub(b49, b50);
    b49 = stwo_m31_add(b80, b23);
    b23 = stwo_m31_mul(b82, b81);
    b81 = stwo_m31_sub(b23, b47);
    b23 = stwo_m31_sub(b81, b84);
    b81 = stwo_m31_add(b83, b23);
    b23 = stwo_m31_add(b71, b85);
    ...
    b59 = stwo_m31_mul(b23, b51);
    b45 = stwo_m31_mul(b85, b93);
    b44 = stwo_m31_add(b59, b45);
    b45 = stwo_m31_mul(b85, b51);
    b59 = stwo_m31_mul(b86, b56);
    b43 = stwo_m31_mul(b87, b55);
    b42 = stwo_m31_add(b59, b43);
    b43 = stwo_m31_mul(b88, b54);
    b59 = stwo_m31_add(b42, b43);
    b43 = stwo_m31_mul(b89, b53);
    b42 = stwo_m31_add(b59, b43);
    b43 = stwo_m31_mul(b90, b52);
    b59 = stwo_m31_add(b42, b43);
    b43 = stwo_m31_mul(b86, b57);
    b86 = stwo_m31_mul(b87, b56);
    b56 = stwo_m31_add(b43, b86);
    b86 = stwo_m31_mul(b88, b55);
    b55 = stwo_m31_add(b56, b86);
    b86 = stwo_m31_mul(b89, b54);
    b54 = stwo_m31_add(b55, b86);
    b86 = stwo_m31_mul(b90, b53);
    b53 = stwo_m31_add(b54, b86);
    b86 = stwo_m31_mul(b91, b52);
    b52 = stwo_m31_add(b53, b86);
    b86 = stwo_m31_mul(b91, b58);
    b53 = stwo_m31_mul(b92, b57);
    b54 = stwo_m31_add(b86, b53);
    b53 = stwo_m31_mul(b92, b58);
    b86 = stwo_m31_add(b23, b91);
    b91 = stwo_m31_add(b85, b92);
    b92 = stwo_m31_add(b93, b57);
    ...
    b92 = stwo_m31_mul(b91, b57);
    b57 = stwo_m31_sub(b92, b45);
    b92 = stwo_m31_sub(b57, b53);
    b57 = stwo_m31_add(b52, b92);
    b92 = stwo_m31_sub(b86, b70);
    b86 = stwo_m31_sub(b92, b49);
    b92 = stwo_m31_add(b36, b86);
    b86 = stwo_m31_sub(b57, b19);
    b57 = stwo_m31_sub(b86, b81);
    b86 = stwo_m31_add(b46, b57);
    b57 = stwo_m31_sub(b32, b60);
    b32 = stwo_m31_sub(b29, b61);
    b29 = stwo_m31_sub(b17, b62);
    b17 = stwo_m31_sub(b30, b63);
    b30 = stwo_m31_sub(b24, b64);
    b24 = 2u;
    b64 = stwo_m31_mul(b24, b57);
    b24 = stwo_m31_add(b64, b29);
    b64 = 32u;
    b29 = stwo_m31_mul(b64, b17);
    b64 = stwo_m31_add(b24, b29);
    b29 = 4u;
    b24 = stwo_m31_mul(b29, b92);
    b29 = stwo_m31_sub(b64, b24);
    b24 = 2u;
    b64 = stwo_m31_mul(b24, b32);
    b24 = stwo_m31_add(b64, b17);
    b64 = 32u;
    b17 = stwo_m31_mul(b64, b30);
    b64 = stwo_m31_add(b24, b17);
    b17 = 4u;
    b24 = stwo_m31_mul(b17, b86);
    b17 = stwo_m31_sub(b64, b24);
    b24 = 512u;
