...
stwo_cairo_cuda_eval_v1_99309798fccd0a05(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 593u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 594u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 600u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 601u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 602u, row, 0);
    unsigned b97 = 0u;
    ...
    b28 = stwo_m31_mul(b43, b69);
    b27 = stwo_m31_add(b29, b28);
    b28 = stwo_m31_mul(b44, b68);
    b29 = stwo_m31_add(b27, b28);
    b28 = stwo_m31_mul(b45, b67);
    b27 = stwo_m31_add(b29, b28);
    ...
    b26 = stwo_m31_add(b28, b29);
    b29 = stwo_m31_mul(b46, b67);
    b28 = stwo_m31_add(b26, b29);
    b29 = stwo_m31_mul(b46, b73);
    ...
    b18 = stwo_m31_add(b13, b28);
    b28 = stwo_m31_mul(b47, b80);
    b13 = stwo_m31_mul(b48, b79);
    b20 = stwo_m31_add(b28, b13);
    b13 = stwo_m31_mul(b49, b78);
    b28 = stwo_m31_add(b20, b13);
    b13 = stwo_m31_mul(b50, b77);
    b20 = stwo_m31_add(b28, b13);
    b13 = stwo_m31_mul(b51, b76);
    b28 = stwo_m31_add(b20, b13);
    b13 = stwo_m31_mul(b52, b75);
    b20 = stwo_m31_add(b28, b13);
    b13 = stwo_m31_mul(b53, b74);
    b28 = stwo_m31_add(b20, b13);
    b13 = stwo_m31_mul(b53, b80);
    b20 = stwo_m31_mul(b54, b86);
    b17 = stwo_m31_mul(b55, b85);
    b21 = stwo_m31_add(b20, b17);
    b17 = stwo_m31_mul(b56, b84);
    b20 = stwo_m31_add(b21, b17);
    b17 = stwo_m31_mul(b57, b83);
    b21 = stwo_m31_add(b20, b17);
    b17 = stwo_m31_mul(b58, b82);
    b20 = stwo_m31_add(b21, b17);
    b17 = stwo_m31_mul(b59, b81);
    b21 = stwo_m31_add(b20, b17);
    b17 = stwo_m31_mul(b54, b87);
    ...
    b17 = stwo_m31_add(b16, b20);
    b20 = stwo_m31_mul(b60, b87);
    b16 = stwo_m31_add(b47, b54);
    b22 = stwo_m31_add(b48, b55);
    b15 = stwo_m31_add(b49, b56);
    b23 = stwo_m31_add(b50, b57);
    b14 = stwo_m31_add(b51, b58);
    b24 = stwo_m31_add(b52, b59);
    b10 = stwo_m31_add(b53, b60);
    b25 = stwo_m31_add(b74, b81);
    b26 = stwo_m31_add(b75, b82);
    ...
    b87 = stwo_m31_mul(b8, b78);
    b73 = stwo_m31_mul(b47, b77);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b48, b76);
    b87 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_mul(b49, b75);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b50, b74);
    b87 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_mul(b51, b60);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b8, b79);
    b87 = stwo_m31_mul(b47, b78);
    b71 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b48, b77);
    b73 = stwo_m31_add(b71, b87);
    b87 = stwo_m31_mul(b49, b76);
    b71 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b50, b75);
    b73 = stwo_m31_add(b71, b87);
    b87 = stwo_m31_mul(b51, b74);
    b71 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b52, b60);
    b73 = stwo_m31_add(b71, b87);
    b87 = stwo_m31_mul(b52, b79);
    b71 = stwo_m31_mul(b53, b85);
    b70 = stwo_m31_mul(b54, b84);
    b69 = stwo_m31_add(b71, b70);
    b70 = stwo_m31_mul(b55, b83);
    b71 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b56, b82);
    b69 = stwo_m31_add(b71, b70);
    b70 = stwo_m31_mul(b57, b81);
    b71 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b58, b80);
    b69 = stwo_m31_add(b71, b70);
    b70 = stwo_m31_mul(b53, b86);
    b71 = stwo_m31_mul(b54, b85);
    b68 = stwo_m31_add(b70, b71);
    b71 = stwo_m31_mul(b55, b84);
    b70 = stwo_m31_add(b68, b71);
    b71 = stwo_m31_mul(b56, b83);
    b68 = stwo_m31_add(b70, b71);
    b71 = stwo_m31_mul(b57, b82);
    b70 = stwo_m31_add(b68, b71);
    b71 = stwo_m31_mul(b58, b81);
    b68 = stwo_m31_add(b70, b71);
    b71 = stwo_m31_mul(b59, b80);
    b70 = stwo_m31_add(b68, b71);
    b71 = stwo_m31_add(b8, b53);
    ...
    b86 = stwo_m31_mul(b71, b84);
    b79 = stwo_m31_mul(b53, b83);
    b78 = stwo_m31_add(b86, b79);
    b79 = stwo_m31_mul(b54, b82);
    b86 = stwo_m31_add(b78, b79);
    b79 = stwo_m31_mul(b55, b81);
    b78 = stwo_m31_add(b86, b79);
    b79 = stwo_m31_mul(b56, b80);
    b86 = stwo_m31_add(b78, b79);
    b79 = stwo_m31_mul(b57, b59);
    b78 = stwo_m31_add(b86, b79);
    b79 = stwo_m31_sub(b78, b72);
    b78 = stwo_m31_sub(b79, b69);
    b79 = stwo_m31_add(b87, b78);
    b78 = stwo_m31_mul(b71, b85);
    b85 = stwo_m31_mul(b53, b84);
    b84 = stwo_m31_add(b78, b85);
    b85 = stwo_m31_mul(b54, b83);
    b83 = stwo_m31_add(b84, b85);
    b85 = stwo_m31_mul(b55, b82);
    b82 = stwo_m31_add(b83, b85);
    b85 = stwo_m31_mul(b56, b81);
    b81 = stwo_m31_add(b82, b85);
    b85 = stwo_m31_mul(b57, b80);
    b80 = stwo_m31_add(b81, b85);
    b85 = stwo_m31_mul(b58, b59);
    b59 = stwo_m31_add(b80, b85);
    b85 = stwo_m31_sub(b59, b73);
    b59 = stwo_m31_sub(b85, b70);
    b85 = stwo_m31_sub(b79, b11);
    b79 = stwo_m31_sub(b85, b6);
    b85 = stwo_m31_add(b29, b79);
    b79 = stwo_m31_sub(b59, b19);
    b59 = stwo_m31_sub(b79, b25);
    b79 = stwo_m31_sub(b93, b88);
    b93 = stwo_m31_sub(b30, b89);
    b30 = stwo_m31_sub(b31, b90);
    b31 = stwo_m31_sub(b85, b91);
    b85 = stwo_m31_sub(b59, b92);
    b59 = 32u;
    b92 = stwo_m31_mul(b59, b93);
    b59 = stwo_m31_add(b79, b92);
    b92 = 4u;
    b79 = stwo_m31_mul(b92, b31);
    b92 = stwo_m31_sub(b59, b79);
    b79 = 8u;
    b59 = stwo_m31_mul(b79, b20);
    b79 = stwo_m31_add(b92, b59);
    b59 = 32u;
    b92 = stwo_m31_mul(b59, b30);
    b59 = stwo_m31_add(b93, b92);
    b92 = 4u;
    b93 = stwo_m31_mul(b92, b85);
    b92 = stwo_m31_sub(b59, b93);
    b93 = 512u;
    b59 = stwo_m31_mul(b95, b93);
    b93 = stwo_m31_add(b79, b94);
    b79 = stwo_m31_sub(b59, b93);
    b93 = 512u;
    b59 = stwo_m31_mul(b96, b93);
    b93 = stwo_m31_add(b92, b95);
    b92 = stwo_m31_sub(b59, b93);
    StwoCairoQm31 e0 = { b79, b97, b97, b97 };
    StwoCairoQm31 e1 = { b92, b97, b97, b97 };
