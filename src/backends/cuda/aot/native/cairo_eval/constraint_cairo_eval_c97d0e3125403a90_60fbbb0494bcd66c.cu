...
stwo_cairo_cuda_eval_v1_a4101d4435c7eeac(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b3 = 0u;
    unsigned b4 = stwo_trace_value(arena, *args, 2u, 0u, row, -1);
    unsigned b5 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b6 = stwo_trace_value(arena, *args, 2u, 1u, row, -1);
    unsigned b7 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b8 = stwo_trace_value(arena, *args, 2u, 2u, row, -1);
    unsigned b9 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b10 = stwo_trace_value(arena, *args, 2u, 3u, row, -1);
    unsigned b11 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    StwoCairoQm31 e0 = { b1, b3, b3, b3 };
    StwoCairoQm31 e1 = stwo_qm31_neg(e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e2 = { b0, b3, b3, b3 };
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e5, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 0u) * 4u)));
