...
stwo_cairo_cuda_eval_v1_4423eca9795f6074(
    unsigned *arena,
    u64 arena_words,
    ...
    b17 = stwo_trace_value(arena, *args, 2u, 0u, row, -1);
    b0 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b22 = stwo_trace_value(arena, *args, 2u, 1u, row, -1);
    unsigned b23 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b24 = stwo_trace_value(arena, *args, 2u, 2u, row, -1);
    unsigned b25 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b26 = stwo_trace_value(arena, *args, 2u, 3u, row, -1);
    ...
    StwoCairoQm31 e4 = { b1, b18, b18, b18 };
    ...
    e4 = stwo_qm31_mul(e6, e1);
    e1 = stwo_qm31_add(e5, e4);
    e4 = stwo_load_qm31(arena, args->ext_params + 12u * 4u);
    e5 = { b8, b18, b18, b18 };
    e6 = stwo_qm31_mul(e4, e5);
    e5 = stwo_qm31_add(e1, e6);
    ...
    e4 = stwo_qm31_mul(e6, e1);
    e1 = stwo_qm31_add(e5, e4);
    e4 = stwo_load_qm31(arena, args->ext_params + 14u * 4u);
    e5 = { b10, b18, b18, b18 };
    e6 = stwo_qm31_mul(e4, e5);
    e5 = stwo_qm31_add(e1, e6);
    ...
    e4 = stwo_qm31_mul(e6, e1);
    e1 = stwo_qm31_add(e5, e4);
    e4 = stwo_load_qm31(arena, args->ext_params + 16u * 4u);
    e5 = { b12, b18, b18, b18 };
    e6 = stwo_qm31_mul(e4, e5);
    e5 = stwo_qm31_add(e1, e6);
    ...
    e4 = stwo_qm31_mul(e6, e1);
    e1 = stwo_qm31_add(e5, e4);
    e4 = stwo_load_qm31(arena, args->ext_params + 18u * 4u);
    e5 = { b14, b18, b18, b18 };
    e6 = stwo_qm31_mul(e4, e5);
    e5 = stwo_qm31_add(e1, e6);
    ...
    e4 = stwo_qm31_mul(e6, e1);
    e1 = stwo_qm31_add(e5, e4);
    e4 = stwo_load_qm31(arena, args->ext_params + 20u * 4u);
    e5 = { b16, b18, b18, b18 };
    e6 = stwo_qm31_mul(e4, e5);
    e5 = stwo_qm31_add(e1, e6);
