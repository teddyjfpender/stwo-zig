...
stwo_cairo_cuda_eval_v1_8ff1c7711f0a5d06(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b59 = stwo_trace_value(arena, *args, 1u, 108u, row, 0);
    unsigned b60 = stwo_trace_value(arena, *args, 1u, 109u, row, 0);
    ...
    b67 = stwo_m31_add(b69, b66);
    b66 = stwo_m31_mul(b13, b34);
    b69 = stwo_m31_mul(b65, b33);
    unsigned b70 = stwo_m31_add(b66, b69);
    b69 = stwo_m31_mul(b14, b32);
    b66 = stwo_m31_add(b70, b69);
    b69 = stwo_m31_mul(b65, b34);
    b70 = stwo_m31_mul(b14, b33);
    unsigned b71 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b15, b38);
    b69 = stwo_m31_mul(b0, b37);
    unsigned b72 = stwo_m31_add(b70, b69);
    b69 = stwo_m31_mul(b16, b36);
    b70 = stwo_m31_add(b72, b69);
    b69 = stwo_m31_mul(b17, b35);
    b72 = stwo_m31_add(b70, b69);
    b69 = stwo_m31_mul(b15, b39);
    b70 = stwo_m31_mul(b0, b38);
    unsigned b73 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b16, b37);
    b69 = stwo_m31_add(b73, b70);
    b70 = stwo_m31_mul(b17, b36);
    b73 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b1, b35);
    b69 = stwo_m31_add(b73, b70);
    b70 = stwo_m31_mul(b1, b41);
    b73 = stwo_m31_mul(b18, b40);
    unsigned b74 = stwo_m31_add(b70, b73);
    b73 = stwo_m31_mul(b19, b39);
    b70 = stwo_m31_add(b74, b73);
    b73 = stwo_m31_mul(b18, b41);
    b41 = stwo_m31_mul(b19, b40);
    b40 = stwo_m31_add(b73, b41);
    b41 = stwo_m31_add(b10, b15);
    b73 = stwo_m31_add(b11, b0);
    b19 = stwo_m31_add(b64, b16);
    b18 = stwo_m31_add(b12, b17);
    b74 = stwo_m31_add(b13, b1);
    unsigned b75 = stwo_m31_add(b28, b35);
    unsigned b76 = stwo_m31_add(b29, b36);
    unsigned b77 = stwo_m31_add(b30, b37);
    unsigned b78 = stwo_m31_add(b31, b38);
    unsigned b79 = stwo_m31_add(b32, b39);
    unsigned b80 = stwo_m31_mul(b41, b78);
    unsigned b81 = stwo_m31_mul(b73, b77);
    unsigned b82 = stwo_m31_add(b80, b81);
    b81 = stwo_m31_mul(b19, b76);
    b80 = stwo_m31_add(b82, b81);
    b81 = stwo_m31_mul(b18, b75);
    b82 = stwo_m31_add(b80, b81);
    b81 = stwo_m31_sub(b82, b68);
    b82 = stwo_m31_sub(b81, b72);
    b81 = stwo_m31_add(b66, b82);
    b82 = stwo_m31_mul(b41, b79);
    b79 = stwo_m31_mul(b73, b78);
    b78 = stwo_m31_add(b82, b79);
    b79 = stwo_m31_mul(b19, b77);
    ...
    b71 = stwo_m31_mul(b20, b44);
    b69 = stwo_m31_add(b75, b71);
    b71 = stwo_m31_mul(b21, b43);
    b75 = stwo_m31_add(b69, b71);
    b71 = stwo_m31_mul(b3, b42);
    b69 = stwo_m31_add(b75, b71);
    b71 = stwo_m31_mul(b2, b46);
    b75 = stwo_m31_mul(b20, b45);
    b76 = stwo_m31_add(b71, b75);
    b75 = stwo_m31_mul(b21, b44);
    b71 = stwo_m31_add(b76, b75);
    b75 = stwo_m31_mul(b3, b43);
    b76 = stwo_m31_add(b71, b75);
    b75 = stwo_m31_mul(b22, b42);
    b71 = stwo_m31_add(b76, b75);
    b75 = stwo_m31_mul(b22, b48);
    b76 = stwo_m31_mul(b23, b47);
    b74 = stwo_m31_add(b75, b76);
    b76 = stwo_m31_mul(b4, b46);
    b75 = stwo_m31_add(b74, b76);
    b76 = stwo_m31_mul(b23, b48);
    b74 = stwo_m31_mul(b4, b47);
    b77 = stwo_m31_add(b76, b74);
    b74 = stwo_m31_mul(b24, b52);
    b76 = stwo_m31_mul(b25, b51);
    b18 = stwo_m31_add(b74, b76);
    b76 = stwo_m31_mul(b5, b50);
    b74 = stwo_m31_add(b18, b76);
    b76 = stwo_m31_mul(b26, b49);
    b18 = stwo_m31_add(b74, b76);
    b76 = stwo_m31_mul(b24, b53);
    b74 = stwo_m31_mul(b25, b52);
    b78 = stwo_m31_add(b76, b74);
    b74 = stwo_m31_mul(b5, b51);
    b76 = stwo_m31_add(b78, b74);
    b74 = stwo_m31_mul(b26, b50);
    b78 = stwo_m31_add(b76, b74);
    b74 = stwo_m31_mul(b27, b49);
    b76 = stwo_m31_add(b78, b74);
    b74 = stwo_m31_mul(b27, b55);
    b78 = stwo_m31_mul(b6, b54);
    b19 = stwo_m31_add(b74, b78);
    b78 = stwo_m31_mul(b9, b53);
    b74 = stwo_m31_add(b19, b78);
    b78 = stwo_m31_mul(b6, b55);
    b6 = stwo_m31_mul(b9, b54);
    b54 = stwo_m31_add(b78, b6);
    b6 = stwo_m31_add(b2, b24);
    b78 = stwo_m31_add(b20, b25);
    b9 = stwo_m31_add(b21, b5);
    b55 = stwo_m31_add(b3, b26);
    b19 = stwo_m31_add(b22, b27);
    b82 = stwo_m31_add(b42, b49);
    b73 = stwo_m31_add(b43, b50);
    b41 = stwo_m31_add(b44, b51);
    b66 = stwo_m31_add(b45, b52);
    b72 = stwo_m31_add(b46, b53);
    b80 = stwo_m31_mul(b6, b66);
    unsigned b83 = stwo_m31_mul(b78, b41);
    unsigned b84 = stwo_m31_add(b80, b83);
    b83 = stwo_m31_mul(b9, b73);
    b80 = stwo_m31_add(b84, b83);
    b83 = stwo_m31_mul(b55, b82);
    b84 = stwo_m31_add(b80, b83);
    b83 = stwo_m31_sub(b84, b69);
    b84 = stwo_m31_sub(b83, b18);
    b83 = stwo_m31_add(b75, b84);
    b84 = stwo_m31_mul(b6, b72);
    b72 = stwo_m31_mul(b78, b66);
    b66 = stwo_m31_add(b84, b72);
    b72 = stwo_m31_mul(b9, b41);
    b41 = stwo_m31_add(b66, b72);
    b72 = stwo_m31_mul(b55, b73);
    b73 = stwo_m31_add(b41, b72);
    b72 = stwo_m31_mul(b19, b82);
    b82 = stwo_m31_add(b73, b72);
    b72 = stwo_m31_sub(b82, b71);
    b82 = stwo_m31_sub(b72, b76);
    b72 = stwo_m31_add(b77, b82);
    b82 = stwo_m31_add(b10, b2);
    ...
    b53 = stwo_m31_mul(b82, b44);
    b39 = stwo_m31_mul(b2, b43);
    b38 = stwo_m31_add(b53, b39);
    b39 = stwo_m31_mul(b20, b42);
    b53 = stwo_m31_add(b38, b39);
    b39 = stwo_m31_mul(b64, b1);
    b38 = stwo_m31_add(b53, b39);
    b39 = stwo_m31_mul(b82, b45);
    b53 = stwo_m31_mul(b2, b44);
    b37 = stwo_m31_add(b39, b53);
    b53 = stwo_m31_mul(b20, b43);
    b39 = stwo_m31_add(b37, b53);
    b53 = stwo_m31_mul(b64, b42);
    b37 = stwo_m31_add(b39, b53);
    b53 = stwo_m31_mul(b3, b1);
    b39 = stwo_m31_add(b37, b53);
    b53 = stwo_m31_mul(b3, b47);
    b37 = stwo_m31_mul(b22, b46);
    b36 = stwo_m31_add(b53, b37);
    b37 = stwo_m31_mul(b65, b45);
    b53 = stwo_m31_add(b36, b37);
    b37 = stwo_m31_mul(b22, b47);
    b47 = stwo_m31_mul(b65, b46);
    b46 = stwo_m31_add(b37, b47);
    b47 = stwo_m31_mul(b4, b51);
    b37 = stwo_m31_mul(b24, b50);
    b65 = stwo_m31_add(b47, b37);
    b37 = stwo_m31_mul(b0, b49);
    b47 = stwo_m31_add(b65, b37);
    b37 = stwo_m31_mul(b5, b48);
    b65 = stwo_m31_add(b47, b37);
    b37 = stwo_m31_mul(b4, b52);
    b47 = stwo_m31_mul(b24, b51);
    b22 = stwo_m31_add(b37, b47);
    b47 = stwo_m31_mul(b0, b50);
    b37 = stwo_m31_add(b22, b47);
    b47 = stwo_m31_mul(b5, b49);
    b22 = stwo_m31_add(b37, b47);
    b47 = stwo_m31_mul(b26, b48);
    b37 = stwo_m31_add(b22, b47);
    b47 = stwo_m31_add(b82, b4);
    b4 = stwo_m31_add(b2, b24);
    b24 = stwo_m31_add(b20, b0);
    b0 = stwo_m31_add(b64, b5);
    b5 = stwo_m31_add(b3, b26);
    b26 = stwo_m31_add(b1, b48);
    b48 = stwo_m31_add(b42, b49);
    b49 = stwo_m31_add(b43, b50);
    b50 = stwo_m31_add(b44, b51);
    b51 = stwo_m31_add(b45, b52);
    b52 = stwo_m31_mul(b47, b50);
    b45 = stwo_m31_mul(b4, b49);
    b44 = stwo_m31_add(b52, b45);
    b45 = stwo_m31_mul(b24, b48);
    b52 = stwo_m31_add(b44, b45);
    b45 = stwo_m31_mul(b0, b26);
    b44 = stwo_m31_add(b52, b45);
    b45 = stwo_m31_sub(b44, b38);
    b44 = stwo_m31_sub(b45, b65);
    b45 = stwo_m31_add(b53, b44);
    b44 = stwo_m31_mul(b47, b51);
    b51 = stwo_m31_mul(b4, b50);
    b50 = stwo_m31_add(b44, b51);
    b51 = stwo_m31_mul(b24, b49);
    b49 = stwo_m31_add(b50, b51);
    b51 = stwo_m31_mul(b0, b48);
    b48 = stwo_m31_add(b49, b51);
    b51 = stwo_m31_mul(b5, b26);
    b26 = stwo_m31_add(b48, b51);
    b51 = stwo_m31_sub(b26, b39);
    b26 = stwo_m31_sub(b51, b37);
    b51 = stwo_m31_add(b46, b26);
    b26 = stwo_m31_sub(b45, b81);
    b45 = stwo_m31_sub(b26, b83);
    b26 = stwo_m31_add(b70, b45);
    b45 = stwo_m31_sub(b51, b79);
    b51 = stwo_m31_sub(b45, b72);
    b45 = stwo_m31_add(b40, b51);
    b51 = stwo_m31_sub(b8, b56);
    b8 = stwo_m31_sub(b68, b57);
    b68 = stwo_m31_sub(b67, b58);
    b67 = stwo_m31_sub(b26, b59);
    b26 = stwo_m31_sub(b45, b60);
    b45 = 32u;
    b60 = stwo_m31_mul(b45, b8);
    b45 = stwo_m31_add(b51, b60);
    b60 = 4u;
    b51 = stwo_m31_mul(b60, b67);
    b60 = stwo_m31_sub(b45, b51);
    b51 = 8u;
    b45 = stwo_m31_mul(b51, b74);
    b51 = stwo_m31_add(b60, b45);
    b45 = 32u;
    b60 = stwo_m31_mul(b45, b68);
    b45 = stwo_m31_add(b8, b60);
    b60 = 4u;
    b8 = stwo_m31_mul(b60, b26);
    b60 = stwo_m31_sub(b45, b8);
    b8 = 8u;
    b45 = stwo_m31_mul(b8, b54);
    b8 = stwo_m31_add(b60, b45);
    b45 = 512u;
    b60 = stwo_m31_mul(b62, b45);
    b45 = stwo_m31_add(b51, b61);
    b51 = stwo_m31_sub(b60, b45);
    b45 = 512u;
    b60 = stwo_m31_mul(b63, b45);
    b45 = stwo_m31_add(b8, b62);
    b8 = stwo_m31_sub(b60, b45);
    StwoCairoQm31 e0 = { b51, b7, b7, b7 };
