...
stwo_cairo_cuda_eval_v1_f62993ee42664b21(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b56 = stwo_trace_value(arena, *args, 1u, 93u, row, 0);
    unsigned b57 = stwo_trace_value(arena, *args, 1u, 94u, row, 0);
    unsigned b58 = stwo_trace_value(arena, *args, 1u, 99u, row, 0);
    unsigned b59 = stwo_trace_value(arena, *args, 1u, 100u, row, 0);
    unsigned b60 = stwo_trace_value(arena, *args, 1u, 101u, row, 0);
    unsigned b61 = stwo_trace_value(arena, *args, 1u, 128u, row, 0);
    unsigned b62 = stwo_trace_value(arena, *args, 1u, 129u, row, 0);
    unsigned b63 = stwo_trace_value(arena, *args, 1u, 130u, row, 0);
    ...
    b8 = stwo_m31_mul(b17, b40);
    unsigned b76 = stwo_m31_add(b74, b8);
    b8 = stwo_m31_mul(b1, b39);
    b74 = stwo_m31_add(b76, b8);
    b8 = stwo_m31_mul(b18, b38);
    b76 = stwo_m31_add(b74, b8);
    b8 = stwo_m31_mul(b19, b37);
    b74 = stwo_m31_add(b76, b8);
    b8 = stwo_m31_mul(b17, b41);
    b76 = stwo_m31_mul(b1, b40);
    unsigned b77 = stwo_m31_add(b8, b76);
    b76 = stwo_m31_mul(b18, b39);
    b8 = stwo_m31_add(b77, b76);
    b76 = stwo_m31_mul(b19, b38);
    b77 = stwo_m31_add(b8, b76);
    b76 = stwo_m31_mul(b1, b41);
    b8 = stwo_m31_mul(b18, b40);
    unsigned b78 = stwo_m31_add(b76, b8);
    b8 = stwo_m31_mul(b19, b39);
    b76 = stwo_m31_add(b78, b8);
    b8 = stwo_m31_add(b10, b15);
    b15 = stwo_m31_add(b11, b0);
    b0 = stwo_m31_add(b64, b16);
    b16 = stwo_m31_add(b12, b17);
    b78 = stwo_m31_add(b13, b1);
    ...
    unsigned b79 = stwo_m31_add(b32, b39);
    b32 = stwo_m31_add(b33, b40);
    b33 = stwo_m31_add(b34, b41);
    b34 = stwo_m31_mul(b8, b36);
    unsigned b80 = stwo_m31_mul(b15, b35);
    unsigned b81 = stwo_m31_add(b34, b80);
    b80 = stwo_m31_mul(b0, b14);
    b34 = stwo_m31_add(b81, b80);
    b80 = stwo_m31_sub(b34, b66);
    b34 = stwo_m31_sub(b80, b72);
    b80 = stwo_m31_add(b71, b34);
    b34 = stwo_m31_mul(b8, b37);
    b8 = stwo_m31_mul(b15, b36);
    b15 = stwo_m31_add(b34, b8);
    b8 = stwo_m31_mul(b0, b35);
    b35 = stwo_m31_add(b15, b8);
    b8 = stwo_m31_mul(b16, b14);
    b14 = stwo_m31_add(b35, b8);
    b8 = stwo_m31_sub(b14, b69);
    b14 = stwo_m31_sub(b8, b75);
    b8 = stwo_m31_add(b70, b14);
    b14 = stwo_m31_mul(b0, b33);
    b0 = stwo_m31_mul(b16, b32);
    b35 = stwo_m31_add(b14, b0);
    b0 = stwo_m31_mul(b78, b79);
    b14 = stwo_m31_add(b35, b0);
    b0 = stwo_m31_mul(b13, b37);
    b35 = stwo_m31_add(b14, b0);
    b0 = stwo_m31_mul(b65, b36);
    b36 = stwo_m31_add(b35, b0);
    b0 = stwo_m31_sub(b36, b68);
    b36 = stwo_m31_sub(b0, b74);
    b0 = stwo_m31_add(b73, b36);
    b36 = stwo_m31_mul(b16, b33);
    b16 = stwo_m31_mul(b78, b32);
    b73 = stwo_m31_add(b36, b16);
    b16 = stwo_m31_mul(b13, b79);
    b36 = stwo_m31_add(b73, b16);
    b16 = stwo_m31_mul(b65, b37);
    b37 = stwo_m31_add(b36, b16);
    b16 = stwo_m31_sub(b37, b71);
    b37 = stwo_m31_sub(b16, b77);
    b16 = stwo_m31_add(b72, b37);
    b37 = stwo_m31_mul(b78, b33);
    b33 = stwo_m31_mul(b13, b32);
    b32 = stwo_m31_add(b37, b33);
    b33 = stwo_m31_mul(b65, b79);
    b79 = stwo_m31_add(b32, b33);
    b33 = stwo_m31_sub(b79, b70);
    b79 = stwo_m31_sub(b33, b76);
    b33 = stwo_m31_add(b75, b79);
    b79 = stwo_m31_mul(b2, b43);
    b75 = stwo_m31_mul(b20, b42);
    b70 = stwo_m31_add(b79, b75);
    b75 = stwo_m31_mul(b2, b44);
    b79 = stwo_m31_mul(b20, b43);
    b32 = stwo_m31_add(b75, b79);
    b79 = stwo_m31_mul(b21, b42);
    b75 = stwo_m31_add(b32, b79);
    b79 = stwo_m31_mul(b2, b45);
    b32 = stwo_m31_mul(b20, b44);
    b65 = stwo_m31_add(b79, b32);
    b32 = stwo_m31_mul(b21, b43);
    b79 = stwo_m31_add(b65, b32);
    b32 = stwo_m31_mul(b3, b42);
    b65 = stwo_m31_add(b79, b32);
    b32 = stwo_m31_mul(b3, b48);
    b79 = stwo_m31_mul(b22, b47);
    b37 = stwo_m31_add(b32, b79);
    b79 = stwo_m31_mul(b23, b46);
    b32 = stwo_m31_add(b37, b79);
    b79 = stwo_m31_mul(b4, b45);
    b37 = stwo_m31_add(b32, b79);
    b79 = stwo_m31_mul(b22, b48);
    b48 = stwo_m31_mul(b23, b47);
    b47 = stwo_m31_add(b79, b48);
    b48 = stwo_m31_mul(b4, b46);
    b4 = stwo_m31_add(b47, b48);
    b48 = stwo_m31_mul(b24, b51);
    b47 = stwo_m31_mul(b25, b50);
    b46 = stwo_m31_add(b48, b47);
    b47 = stwo_m31_mul(b5, b49);
    b48 = stwo_m31_add(b46, b47);
    b47 = stwo_m31_mul(b24, b52);
    b46 = stwo_m31_mul(b25, b51);
    b79 = stwo_m31_add(b47, b46);
    b46 = stwo_m31_mul(b5, b50);
    b47 = stwo_m31_add(b79, b46);
    b46 = stwo_m31_mul(b26, b49);
    b79 = stwo_m31_add(b47, b46);
    b46 = stwo_m31_mul(b26, b55);
    b47 = stwo_m31_mul(b27, b54);
    b23 = stwo_m31_add(b46, b47);
    b47 = stwo_m31_mul(b6, b53);
    b46 = stwo_m31_add(b23, b47);
    b47 = stwo_m31_mul(b9, b52);
    b23 = stwo_m31_add(b46, b47);
    b47 = stwo_m31_mul(b27, b55);
    b46 = stwo_m31_mul(b6, b54);
    b22 = stwo_m31_add(b47, b46);
    b46 = stwo_m31_mul(b9, b53);
    b47 = stwo_m31_add(b22, b46);
    b46 = stwo_m31_add(b2, b24);
    b24 = stwo_m31_add(b20, b25);
    b25 = stwo_m31_add(b21, b5);
    b5 = stwo_m31_add(b3, b26);
    b22 = stwo_m31_add(b42, b49);
    b49 = stwo_m31_add(b43, b50);
    b50 = stwo_m31_add(b44, b51);
    b51 = stwo_m31_add(b45, b52);
    b32 = stwo_m31_mul(b46, b50);
    b13 = stwo_m31_mul(b24, b49);
    b78 = stwo_m31_add(b32, b13);
    b13 = stwo_m31_mul(b25, b22);
    b32 = stwo_m31_add(b78, b13);
    b13 = stwo_m31_sub(b32, b75);
    b32 = stwo_m31_sub(b13, b48);
    b13 = stwo_m31_add(b37, b32);
    b32 = stwo_m31_mul(b46, b51);
    b51 = stwo_m31_mul(b24, b50);
    b50 = stwo_m31_add(b32, b51);
    b51 = stwo_m31_mul(b25, b49);
    b49 = stwo_m31_add(b50, b51);
    b51 = stwo_m31_mul(b5, b22);
    b22 = stwo_m31_add(b49, b51);
    b51 = stwo_m31_sub(b22, b65);
    b22 = stwo_m31_sub(b51, b79);
    b51 = stwo_m31_add(b4, b22);
    b22 = stwo_m31_add(b10, b2);
    b2 = stwo_m31_add(b11, b20);
    b20 = stwo_m31_add(b64, b21);
    b64 = stwo_m31_add(b12, b3);
    b3 = stwo_m31_add(b17, b26);
    ...
    b44 = stwo_m31_mul(b64, b19);
    b19 = stwo_m31_add(b42, b44);
    b44 = stwo_m31_mul(b3, b54);
    b3 = stwo_m31_mul(b26, b53);
    b42 = stwo_m31_add(b44, b3);
    b3 = stwo_m31_mul(b1, b52);
    b44 = stwo_m31_add(b42, b3);
    b3 = stwo_m31_mul(b6, b45);
    b45 = stwo_m31_add(b44, b3);
    b3 = stwo_m31_mul(b26, b54);
    b54 = stwo_m31_mul(b1, b53);
    b53 = stwo_m31_add(b3, b54);
    b54 = stwo_m31_mul(b6, b52);
    b52 = stwo_m31_add(b53, b54);
    b54 = stwo_m31_sub(b40, b67);
    b40 = stwo_m31_sub(b54, b70);
    b54 = stwo_m31_add(b0, b40);
    b40 = stwo_m31_sub(b41, b66);
    b41 = stwo_m31_sub(b40, b75);
    b40 = stwo_m31_add(b16, b41);
    b41 = stwo_m31_sub(b19, b69);
    b19 = stwo_m31_sub(b41, b65);
    b41 = stwo_m31_add(b33, b19);
    b19 = stwo_m31_sub(b45, b77);
    b45 = stwo_m31_sub(b19, b23);
    b19 = stwo_m31_add(b13, b45);
    b45 = stwo_m31_sub(b52, b76);
    b52 = stwo_m31_sub(b45, b47);
    b45 = stwo_m31_add(b51, b52);
    b52 = stwo_m31_sub(b80, b56);
    b80 = stwo_m31_sub(b8, b57);
    b8 = stwo_m31_sub(b54, b58);
    b54 = stwo_m31_sub(b40, b59);
    b40 = stwo_m31_sub(b41, b60);
    b41 = 2u;
    b60 = stwo_m31_mul(b41, b52);
