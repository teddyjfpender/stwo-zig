...
stwo_cairo_cuda_eval_v1_cc9aeb31521d25a7(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 52u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 53u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 58u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 59u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 60u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 579u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 580u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 585u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 586u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 587u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 614u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 615u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 616u, row, 0);
    unsigned b97 = 0u;
    ...
    b26 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b45, b73);
    b24 = stwo_m31_mul(b46, b72);
    b23 = stwo_m31_add(b27, b24);
    b24 = stwo_m31_mul(b46, b73);
    b27 = stwo_m31_add(b33, b40);
    ...
    b21 = stwo_m31_add(b19, b20);
    b20 = stwo_m31_mul(b44, b22);
    b19 = stwo_m31_add(b21, b20);
    b20 = stwo_m31_sub(b19, b30);
    b19 = stwo_m31_sub(b20, b25);
    b20 = stwo_m31_add(b29, b19);
    b19 = stwo_m31_mul(b27, b72);
    b27 = stwo_m31_mul(b40, b71);
    b40 = stwo_m31_add(b19, b27);
    b27 = stwo_m31_mul(b41, b70);
    b70 = stwo_m31_add(b40, b27);
    b27 = stwo_m31_mul(b42, b69);
    b69 = stwo_m31_add(b70, b27);
    b27 = stwo_m31_mul(b43, b68);
    b68 = stwo_m31_add(b69, b27);
    b27 = stwo_m31_mul(b44, b67);
    b67 = stwo_m31_add(b68, b27);
    b27 = stwo_m31_mul(b45, b22);
    b22 = stwo_m31_add(b67, b27);
    b27 = stwo_m31_sub(b22, b31);
    b22 = stwo_m31_sub(b27, b26);
    b27 = stwo_m31_mul(b44, b72);
    b44 = stwo_m31_mul(b45, b71);
    b71 = stwo_m31_add(b27, b44);
    b44 = stwo_m31_sub(b71, b28);
    b71 = stwo_m31_sub(b44, b23);
    b44 = stwo_m31_add(b32, b71);
    b71 = stwo_m31_mul(b45, b72);
    b72 = stwo_m31_sub(b71, b29);
    b71 = stwo_m31_sub(b72, b24);
    b72 = stwo_m31_add(b25, b71);
    b71 = stwo_m31_mul(b47, b78);
    b25 = stwo_m31_mul(b48, b77);
    b29 = stwo_m31_add(b71, b25);
    b25 = stwo_m31_mul(b49, b76);
    b71 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b50, b75);
    b29 = stwo_m31_add(b71, b25);
    b25 = stwo_m31_mul(b51, b74);
    b71 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b47, b79);
    b29 = stwo_m31_mul(b48, b78);
    b45 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_mul(b49, b77);
    b25 = stwo_m31_add(b45, b29);
    b29 = stwo_m31_mul(b50, b76);
    b45 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_mul(b51, b75);
    b25 = stwo_m31_add(b45, b29);
    b29 = stwo_m31_mul(b52, b74);
    b45 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_mul(b47, b80);
    b25 = stwo_m31_mul(b48, b79);
    b32 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b49, b78);
    b29 = stwo_m31_add(b32, b25);
    ...
    b29 = stwo_m31_add(b32, b25);
    b25 = stwo_m31_mul(b53, b80);
    b32 = stwo_m31_mul(b54, b86);
    b23 = stwo_m31_mul(b55, b85);
    b28 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b56, b84);
    b32 = stwo_m31_add(b28, b23);
    b23 = stwo_m31_mul(b57, b83);
    b28 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b58, b82);
    b32 = stwo_m31_add(b28, b23);
    b23 = stwo_m31_mul(b59, b81);
    b28 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b54, b87);
    b32 = stwo_m31_mul(b55, b86);
    b27 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b56, b85);
    b23 = stwo_m31_add(b27, b32);
    b32 = stwo_m31_mul(b57, b84);
    b27 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b58, b83);
    b23 = stwo_m31_add(b27, b32);
    b32 = stwo_m31_mul(b59, b82);
    b27 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b60, b81);
    b23 = stwo_m31_add(b27, b32);
    b32 = stwo_m31_mul(b60, b87);
    b27 = stwo_m31_add(b47, b54);
    ...
    b68 = stwo_m31_mul(b27, b85);
    b69 = stwo_m31_mul(b54, b84);
    b43 = stwo_m31_add(b68, b69);
    b69 = stwo_m31_mul(b55, b83);
    b68 = stwo_m31_add(b43, b69);
    b69 = stwo_m31_mul(b56, b82);
    b43 = stwo_m31_add(b68, b69);
    b69 = stwo_m31_mul(b57, b81);
    b68 = stwo_m31_add(b43, b69);
    b69 = stwo_m31_mul(b58, b67);
    b43 = stwo_m31_add(b68, b69);
    b69 = stwo_m31_sub(b43, b45);
    b43 = stwo_m31_sub(b69, b28);
    b69 = stwo_m31_add(b25, b43);
    b43 = stwo_m31_mul(b27, b86);
    b86 = stwo_m31_mul(b54, b85);
    b85 = stwo_m31_add(b43, b86);
    b86 = stwo_m31_mul(b55, b84);
    b84 = stwo_m31_add(b85, b86);
    b86 = stwo_m31_mul(b56, b83);
    b83 = stwo_m31_add(b84, b86);
    b86 = stwo_m31_mul(b57, b82);
    b82 = stwo_m31_add(b83, b86);
    b86 = stwo_m31_mul(b58, b81);
    b81 = stwo_m31_add(b82, b86);
    b86 = stwo_m31_mul(b59, b67);
    b67 = stwo_m31_add(b81, b86);
    b86 = stwo_m31_sub(b67, b29);
    b67 = stwo_m31_sub(b86, b23);
    b86 = stwo_m31_add(b33, b47);
    ...
    b87 = stwo_m31_mul(b86, b77);
    b73 = stwo_m31_mul(b47, b76);
    b66 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b48, b75);
    b87 = stwo_m31_add(b66, b73);
    b73 = stwo_m31_mul(b49, b74);
    b66 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b50, b60);
    b87 = stwo_m31_add(b66, b73);
    b73 = stwo_m31_mul(b86, b78);
    b66 = stwo_m31_mul(b47, b77);
    b65 = stwo_m31_add(b73, b66);
    b66 = stwo_m31_mul(b48, b76);
    b73 = stwo_m31_add(b65, b66);
    b66 = stwo_m31_mul(b49, b75);
    b65 = stwo_m31_add(b73, b66);
    b66 = stwo_m31_mul(b50, b74);
    b73 = stwo_m31_add(b65, b66);
    b66 = stwo_m31_mul(b51, b60);
    b65 = stwo_m31_add(b73, b66);
    b66 = stwo_m31_mul(b86, b79);
    b79 = stwo_m31_mul(b47, b78);
    b78 = stwo_m31_add(b66, b79);
    b79 = stwo_m31_mul(b48, b77);
    b77 = stwo_m31_add(b78, b79);
    b79 = stwo_m31_mul(b49, b76);
    b76 = stwo_m31_add(b77, b79);
    b79 = stwo_m31_mul(b50, b75);
    b75 = stwo_m31_add(b76, b79);
    b79 = stwo_m31_mul(b51, b74);
    b74 = stwo_m31_add(b75, b79);
    b79 = stwo_m31_mul(b52, b60);
    b60 = stwo_m31_add(b74, b79);
    b79 = stwo_m31_mul(b53, b80);
    b80 = stwo_m31_sub(b87, b93);
    b87 = stwo_m31_sub(b80, b71);
    b80 = stwo_m31_add(b44, b87);
    b87 = stwo_m31_sub(b65, b30);
    b65 = stwo_m31_sub(b87, b45);
    b87 = stwo_m31_add(b72, b65);
    b65 = stwo_m31_sub(b60, b31);
    b60 = stwo_m31_sub(b65, b29);
    b65 = stwo_m31_add(b26, b60);
    b60 = stwo_m31_sub(b79, b24);
    b79 = stwo_m31_sub(b60, b32);
    b60 = stwo_m31_add(b69, b79);
    b79 = stwo_m31_sub(b20, b88);
    b20 = stwo_m31_sub(b22, b89);
    b22 = stwo_m31_sub(b80, b90);
    b80 = stwo_m31_sub(b87, b91);
    b87 = stwo_m31_sub(b65, b92);
    b65 = 2u;
    b92 = stwo_m31_mul(b65, b79);
    b65 = stwo_m31_add(b92, b22);
    b92 = 32u;
    b22 = stwo_m31_mul(b92, b80);
    b92 = stwo_m31_add(b65, b22);
    b22 = 4u;
    b65 = stwo_m31_mul(b22, b60);
    b22 = stwo_m31_sub(b92, b65);
    b65 = 2u;
    b92 = stwo_m31_mul(b65, b20);
    b65 = stwo_m31_add(b92, b80);
    b92 = 32u;
    b80 = stwo_m31_mul(b92, b87);
    b92 = stwo_m31_add(b65, b80);
    b80 = 4u;
    b65 = stwo_m31_mul(b80, b67);
    b80 = stwo_m31_sub(b92, b65);
    b65 = 512u;
    b92 = stwo_m31_mul(b95, b65);
    b65 = stwo_m31_add(b22, b94);
    b22 = stwo_m31_sub(b92, b65);
    b65 = 512u;
    b92 = stwo_m31_mul(b96, b65);
    b65 = stwo_m31_add(b80, b95);
    b80 = stwo_m31_sub(b92, b65);
    StwoCairoQm31 e0 = { b22, b97, b97, b97 };
    StwoCairoQm31 e1 = { b80, b97, b97, b97 };
