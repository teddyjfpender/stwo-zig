...
stwo_cairo_cuda_eval_v1_9c1ac90cc33954f6(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b59 = stwo_trace_value(arena, *args, 1u, 102u, row, 0);
    unsigned b60 = stwo_trace_value(arena, *args, 1u, 103u, row, 0);
    unsigned b61 = stwo_trace_value(arena, *args, 1u, 130u, row, 0);
    unsigned b62 = stwo_trace_value(arena, *args, 1u, 131u, row, 0);
    unsigned b63 = stwo_trace_value(arena, *args, 1u, 132u, row, 0);
    ...
    unsigned b66 = stwo_m31_mul(b11, b30);
    unsigned b67 = stwo_m31_add(b8, b66);
    b66 = stwo_m31_mul(b64, b29);
    b8 = stwo_m31_add(b67, b66);
    b66 = stwo_m31_mul(b12, b28);
    b67 = stwo_m31_add(b8, b66);
    b66 = stwo_m31_mul(b10, b32);
    b8 = stwo_m31_mul(b11, b31);
    unsigned b68 = stwo_m31_add(b66, b8);
    b8 = stwo_m31_mul(b64, b30);
    b66 = stwo_m31_add(b68, b8);
    b8 = stwo_m31_mul(b12, b29);
    b68 = stwo_m31_add(b66, b8);
    b8 = stwo_m31_mul(b13, b28);
    b66 = stwo_m31_add(b68, b8);
    b8 = stwo_m31_mul(b10, b33);
    b68 = stwo_m31_mul(b11, b32);
    unsigned b69 = stwo_m31_add(b8, b68);
    b68 = stwo_m31_mul(b64, b31);
    b8 = stwo_m31_add(b69, b68);
    b68 = stwo_m31_mul(b12, b30);
    b69 = stwo_m31_add(b8, b68);
    b68 = stwo_m31_mul(b13, b29);
    b8 = stwo_m31_add(b69, b68);
    b68 = stwo_m31_mul(b65, b28);
    b69 = stwo_m31_add(b8, b68);
    b68 = stwo_m31_mul(b13, b34);
    b8 = stwo_m31_mul(b65, b33);
    unsigned b70 = stwo_m31_add(b68, b8);
    b8 = stwo_m31_mul(b14, b32);
    b68 = stwo_m31_add(b70, b8);
    b8 = stwo_m31_mul(b65, b34);
    b70 = stwo_m31_mul(b14, b33);
    unsigned b71 = stwo_m31_add(b8, b70);
    b70 = stwo_m31_mul(b14, b34);
    b8 = stwo_m31_mul(b15, b38);
    unsigned b72 = stwo_m31_mul(b0, b37);
    unsigned b73 = stwo_m31_add(b8, b72);
    b72 = stwo_m31_mul(b16, b36);
    b8 = stwo_m31_add(b73, b72);
    b72 = stwo_m31_mul(b17, b35);
    b73 = stwo_m31_add(b8, b72);
    b72 = stwo_m31_mul(b15, b39);
    b8 = stwo_m31_mul(b0, b38);
    unsigned b74 = stwo_m31_add(b72, b8);
    b8 = stwo_m31_mul(b16, b37);
    b72 = stwo_m31_add(b74, b8);
    b8 = stwo_m31_mul(b17, b36);
    b74 = stwo_m31_add(b72, b8);
    b8 = stwo_m31_mul(b1, b35);
    b72 = stwo_m31_add(b74, b8);
    b8 = stwo_m31_mul(b15, b40);
    b74 = stwo_m31_mul(b0, b39);
    unsigned b75 = stwo_m31_add(b8, b74);
    b74 = stwo_m31_mul(b16, b38);
    b8 = stwo_m31_add(b75, b74);
    b74 = stwo_m31_mul(b17, b37);
    b75 = stwo_m31_add(b8, b74);
    b74 = stwo_m31_mul(b1, b36);
    b8 = stwo_m31_add(b75, b74);
    b74 = stwo_m31_mul(b18, b35);
    b75 = stwo_m31_add(b8, b74);
    b74 = stwo_m31_mul(b1, b41);
    b8 = stwo_m31_mul(b18, b40);
    unsigned b76 = stwo_m31_add(b74, b8);
    b8 = stwo_m31_mul(b19, b39);
    b74 = stwo_m31_add(b76, b8);
    b8 = stwo_m31_mul(b18, b41);
    b76 = stwo_m31_mul(b19, b40);
    unsigned b77 = stwo_m31_add(b8, b76);
    b76 = stwo_m31_mul(b19, b41);
    b8 = stwo_m31_add(b10, b15);
    b15 = stwo_m31_add(b11, b0);
    b0 = stwo_m31_add(b64, b16);
    b16 = stwo_m31_add(b12, b17);
    b17 = stwo_m31_add(b13, b1);
    b1 = stwo_m31_add(b65, b18);
    unsigned b78 = stwo_m31_add(b14, b19);
    ...
    unsigned b79 = stwo_m31_add(b34, b41);
    b34 = stwo_m31_mul(b8, b38);
    unsigned b80 = stwo_m31_mul(b15, b37);
    unsigned b81 = stwo_m31_add(b34, b80);
    b80 = stwo_m31_mul(b0, b36);
    b34 = stwo_m31_add(b81, b80);
    b80 = stwo_m31_mul(b16, b35);
    b81 = stwo_m31_add(b34, b80);
    b80 = stwo_m31_mul(b17, b14);
    b34 = stwo_m31_add(b81, b80);
    b80 = stwo_m31_sub(b34, b66);
    b34 = stwo_m31_sub(b80, b72);
    b80 = stwo_m31_add(b71, b34);
    b34 = stwo_m31_mul(b8, b39);
    b8 = stwo_m31_mul(b15, b38);
    b15 = stwo_m31_add(b34, b8);
    b8 = stwo_m31_mul(b0, b37);
    b37 = stwo_m31_add(b15, b8);
    b8 = stwo_m31_mul(b16, b36);
    b36 = stwo_m31_add(b37, b8);
    b8 = stwo_m31_mul(b17, b35);
    b35 = stwo_m31_add(b36, b8);
    b8 = stwo_m31_mul(b1, b14);
    b14 = stwo_m31_add(b35, b8);
    b8 = stwo_m31_sub(b14, b69);
    b14 = stwo_m31_sub(b8, b75);
    b8 = stwo_m31_add(b70, b14);
    b14 = stwo_m31_mul(b17, b79);
    b17 = stwo_m31_mul(b1, b39);
    b35 = stwo_m31_add(b14, b17);
    b17 = stwo_m31_mul(b78, b38);
    b38 = stwo_m31_add(b35, b17);
    b17 = stwo_m31_sub(b38, b68);
    b38 = stwo_m31_sub(b17, b74);
    b17 = stwo_m31_add(b73, b38);
    b38 = stwo_m31_mul(b1, b79);
    b1 = stwo_m31_mul(b78, b39);
    b39 = stwo_m31_add(b38, b1);
    b1 = stwo_m31_sub(b39, b71);
    b39 = stwo_m31_sub(b1, b77);
    b1 = stwo_m31_add(b72, b39);
    b39 = stwo_m31_mul(b78, b79);
    b79 = stwo_m31_sub(b39, b70);
    b39 = stwo_m31_sub(b79, b76);
    b79 = stwo_m31_add(b75, b39);
    b39 = stwo_m31_mul(b2, b45);
    b75 = stwo_m31_mul(b20, b44);
    b70 = stwo_m31_add(b39, b75);
    b75 = stwo_m31_mul(b21, b43);
    b39 = stwo_m31_add(b70, b75);
    b75 = stwo_m31_mul(b3, b42);
    b70 = stwo_m31_add(b39, b75);
    b75 = stwo_m31_mul(b2, b46);
    b39 = stwo_m31_mul(b20, b45);
    b78 = stwo_m31_add(b75, b39);
    b39 = stwo_m31_mul(b21, b44);
    b75 = stwo_m31_add(b78, b39);
    b39 = stwo_m31_mul(b3, b43);
    b78 = stwo_m31_add(b75, b39);
    b39 = stwo_m31_mul(b22, b42);
    b75 = stwo_m31_add(b78, b39);
    b39 = stwo_m31_mul(b2, b47);
    b78 = stwo_m31_mul(b20, b46);
    b72 = stwo_m31_add(b39, b78);
    b78 = stwo_m31_mul(b21, b45);
    b39 = stwo_m31_add(b72, b78);
    b78 = stwo_m31_mul(b3, b44);
    b72 = stwo_m31_add(b39, b78);
    b78 = stwo_m31_mul(b22, b43);
    b39 = stwo_m31_add(b72, b78);
    b78 = stwo_m31_mul(b23, b42);
    b72 = stwo_m31_add(b39, b78);
    b78 = stwo_m31_mul(b23, b48);
    b39 = stwo_m31_mul(b4, b47);
    b71 = stwo_m31_add(b78, b39);
    b39 = stwo_m31_mul(b4, b48);
    b4 = stwo_m31_mul(b24, b53);
    b48 = stwo_m31_mul(b25, b52);
    b78 = stwo_m31_add(b4, b48);
    b48 = stwo_m31_mul(b5, b51);
    b4 = stwo_m31_add(b78, b48);
    b48 = stwo_m31_mul(b26, b50);
    b78 = stwo_m31_add(b4, b48);
    b48 = stwo_m31_mul(b27, b49);
    b4 = stwo_m31_add(b78, b48);
    b48 = stwo_m31_mul(b24, b54);
    b78 = stwo_m31_mul(b25, b53);
    b38 = stwo_m31_add(b48, b78);
    b78 = stwo_m31_mul(b5, b52);
    b48 = stwo_m31_add(b38, b78);
    b78 = stwo_m31_mul(b26, b51);
    b38 = stwo_m31_add(b48, b78);
    b78 = stwo_m31_mul(b27, b50);
    b48 = stwo_m31_add(b38, b78);
    b78 = stwo_m31_mul(b6, b49);
    b38 = stwo_m31_add(b48, b78);
    b78 = stwo_m31_mul(b6, b55);
    b48 = stwo_m31_mul(b9, b54);
    b73 = stwo_m31_add(b78, b48);
    b48 = stwo_m31_mul(b9, b55);
    b78 = stwo_m31_add(b2, b24);
    b24 = stwo_m31_add(b20, b25);
    b25 = stwo_m31_add(b21, b5);
    b5 = stwo_m31_add(b3, b26);
    b26 = stwo_m31_add(b22, b27);
    b27 = stwo_m31_add(b23, b6);
    b74 = stwo_m31_add(b42, b49);
    b49 = stwo_m31_add(b43, b50);
    b50 = stwo_m31_add(b44, b51);
    b51 = stwo_m31_add(b45, b52);
    b52 = stwo_m31_add(b46, b53);
    b53 = stwo_m31_add(b47, b54);
    b68 = stwo_m31_mul(b78, b52);
    b35 = stwo_m31_mul(b24, b51);
    b14 = stwo_m31_add(b68, b35);
    b35 = stwo_m31_mul(b25, b50);
    b68 = stwo_m31_add(b14, b35);
    b35 = stwo_m31_mul(b5, b49);
    b14 = stwo_m31_add(b68, b35);
    b35 = stwo_m31_mul(b26, b74);
    b68 = stwo_m31_add(b14, b35);
    b35 = stwo_m31_sub(b68, b75);
    b68 = stwo_m31_sub(b35, b4);
    b35 = stwo_m31_add(b71, b68);
    b68 = stwo_m31_mul(b78, b53);
    b53 = stwo_m31_mul(b24, b52);
    b52 = stwo_m31_add(b68, b53);
    b53 = stwo_m31_mul(b25, b51);
    b51 = stwo_m31_add(b52, b53);
    b53 = stwo_m31_mul(b5, b50);
    b50 = stwo_m31_add(b51, b53);
    b53 = stwo_m31_mul(b26, b49);
    b49 = stwo_m31_add(b50, b53);
    b53 = stwo_m31_mul(b27, b74);
    b74 = stwo_m31_add(b49, b53);
    b53 = stwo_m31_sub(b74, b72);
    b74 = stwo_m31_sub(b53, b38);
    b53 = stwo_m31_add(b39, b74);
    b74 = stwo_m31_add(b10, b2);
    b2 = stwo_m31_add(b11, b20);
    b20 = stwo_m31_add(b64, b21);
    b64 = stwo_m31_add(b12, b3);
    b3 = stwo_m31_add(b13, b22);
    b22 = stwo_m31_add(b65, b23);
    b65 = stwo_m31_add(b18, b6);
    ...
    b47 = stwo_m31_add(b40, b54);
    b54 = stwo_m31_add(b41, b55);
    b55 = stwo_m31_mul(b74, b44);
    b41 = stwo_m31_mul(b2, b43);
    b40 = stwo_m31_add(b55, b41);
    b41 = stwo_m31_mul(b20, b42);
    b55 = stwo_m31_add(b40, b41);
    b41 = stwo_m31_mul(b64, b19);
    b40 = stwo_m31_add(b55, b41);
    b41 = stwo_m31_mul(b74, b45);
    b55 = stwo_m31_mul(b2, b44);
    b33 = stwo_m31_add(b41, b55);
    b55 = stwo_m31_mul(b20, b43);
    b41 = stwo_m31_add(b33, b55);
    b55 = stwo_m31_mul(b64, b42);
    b33 = stwo_m31_add(b41, b55);
    b55 = stwo_m31_mul(b3, b19);
    b41 = stwo_m31_add(b33, b55);
    b55 = stwo_m31_mul(b74, b46);
    b46 = stwo_m31_mul(b2, b45);
    b45 = stwo_m31_add(b55, b46);
    b46 = stwo_m31_mul(b20, b44);
    b44 = stwo_m31_add(b45, b46);
    b46 = stwo_m31_mul(b64, b43);
    b43 = stwo_m31_add(b44, b46);
    b46 = stwo_m31_mul(b3, b42);
    b42 = stwo_m31_add(b43, b46);
    b46 = stwo_m31_mul(b22, b19);
    b19 = stwo_m31_add(b42, b46);
    b46 = stwo_m31_mul(b65, b54);
    b65 = stwo_m31_mul(b6, b47);
    b47 = stwo_m31_add(b46, b65);
    b65 = stwo_m31_mul(b6, b54);
    b54 = stwo_m31_sub(b40, b67);
    b40 = stwo_m31_sub(b54, b70);
    b54 = stwo_m31_add(b17, b40);
    b40 = stwo_m31_sub(b41, b66);
    b41 = stwo_m31_sub(b40, b75);
    b40 = stwo_m31_add(b1, b41);
    b41 = stwo_m31_sub(b19, b69);
    b19 = stwo_m31_sub(b41, b72);
    b41 = stwo_m31_add(b79, b19);
    b19 = stwo_m31_sub(b47, b77);
    b47 = stwo_m31_sub(b19, b73);
    b19 = stwo_m31_add(b35, b47);
    b47 = stwo_m31_sub(b65, b76);
    b65 = stwo_m31_sub(b47, b48);
    b47 = stwo_m31_add(b53, b65);
    b65 = stwo_m31_sub(b80, b56);
    b80 = stwo_m31_sub(b8, b57);
    b8 = stwo_m31_sub(b54, b58);
    b54 = stwo_m31_sub(b40, b59);
    b40 = stwo_m31_sub(b41, b60);
    b41 = 2u;
    b60 = stwo_m31_mul(b41, b65);
    b41 = stwo_m31_add(b60, b8);
    b60 = 32u;
    b8 = stwo_m31_mul(b60, b54);
    b60 = stwo_m31_add(b41, b8);
    b8 = 4u;
    b41 = stwo_m31_mul(b8, b19);
    b8 = stwo_m31_sub(b60, b41);
    b41 = 2u;
    b60 = stwo_m31_mul(b41, b80);
    b41 = stwo_m31_add(b60, b54);
    b60 = 32u;
    b54 = stwo_m31_mul(b60, b40);
    b60 = stwo_m31_add(b41, b54);
    b54 = 4u;
    b41 = stwo_m31_mul(b54, b47);
    b54 = stwo_m31_sub(b60, b41);
    b41 = 512u;
    b60 = stwo_m31_mul(b62, b41);
    b41 = stwo_m31_add(b8, b61);
    b8 = stwo_m31_sub(b60, b41);
    b41 = 512u;
    b60 = stwo_m31_mul(b63, b41);
    b41 = stwo_m31_add(b54, b62);
    b54 = stwo_m31_sub(b60, b41);
    StwoCairoQm31 e0 = { b8, b7, b7, b7 };
    StwoCairoQm31 e1 = { b54, b7, b7, b7 };
