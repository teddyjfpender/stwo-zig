...
stwo_cairo_cuda_eval_v1_92d73a230191b024(
    unsigned *arena,
    u64 arena_words,
    ...
    b14 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    ...
    unsigned b32 = stwo_trace_value(arena, *args, 2u, 8u, row, 0);
    unsigned b33 = stwo_trace_value(arena, *args, 2u, 9u, row, 0);
    unsigned b34 = stwo_trace_value(arena, *args, 2u, 10u, row, 0);
    unsigned b35 = stwo_trace_value(arena, *args, 2u, 11u, row, 0);
    unsigned b36 = stwo_trace_value(arena, *args, 2u, 12u, row, -1);
    unsigned b37 = stwo_trace_value(arena, *args, 2u, 12u, row, 0);
    unsigned b38 = stwo_trace_value(arena, *args, 2u, 13u, row, -1);
    unsigned b39 = stwo_trace_value(arena, *args, 2u, 13u, row, 0);
    unsigned b40 = stwo_trace_value(arena, *args, 2u, 14u, row, -1);
    unsigned b41 = stwo_trace_value(arena, *args, 2u, 14u, row, 0);
    unsigned b42 = stwo_trace_value(arena, *args, 2u, 15u, row, -1);
    unsigned b43 = stwo_trace_value(arena, *args, 2u, 15u, row, 0);
    StwoCairoQm31 e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e1 = { b0, b16, b16, b16 };
    ...
    StwoCairoQm31 e5 = { b3, b16, b16, b16 };
    ...
    e5 = stwo_load_qm31(arena, args->ext_params + 19u * 4u);
    e2 = { b17, b16, b16, b16 };
    ...
    e8 = stwo_load_qm31(arena, args->ext_params + 22u * 4u);
    e5 = stwo_qm31_sub(e7, e8);
    e8 = { b22, b16, b16, b16 };
    e7 = { b21, b16, b16, b16 };
    e2 = stwo_load_qm31(arena, args->ext_params + 23u * 4u);
    StwoCairoQm31 e9 = { b9, b16, b16, b16 };
    ...
    e11 = { b15, b16, b16, b16 };
    e2 = stwo_qm31_neg(e11);
    e11 = stwo_load_qm31(arena, args->ext_params + 35u * 4u);
    e13 = { b24, b16, b16, b16 };
    StwoCairoQm31 e14 = stwo_qm31_mul(e11, e13);
    ...
    e15 = stwo_load_qm31(arena, args->ext_params + 38u * 4u);
    e11 = { b25, b16, b16, b16 };
    ...
    e5 = stwo_load_qm31(arena, args->ext_params + 44u * 4u);
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e8, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 2u) * 4u)));
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e15, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 5u) * 4u)));
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e13, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 6u) * 4u)));
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e1, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 7u) * 4u)));
