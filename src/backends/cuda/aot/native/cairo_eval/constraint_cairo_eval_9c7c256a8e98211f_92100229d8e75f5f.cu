...
stwo_cairo_cuda_eval_v1_4e6ff05f7d619d1b(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 189u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 190u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 191u, row, 0);
    unsigned b97 = 0u;
