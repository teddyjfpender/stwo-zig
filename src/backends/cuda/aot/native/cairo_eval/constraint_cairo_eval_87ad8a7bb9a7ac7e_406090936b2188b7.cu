...
stwo_cairo_cuda_eval_v1_1d96fd09e5f480bb(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b59 = stwo_trace_value(arena, *args, 1u, 110u, row, 0);
    unsigned b60 = stwo_trace_value(arena, *args, 1u, 111u, row, 0);
    ...
    b67 = stwo_m31_add(b69, b66);
    b66 = stwo_m31_mul(b14, b34);
    b69 = stwo_m31_mul(b15, b40);
    unsigned b70 = stwo_m31_mul(b0, b39);
    unsigned b71 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b16, b38);
    b69 = stwo_m31_add(b71, b70);
    b70 = stwo_m31_mul(b17, b37);
    b71 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b1, b36);
    b69 = stwo_m31_add(b71, b70);
    b70 = stwo_m31_mul(b18, b35);
    b71 = stwo_m31_add(b69, b70);
    b70 = stwo_m31_mul(b15, b41);
    b69 = stwo_m31_mul(b0, b40);
    unsigned b72 = stwo_m31_add(b70, b69);
    b69 = stwo_m31_mul(b16, b39);
    b70 = stwo_m31_add(b72, b69);
    b69 = stwo_m31_mul(b17, b38);
    b72 = stwo_m31_add(b70, b69);
    b69 = stwo_m31_mul(b1, b37);
    b70 = stwo_m31_add(b72, b69);
    b69 = stwo_m31_mul(b18, b36);
    b72 = stwo_m31_add(b70, b69);
    b69 = stwo_m31_mul(b19, b35);
    b70 = stwo_m31_add(b72, b69);
    b69 = stwo_m31_mul(b19, b41);
    b72 = stwo_m31_add(b10, b15);
    unsigned b73 = stwo_m31_add(b11, b0);
    unsigned b74 = stwo_m31_add(b64, b16);
    unsigned b75 = stwo_m31_add(b12, b17);
    unsigned b76 = stwo_m31_add(b13, b1);
    unsigned b77 = stwo_m31_add(b65, b18);
    unsigned b78 = stwo_m31_add(b14, b19);
    unsigned b79 = stwo_m31_add(b28, b35);
    unsigned b80 = stwo_m31_add(b29, b36);
    ...
    b85 = stwo_m31_mul(b2, b47);
    b70 = stwo_m31_mul(b20, b46);
    b80 = stwo_m31_add(b85, b70);
    b70 = stwo_m31_mul(b21, b45);
    b85 = stwo_m31_add(b80, b70);
    b70 = stwo_m31_mul(b3, b44);
    b80 = stwo_m31_add(b85, b70);
    b70 = stwo_m31_mul(b22, b43);
    b85 = stwo_m31_add(b80, b70);
    b70 = stwo_m31_mul(b23, b42);
    b80 = stwo_m31_add(b85, b70);
    b70 = stwo_m31_mul(b2, b48);
    b85 = stwo_m31_mul(b20, b47);
    b78 = stwo_m31_add(b70, b85);
    b85 = stwo_m31_mul(b21, b46);
    b70 = stwo_m31_add(b78, b85);
    b85 = stwo_m31_mul(b3, b45);
    b78 = stwo_m31_add(b70, b85);
    b85 = stwo_m31_mul(b22, b44);
    b70 = stwo_m31_add(b78, b85);
    b85 = stwo_m31_mul(b23, b43);
    b78 = stwo_m31_add(b70, b85);
    b85 = stwo_m31_mul(b4, b42);
    b70 = stwo_m31_add(b78, b85);
    b85 = stwo_m31_mul(b4, b48);
    b78 = stwo_m31_mul(b24, b54);
    b81 = stwo_m31_mul(b25, b53);
    b77 = stwo_m31_add(b78, b81);
    b81 = stwo_m31_mul(b5, b52);
    b78 = stwo_m31_add(b77, b81);
    b81 = stwo_m31_mul(b26, b51);
    b77 = stwo_m31_add(b78, b81);
    b81 = stwo_m31_mul(b27, b50);
    b78 = stwo_m31_add(b77, b81);
    b81 = stwo_m31_mul(b6, b49);
    b77 = stwo_m31_add(b78, b81);
    b81 = stwo_m31_mul(b24, b55);
    b78 = stwo_m31_mul(b25, b54);
    b82 = stwo_m31_add(b81, b78);
    b78 = stwo_m31_mul(b5, b53);
    b81 = stwo_m31_add(b82, b78);
    b78 = stwo_m31_mul(b26, b52);
    b82 = stwo_m31_add(b81, b78);
    b78 = stwo_m31_mul(b27, b51);
    b81 = stwo_m31_add(b82, b78);
    b78 = stwo_m31_mul(b6, b50);
    b82 = stwo_m31_add(b81, b78);
    b78 = stwo_m31_mul(b9, b49);
    b81 = stwo_m31_add(b82, b78);
    b78 = stwo_m31_mul(b9, b55);
    b82 = stwo_m31_add(b2, b24);
    b76 = stwo_m31_add(b20, b25);
    b83 = stwo_m31_add(b21, b5);
    b75 = stwo_m31_add(b3, b26);
    b84 = stwo_m31_add(b22, b27);
    b74 = stwo_m31_add(b23, b6);
    b88 = stwo_m31_add(b4, b9);
    b73 = stwo_m31_add(b42, b49);
    b72 = stwo_m31_add(b43, b50);
    b66 = stwo_m31_add(b44, b51);
    b71 = stwo_m31_add(b45, b52);
    b86 = stwo_m31_add(b46, b53);
    unsigned b89 = stwo_m31_add(b47, b54);
    unsigned b90 = stwo_m31_add(b48, b55);
    ...
    b55 = stwo_m31_mul(b90, b46);
    b41 = stwo_m31_mul(b2, b45);
    b40 = stwo_m31_add(b55, b41);
    b41 = stwo_m31_mul(b20, b44);
    b55 = stwo_m31_add(b40, b41);
    b41 = stwo_m31_mul(b64, b43);
    b40 = stwo_m31_add(b55, b41);
    b41 = stwo_m31_mul(b3, b42);
    b55 = stwo_m31_add(b40, b41);
    b41 = stwo_m31_mul(b22, b19);
    b40 = stwo_m31_add(b55, b41);
    b41 = stwo_m31_mul(b90, b47);
    b55 = stwo_m31_mul(b2, b46);
    b39 = stwo_m31_add(b41, b55);
    b55 = stwo_m31_mul(b20, b45);
    b41 = stwo_m31_add(b39, b55);
    b55 = stwo_m31_mul(b64, b44);
    b39 = stwo_m31_add(b41, b55);
    b55 = stwo_m31_mul(b3, b43);
    b41 = stwo_m31_add(b39, b55);
    b55 = stwo_m31_mul(b22, b42);
    b39 = stwo_m31_add(b41, b55);
    b55 = stwo_m31_mul(b65, b19);
    b41 = stwo_m31_add(b39, b55);
    b55 = stwo_m31_mul(b65, b47);
    ...
    b39 = stwo_m31_mul(b24, b53);
    b36 = stwo_m31_add(b38, b39);
    b39 = stwo_m31_mul(b0, b52);
    b38 = stwo_m31_add(b36, b39);
    b39 = stwo_m31_mul(b5, b51);
    b36 = stwo_m31_add(b38, b39);
    b39 = stwo_m31_mul(b26, b50);
    b38 = stwo_m31_add(b36, b39);
    b39 = stwo_m31_mul(b1, b49);
    b36 = stwo_m31_add(b38, b39);
    b39 = stwo_m31_mul(b6, b48);
    b38 = stwo_m31_add(b36, b39);
    b39 = stwo_m31_add(b90, b4);
    ...
    b54 = stwo_m31_mul(b39, b52);
    b47 = stwo_m31_mul(b4, b51);
    b46 = stwo_m31_add(b54, b47);
    b47 = stwo_m31_mul(b24, b50);
    b54 = stwo_m31_add(b46, b47);
    b47 = stwo_m31_mul(b0, b49);
    b46 = stwo_m31_add(b54, b47);
    b47 = stwo_m31_mul(b5, b48);
    b54 = stwo_m31_add(b46, b47);
    b47 = stwo_m31_mul(b26, b6);
    b46 = stwo_m31_add(b54, b47);
    b47 = stwo_m31_sub(b46, b40);
    b46 = stwo_m31_sub(b47, b37);
    b47 = stwo_m31_add(b55, b46);
    b46 = stwo_m31_mul(b39, b53);
    b53 = stwo_m31_mul(b4, b52);
    b52 = stwo_m31_add(b46, b53);
    b53 = stwo_m31_mul(b24, b51);
    b51 = stwo_m31_add(b52, b53);
    b53 = stwo_m31_mul(b0, b50);
    b50 = stwo_m31_add(b51, b53);
    b53 = stwo_m31_mul(b5, b49);
    b49 = stwo_m31_add(b50, b53);
    b53 = stwo_m31_mul(b26, b48);
    b48 = stwo_m31_add(b49, b53);
    b53 = stwo_m31_mul(b1, b6);
    b6 = stwo_m31_add(b48, b53);
    b53 = stwo_m31_sub(b6, b41);
    b6 = stwo_m31_sub(b53, b38);
    b53 = stwo_m31_sub(b47, b87);
    b47 = stwo_m31_sub(b53, b92);
    b53 = stwo_m31_add(b69, b47);
    b47 = stwo_m31_sub(b6, b79);
    b6 = stwo_m31_sub(b47, b73);
    b47 = stwo_m31_sub(b8, b56);
    b8 = stwo_m31_sub(b68, b57);
    b68 = stwo_m31_sub(b67, b58);
    b67 = stwo_m31_sub(b53, b59);
    b53 = stwo_m31_sub(b6, b60);
    b6 = 32u;
    b60 = stwo_m31_mul(b6, b8);
    b6 = stwo_m31_add(b47, b60);
    b60 = 4u;
    b47 = stwo_m31_mul(b60, b67);
    b60 = stwo_m31_sub(b6, b47);
    b47 = 8u;
    b6 = stwo_m31_mul(b47, b78);
    b47 = stwo_m31_add(b60, b6);
    b6 = 32u;
    b60 = stwo_m31_mul(b6, b68);
    b6 = stwo_m31_add(b8, b60);
    b60 = 4u;
    b8 = stwo_m31_mul(b60, b53);
    b60 = stwo_m31_sub(b6, b8);
    b8 = 512u;
    b6 = stwo_m31_mul(b62, b8);
    b8 = stwo_m31_add(b47, b61);
    b47 = stwo_m31_sub(b6, b8);
    b8 = 512u;
    b6 = stwo_m31_mul(b63, b8);
    b8 = stwo_m31_add(b60, b62);
    b60 = stwo_m31_sub(b6, b8);
