...
stwo_cairo_cuda_eval_v1_56d378b6cfc93c5a(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 163u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 164u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 165u, row, 0);
    unsigned b97 = 0u;
