...
stwo_cairo_cuda_eval_v1_893859ea21efc9d0(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b64 = stwo_trace_value(arena, *args, 1u, 107u, row, 0);
    unsigned b65 = stwo_trace_value(arena, *args, 1u, 108u, row, 0);
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 185u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 186u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 187u, row, 0);
    unsigned b97 = 0u;
