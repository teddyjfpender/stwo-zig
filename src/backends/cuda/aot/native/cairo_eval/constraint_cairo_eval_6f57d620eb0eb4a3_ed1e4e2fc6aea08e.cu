...
stwo_cairo_cuda_eval_v1_78e8616cbafed7d8(
    unsigned *arena,
    u64 arena_words,
    ...
    b22 = 256u;
    unsigned b23 = stwo_m31_mul(b7, b22);
    b22 = stwo_m31_sub(b1, b23);
    b23 = 256u;
    unsigned b24 = stwo_m31_mul(b8, b23);
    b23 = stwo_m31_sub(b2, b24);
    b24 = 256u;
    unsigned b25 = stwo_m31_mul(b9, b24);
    b24 = stwo_m31_sub(b3, b25);
    b25 = 256u;
    unsigned b26 = stwo_m31_mul(b10, b25);
    b25 = stwo_m31_sub(b4, b26);
    b26 = 256u;
    unsigned b27 = stwo_m31_mul(b11, b26);
    b26 = stwo_m31_sub(b5, b27);
    b27 = 0u;
    unsigned b28 = 256u;
    unsigned b29 = stwo_m31_mul(b15, b28);
    b28 = stwo_m31_add(b13, b29);
    b29 = 256u;
    unsigned b30 = stwo_m31_mul(b19, b29);
    b29 = stwo_m31_add(b17, b30);
    b30 = stwo_m31_mul(b20, b20);
    unsigned b31 = stwo_m31_sub(b30, b20);
    ...
    unsigned b47 = stwo_trace_value(arena, *args, 2u, 16u, row, -1);
    unsigned b48 = stwo_trace_value(arena, *args, 2u, 16u, row, 0);
    unsigned b49 = stwo_trace_value(arena, *args, 2u, 17u, row, -1);
    unsigned b50 = stwo_trace_value(arena, *args, 2u, 17u, row, 0);
    unsigned b51 = stwo_trace_value(arena, *args, 2u, 18u, row, -1);
    unsigned b52 = stwo_trace_value(arena, *args, 2u, 18u, row, 0);
    unsigned b53 = stwo_trace_value(arena, *args, 2u, 19u, row, -1);
    unsigned b54 = stwo_trace_value(arena, *args, 2u, 19u, row, 0);
    StwoCairoQm31 e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e1 = { b21, b27, b27, b27 };
    ...
    e0 = stwo_load_qm31(arena, args->ext_params + 7u * 4u);
    e3 = { b25, b27, b27, b27 };
    ...
    e0 = stwo_load_qm31(arena, args->ext_params + 9u * 4u);
    e3 = stwo_qm31_sub(e1, e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 10u * 4u);
    e1 = { b6, b27, b27, b27 };
    e4 = stwo_qm31_mul(e0, e1);
    e1 = stwo_load_qm31(arena, args->ext_params + 11u * 4u);
    ...
    e1 = stwo_load_qm31(arena, args->ext_params + 15u * 4u);
    e0 = { b14, b27, b27, b27 };
    e5 = stwo_qm31_mul(e1, e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 16u * 4u);
    e1 = stwo_qm31_add(e0, e5);
    e0 = stwo_load_qm31(arena, args->ext_params + 17u * 4u);
    e5 = { b10, b27, b27, b27 };
    ...
    e0 = stwo_load_qm31(arena, args->ext_params + 19u * 4u);
    ...
    e0 = stwo_load_qm31(arena, args->ext_params + 26u * 4u);
    e1 = stwo_qm31_add(e0, e7);
    e0 = stwo_load_qm31(arena, args->ext_params + 27u * 4u);
    e7 = { b26, b27, b27, b27 };
    StwoCairoQm31 e8 = stwo_qm31_mul(e0, e7);
    e7 = stwo_qm31_add(e1, e8);
    e8 = stwo_load_qm31(arena, args->ext_params + 28u * 4u);
    e1 = { b17, b27, b27, b27 };
    e0 = stwo_qm31_mul(e8, e1);
    e1 = stwo_qm31_add(e7, e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 29u * 4u);
    e7 = stwo_qm31_sub(e1, e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 30u * 4u);
    e1 = { b7, b27, b27, b27 };
    ...
    e1 = stwo_load_qm31(arena, args->ext_params + 35u * 4u);
    e0 = { b18, b27, b27, b27 };
    e9 = stwo_qm31_mul(e1, e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 36u * 4u);
    ...
    e10 = stwo_load_qm31(arena, args->ext_params + 38u * 4u);
    e1 = { b19, b27, b27, b27 };
    ...
    e0 = { b31, b27, b27, b27 };
    e1 = { b20, b27, b27, b27 };
    e10 = stwo_qm31_neg(e1);
    e1 = stwo_load_qm31(arena, args->ext_params + 40u * 4u);
    StwoCairoQm31 e11 = { b0, b27, b27, b27 };
    StwoCairoQm31 e12 = stwo_qm31_mul(e1, e11);
    ...
    e12 = stwo_qm31_add(e1, e13);
    e13 = stwo_load_qm31(arena, args->ext_params + 45u * 4u);
    e1 = { b4, b27, b27, b27 };
    e11 = stwo_qm31_mul(e13, e1);
    e1 = stwo_qm31_add(e12, e11);
    ...
    e13 = stwo_qm31_mul(e11, e12);
    e12 = stwo_qm31_add(e1, e13);
    e13 = stwo_load_qm31(arena, args->ext_params + 47u * 4u);
    e1 = { b28, b27, b27, b27 };
    e11 = stwo_qm31_mul(e13, e1);
    e1 = stwo_qm31_add(e12, e11);
    ...
    e13 = stwo_load_qm31(arena, args->ext_params + 50u * 4u);
    e12 = stwo_qm31_mul(e3, e13);
    e13 = stwo_load_qm31(arena, args->ext_params + 51u * 4u);
    ...
    e5 = stwo_load_qm31(arena, args->ext_params + 54u * 4u);
    ...
    e7 = stwo_load_qm31(arena, args->ext_params + 56u * 4u);
    e6 = stwo_qm31_mul(e9, e7);
    e7 = stwo_load_qm31(arena, args->ext_params + 57u * 4u);
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e11, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 1u) * 4u)));
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e13, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 2u) * 4u)));
