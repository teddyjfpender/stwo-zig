...
stwo_cairo_cuda_eval_v1_3ef94e189cced438(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 109u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 110u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 115u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 116u, row, 0);
    ...
    unsigned b88 = stwo_trace_value(arena, *args, 1u, 271u, row, 0);
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 272u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 277u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 278u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 286u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 306u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 307u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 308u, row, 0);
    unsigned b96 = 0u;
