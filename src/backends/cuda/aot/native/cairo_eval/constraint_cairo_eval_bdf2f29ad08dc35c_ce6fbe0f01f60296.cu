...
stwo_cairo_cuda_eval_v1_f06b640eaace9f09(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 567u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 568u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 573u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 574u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 575u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 602u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 603u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 604u, row, 0);
    unsigned b97 = 0u;
    ...
    b29 = stwo_m31_add(b27, b32);
    b32 = stwo_m31_mul(b40, b67);
    b27 = stwo_m31_mul(b40, b68);
    b26 = stwo_m31_mul(b41, b67);
    b25 = stwo_m31_add(b27, b26);
    b26 = stwo_m31_mul(b41, b73);
    b27 = stwo_m31_mul(b42, b72);
    b24 = stwo_m31_add(b26, b27);
    b27 = stwo_m31_mul(b43, b71);
    b26 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b44, b70);
    b24 = stwo_m31_add(b26, b27);
    b27 = stwo_m31_mul(b45, b69);
    b26 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b46, b68);
    b24 = stwo_m31_add(b26, b27);
    b27 = stwo_m31_mul(b42, b73);
    b26 = stwo_m31_mul(b43, b72);
    b23 = stwo_m31_add(b27, b26);
    b26 = stwo_m31_mul(b44, b71);
    b27 = stwo_m31_add(b23, b26);
    b26 = stwo_m31_mul(b45, b70);
    b23 = stwo_m31_add(b27, b26);
    b26 = stwo_m31_mul(b46, b69);
    b27 = stwo_m31_add(b23, b26);
    b26 = stwo_m31_add(b33, b40);
    b33 = stwo_m31_add(b34, b41);
    b23 = stwo_m31_add(b35, b42);
    b22 = stwo_m31_add(b36, b43);
    ...
    b26 = stwo_m31_mul(b33, b18);
    b18 = stwo_m31_add(b12, b26);
    b26 = stwo_m31_sub(b18, b30);
    b18 = stwo_m31_sub(b26, b25);
    b26 = stwo_m31_add(b29, b18);
    b18 = stwo_m31_mul(b33, b13);
    b33 = stwo_m31_mul(b23, b14);
    b12 = stwo_m31_add(b18, b33);
    b33 = stwo_m31_mul(b22, b15);
    b18 = stwo_m31_add(b12, b33);
    b33 = stwo_m31_mul(b21, b16);
    b12 = stwo_m31_add(b18, b33);
    b33 = stwo_m31_mul(b20, b17);
    b18 = stwo_m31_add(b12, b33);
    b33 = stwo_m31_mul(b19, b98);
    b98 = stwo_m31_add(b18, b33);
    b33 = stwo_m31_sub(b98, b28);
    b98 = stwo_m31_sub(b33, b24);
    b33 = stwo_m31_add(b32, b98);
    ...
    b17 = stwo_m31_mul(b47, b74);
    b25 = stwo_m31_mul(b47, b75);
    b47 = stwo_m31_mul(b48, b74);
    b74 = stwo_m31_add(b25, b47);
    b47 = stwo_m31_mul(b48, b80);
    b25 = stwo_m31_mul(b49, b79);
    b27 = stwo_m31_add(b47, b25);
    b25 = stwo_m31_mul(b50, b78);
    b47 = stwo_m31_add(b27, b25);
    b25 = stwo_m31_mul(b51, b77);
    b27 = stwo_m31_add(b47, b25);
    b25 = stwo_m31_mul(b52, b76);
    b47 = stwo_m31_add(b27, b25);
    b25 = stwo_m31_mul(b53, b75);
    b27 = stwo_m31_add(b47, b25);
    b25 = stwo_m31_mul(b49, b80);
    b47 = stwo_m31_mul(b50, b79);
    b29 = stwo_m31_add(b25, b47);
    b47 = stwo_m31_mul(b51, b78);
    b25 = stwo_m31_add(b29, b47);
    b47 = stwo_m31_mul(b52, b77);
    b29 = stwo_m31_add(b25, b47);
    b47 = stwo_m31_mul(b53, b76);
    b25 = stwo_m31_add(b29, b47);
    b47 = stwo_m31_mul(b54, b81);
    b29 = stwo_m31_mul(b54, b82);
    b16 = stwo_m31_mul(b55, b81);
    b19 = stwo_m31_add(b29, b16);
    b16 = stwo_m31_mul(b55, b87);
    b29 = stwo_m31_mul(b56, b86);
    b15 = stwo_m31_add(b16, b29);
    b29 = stwo_m31_mul(b57, b85);
    b16 = stwo_m31_add(b15, b29);
    b29 = stwo_m31_mul(b58, b84);
    b15 = stwo_m31_add(b16, b29);
    b29 = stwo_m31_mul(b59, b83);
    b16 = stwo_m31_add(b15, b29);
    b29 = stwo_m31_mul(b60, b82);
    b15 = stwo_m31_add(b16, b29);
    b29 = stwo_m31_mul(b56, b87);
    b16 = stwo_m31_mul(b57, b86);
    b20 = stwo_m31_add(b29, b16);
    b16 = stwo_m31_mul(b58, b85);
    b29 = stwo_m31_add(b20, b16);
    b16 = stwo_m31_mul(b59, b84);
    b20 = stwo_m31_add(b29, b16);
    b16 = stwo_m31_mul(b60, b83);
    b29 = stwo_m31_add(b20, b16);
    b16 = stwo_m31_add(b48, b55);
    b20 = stwo_m31_add(b49, b56);
    b14 = stwo_m31_add(b50, b57);
    b21 = stwo_m31_add(b51, b58);
    b98 = stwo_m31_add(b52, b59);
    b22 = stwo_m31_add(b53, b60);
    b23 = stwo_m31_add(b75, b82);
    b32 = stwo_m31_add(b76, b83);
    b24 = stwo_m31_add(b77, b84);
    b28 = stwo_m31_add(b78, b85);
    b18 = stwo_m31_add(b79, b86);
    b12 = stwo_m31_add(b80, b87);
    ...
    b87 = stwo_m31_mul(b32, b79);
    b73 = stwo_m31_mul(b48, b78);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b49, b77);
    b87 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_mul(b50, b76);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b51, b75);
    b87 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_mul(b52, b60);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b48, b79);
    b87 = stwo_m31_mul(b49, b78);
    b71 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b50, b77);
    b73 = stwo_m31_add(b71, b87);
    b87 = stwo_m31_mul(b51, b76);
    b71 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b52, b75);
    b73 = stwo_m31_add(b71, b87);
    b87 = stwo_m31_mul(b53, b80);
    b71 = stwo_m31_mul(b53, b81);
    b53 = stwo_m31_mul(b54, b80);
    b80 = stwo_m31_add(b71, b53);
    b53 = stwo_m31_mul(b54, b86);
    b71 = stwo_m31_mul(b55, b85);
    b70 = stwo_m31_add(b53, b71);
    b71 = stwo_m31_mul(b56, b84);
    b53 = stwo_m31_add(b70, b71);
    b71 = stwo_m31_mul(b57, b83);
    b70 = stwo_m31_add(b53, b71);
    b71 = stwo_m31_mul(b58, b82);
    b53 = stwo_m31_add(b70, b71);
    b71 = stwo_m31_mul(b59, b81);
    b70 = stwo_m31_add(b53, b71);
    b71 = stwo_m31_mul(b55, b86);
    b53 = stwo_m31_mul(b56, b85);
    b69 = stwo_m31_add(b71, b53);
    b53 = stwo_m31_mul(b57, b84);
    b71 = stwo_m31_add(b69, b53);
    b53 = stwo_m31_mul(b58, b83);
    b69 = stwo_m31_add(b71, b53);
    b53 = stwo_m31_mul(b59, b82);
    b71 = stwo_m31_add(b69, b53);
    b53 = stwo_m31_add(b32, b54);
    ...
    b59 = stwo_m31_sub(b53, b70);
    b53 = stwo_m31_add(b87, b59);
    b59 = stwo_m31_mul(b54, b85);
    b85 = stwo_m31_mul(b55, b84);
    b84 = stwo_m31_add(b59, b85);
    b85 = stwo_m31_mul(b56, b83);
    b83 = stwo_m31_add(b84, b85);
    b85 = stwo_m31_mul(b57, b82);
    b82 = stwo_m31_add(b83, b85);
    b85 = stwo_m31_mul(b58, b81);
    b81 = stwo_m31_add(b82, b85);
    b85 = stwo_m31_sub(b81, b73);
    b81 = stwo_m31_sub(b85, b71);
    b85 = stwo_m31_add(b80, b81);
    b81 = stwo_m31_sub(b53, b33);
    b53 = stwo_m31_sub(b81, b16);
    b81 = stwo_m31_add(b17, b53);
    b53 = stwo_m31_sub(b85, b13);
    b85 = stwo_m31_sub(b53, b12);
    b53 = stwo_m31_add(b74, b85);
    b85 = stwo_m31_sub(b93, b88);
    b93 = stwo_m31_sub(b30, b89);
    b30 = stwo_m31_sub(b31, b90);
    b31 = stwo_m31_sub(b11, b91);
    b11 = stwo_m31_sub(b26, b92);
    b26 = 2u;
    b92 = stwo_m31_mul(b26, b85);
    b26 = stwo_m31_add(b92, b30);
    b92 = 32u;
    b30 = stwo_m31_mul(b92, b31);
    b92 = stwo_m31_add(b26, b30);
    b30 = 4u;
    b26 = stwo_m31_mul(b30, b81);
    b30 = stwo_m31_sub(b92, b26);
    b26 = 2u;
    b92 = stwo_m31_mul(b26, b93);
    b26 = stwo_m31_add(b92, b31);
    b92 = 32u;
    b31 = stwo_m31_mul(b92, b11);
    b92 = stwo_m31_add(b26, b31);
    b31 = 4u;
    b26 = stwo_m31_mul(b31, b53);
    b31 = stwo_m31_sub(b92, b26);
    b26 = 512u;
    b92 = stwo_m31_mul(b95, b26);
    b26 = stwo_m31_add(b30, b94);
    b30 = stwo_m31_sub(b92, b26);
    b26 = 512u;
    b92 = stwo_m31_mul(b96, b26);
