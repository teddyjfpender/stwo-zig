...
stwo_cairo_cuda_eval_v1_c1c711c6a708076b(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b4 = stwo_trace_value(arena, *args, 1u, 43u, row, 0);
    unsigned b5 = stwo_trace_value(arena, *args, 1u, 72u, row, 0);
    unsigned b6 = stwo_trace_value(arena, *args, 1u, 77u, row, 0);
    unsigned b7 = stwo_trace_value(arena, *args, 1u, 78u, row, 0);
    unsigned b8 = stwo_trace_value(arena, *args, 1u, 79u, row, 0);
    unsigned b9 = stwo_trace_value(arena, *args, 1u, 99u, row, 0);
    ...
    unsigned b23 = stwo_trace_value(arena, *args, 1u, 141u, row, 0);
    unsigned b24 = stwo_trace_value(arena, *args, 1u, 142u, row, 0);
    unsigned b25 = stwo_trace_value(arena, *args, 1u, 143u, row, 0);
    unsigned b26 = stwo_trace_value(arena, *args, 1u, 144u, row, 0);
    unsigned b27 = stwo_trace_value(arena, *args, 1u, 145u, row, 0);
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 146u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 147u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 148u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 149u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 150u, row, 0);
    unsigned b33 = stwo_trace_value(arena, *args, 1u, 151u, row, 0);
    unsigned b34 = stwo_trace_value(arena, *args, 1u, 152u, row, 0);
    unsigned b35 = stwo_trace_value(arena, *args, 1u, 153u, row, 0);
    unsigned b36 = stwo_trace_value(arena, *args, 1u, 154u, row, 0);
    unsigned b37 = stwo_trace_value(arena, *args, 1u, 155u, row, 0);
    unsigned b38 = stwo_trace_value(arena, *args, 1u, 184u, row, 0);
    unsigned b39 = stwo_trace_value(arena, *args, 1u, 189u, row, 0);
    unsigned b40 = stwo_trace_value(arena, *args, 1u, 190u, row, 0);
    unsigned b41 = stwo_trace_value(arena, *args, 1u, 191u, row, 0);
    unsigned b42 = stwo_trace_value(arena, *args, 1u, 211u, row, 0);
    unsigned b43 = stwo_trace_value(arena, *args, 1u, 218u, row, 0);
    unsigned b44 = stwo_trace_value(arena, *args, 1u, 219u, row, 0);
    unsigned b45 = stwo_trace_value(arena, *args, 1u, 220u, row, 0);
    unsigned b46 = 0u;
    unsigned b47 = stwo_m31_add(b0, b5);
    b5 = stwo_m31_add(b47, b38);
    b47 = stwo_m31_add(b1, b6);
    b6 = stwo_m31_add(b47, b39);
    b47 = stwo_m31_add(b2, b7);
    b7 = stwo_m31_add(b47, b40);
    b47 = stwo_m31_add(b3, b8);
    b8 = stwo_m31_add(b47, b41);
    b47 = stwo_m31_add(b4, b9);
