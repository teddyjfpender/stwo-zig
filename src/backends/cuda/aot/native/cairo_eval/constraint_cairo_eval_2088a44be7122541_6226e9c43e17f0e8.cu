...
stwo_cairo_cuda_eval_v1_8703edf24779c89a(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b58 = stwo_trace_value(arena, *args, 1u, 103u, row, 0);
    unsigned b59 = stwo_trace_value(arena, *args, 1u, 104u, row, 0);
    unsigned b60 = stwo_trace_value(arena, *args, 1u, 112u, row, 0);
    unsigned b61 = stwo_trace_value(arena, *args, 1u, 132u, row, 0);
    unsigned b62 = stwo_trace_value(arena, *args, 1u, 133u, row, 0);
    unsigned b63 = stwo_trace_value(arena, *args, 1u, 134u, row, 0);
    ...
    unsigned b66 = stwo_m31_mul(b10, b33);
    unsigned b67 = stwo_m31_mul(b11, b32);
    ...
    unsigned b71 = stwo_m31_mul(b15, b40);
    unsigned b72 = stwo_m31_mul(b0, b39);
    ...
    b71 = stwo_m31_mul(b15, b39);
    unsigned b76 = stwo_m31_add(b41, b71);
    b71 = stwo_m31_mul(b0, b38);
    b41 = stwo_m31_add(b76, b71);
    b71 = stwo_m31_mul(b16, b37);
    b76 = stwo_m31_add(b41, b71);
    b71 = stwo_m31_mul(b17, b36);
    b41 = stwo_m31_add(b76, b71);
    b71 = stwo_m31_mul(b1, b35);
    b76 = stwo_m31_add(b41, b71);
    b71 = stwo_m31_mul(b18, b19);
    b19 = stwo_m31_add(b76, b71);
    b71 = stwo_m31_sub(b19, b67);
    b19 = stwo_m31_sub(b71, b72);
    b71 = stwo_m31_mul(b15, b40);
    b15 = stwo_m31_mul(b0, b39);
    b39 = stwo_m31_add(b71, b15);
    b15 = stwo_m31_mul(b16, b38);
    b38 = stwo_m31_add(b39, b15);
    b15 = stwo_m31_mul(b17, b37);
    b37 = stwo_m31_add(b38, b15);
    b15 = stwo_m31_mul(b1, b36);
    b36 = stwo_m31_add(b37, b15);
    b15 = stwo_m31_mul(b18, b35);
    b35 = stwo_m31_add(b36, b15);
    b15 = stwo_m31_sub(b35, b70);
    b35 = stwo_m31_sub(b15, b75);
    b15 = stwo_m31_add(b66, b35);
    b35 = stwo_m31_mul(b18, b40);
    b40 = stwo_m31_sub(b35, b69);
    b35 = stwo_m31_sub(b40, b74);
    b40 = stwo_m31_add(b73, b35);
    b35 = stwo_m31_mul(b2, b42);
    b73 = stwo_m31_mul(b2, b47);
    b74 = stwo_m31_mul(b20, b46);
    b69 = stwo_m31_add(b73, b74);
    b74 = stwo_m31_mul(b21, b45);
    b73 = stwo_m31_add(b69, b74);
    b74 = stwo_m31_mul(b3, b44);
    b69 = stwo_m31_add(b73, b74);
    b74 = stwo_m31_mul(b22, b43);
    b73 = stwo_m31_add(b69, b74);
    b74 = stwo_m31_mul(b23, b42);
    b69 = stwo_m31_add(b73, b74);
    b74 = stwo_m31_mul(b2, b48);
    b73 = stwo_m31_mul(b20, b47);
    b18 = stwo_m31_add(b74, b73);
    b73 = stwo_m31_mul(b21, b46);
    b74 = stwo_m31_add(b18, b73);
    ...
    b74 = stwo_m31_add(b18, b73);
    b73 = stwo_m31_mul(b20, b48);
    b18 = stwo_m31_mul(b21, b47);
    b66 = stwo_m31_add(b73, b18);
    b18 = stwo_m31_mul(b3, b46);
    b73 = stwo_m31_add(b66, b18);
    b18 = stwo_m31_mul(b22, b45);
    b66 = stwo_m31_add(b73, b18);
    b18 = stwo_m31_mul(b23, b44);
    b73 = stwo_m31_add(b66, b18);
    b18 = stwo_m31_mul(b4, b43);
    b66 = stwo_m31_add(b73, b18);
    b18 = stwo_m31_mul(b24, b49);
    b73 = stwo_m31_mul(b24, b55);
    b75 = stwo_m31_mul(b25, b54);
    b70 = stwo_m31_add(b73, b75);
    b75 = stwo_m31_mul(b5, b53);
    b73 = stwo_m31_add(b70, b75);
    b75 = stwo_m31_mul(b26, b52);
    b70 = stwo_m31_add(b73, b75);
    b75 = stwo_m31_mul(b27, b51);
    b73 = stwo_m31_add(b70, b75);
    b75 = stwo_m31_mul(b6, b50);
    b70 = stwo_m31_add(b73, b75);
    b75 = stwo_m31_mul(b9, b49);
    b73 = stwo_m31_add(b70, b75);
    b75 = stwo_m31_mul(b25, b55);
    b70 = stwo_m31_mul(b5, b54);
    b36 = stwo_m31_add(b75, b70);
    b70 = stwo_m31_mul(b26, b53);
    b75 = stwo_m31_add(b36, b70);
    b70 = stwo_m31_mul(b27, b52);
    b36 = stwo_m31_add(b75, b70);
    b70 = stwo_m31_mul(b6, b51);
    b75 = stwo_m31_add(b36, b70);
    b70 = stwo_m31_mul(b9, b50);
    b36 = stwo_m31_add(b75, b70);
    b70 = stwo_m31_add(b2, b24);
    ...
    b55 = stwo_m31_mul(b70, b54);
    b70 = stwo_m31_mul(b24, b53);
    b75 = stwo_m31_add(b55, b70);
    b70 = stwo_m31_mul(b25, b52);
    b55 = stwo_m31_add(b75, b70);
    b70 = stwo_m31_mul(b5, b51);
    b75 = stwo_m31_add(b55, b70);
    b70 = stwo_m31_mul(b26, b50);
    b55 = stwo_m31_add(b75, b70);
    b70 = stwo_m31_mul(b27, b49);
    b75 = stwo_m31_add(b55, b70);
    b70 = stwo_m31_mul(b6, b9);
    b9 = stwo_m31_add(b75, b70);
    b70 = stwo_m31_sub(b9, b74);
    b9 = stwo_m31_sub(b70, b73);
    b70 = stwo_m31_mul(b24, b54);
    b54 = stwo_m31_mul(b25, b53);
    b53 = stwo_m31_add(b70, b54);
    b54 = stwo_m31_mul(b5, b52);
    b52 = stwo_m31_add(b53, b54);
    b54 = stwo_m31_mul(b26, b51);
    b51 = stwo_m31_add(b52, b54);
    b54 = stwo_m31_mul(b27, b50);
    b50 = stwo_m31_add(b51, b54);
    b54 = stwo_m31_mul(b6, b49);
    b49 = stwo_m31_add(b50, b54);
    b54 = stwo_m31_sub(b49, b66);
    b49 = stwo_m31_sub(b54, b36);
    b54 = stwo_m31_add(b18, b49);
    b49 = stwo_m31_add(b10, b2);
    ...
    b48 = stwo_m31_mul(b49, b4);
    b34 = stwo_m31_mul(b49, b46);
    b33 = stwo_m31_mul(b2, b45);
    b32 = stwo_m31_add(b34, b33);
    b33 = stwo_m31_mul(b20, b44);
    b34 = stwo_m31_add(b32, b33);
    b33 = stwo_m31_mul(b64, b43);
    b32 = stwo_m31_add(b34, b33);
    b33 = stwo_m31_mul(b3, b42);
    b34 = stwo_m31_add(b32, b33);
    b33 = stwo_m31_mul(b22, b4);
    b32 = stwo_m31_add(b34, b33);
    b33 = stwo_m31_mul(b49, b47);
    b47 = stwo_m31_mul(b2, b46);
    b46 = stwo_m31_add(b33, b47);
    b47 = stwo_m31_mul(b20, b45);
    b45 = stwo_m31_add(b46, b47);
    b47 = stwo_m31_mul(b64, b44);
    b44 = stwo_m31_add(b45, b47);
    b47 = stwo_m31_mul(b3, b43);
    b43 = stwo_m31_add(b44, b47);
    b47 = stwo_m31_mul(b22, b42);
    b42 = stwo_m31_add(b43, b47);
    b47 = stwo_m31_mul(b65, b4);
    b4 = stwo_m31_add(b42, b47);
    b47 = stwo_m31_sub(b48, b8);
    b48 = stwo_m31_sub(b47, b35);
    b47 = stwo_m31_add(b15, b48);
    b48 = stwo_m31_sub(b32, b68);
    b32 = stwo_m31_sub(b48, b69);
    b48 = stwo_m31_add(b40, b32);
    b32 = stwo_m31_sub(b4, b67);
    b4 = stwo_m31_sub(b32, b74);
    b32 = stwo_m31_add(b72, b4);
    b4 = stwo_m31_sub(b19, b56);
    b19 = stwo_m31_sub(b47, b57);
    b47 = stwo_m31_sub(b48, b58);
    b48 = stwo_m31_sub(b32, b59);
    b32 = 2u;
    b59 = stwo_m31_mul(b32, b4);
    b32 = stwo_m31_add(b59, b47);
    b59 = 32u;
    b47 = stwo_m31_mul(b59, b48);
    b59 = stwo_m31_add(b32, b47);
    b47 = 4u;
    b32 = stwo_m31_mul(b47, b9);
    b47 = stwo_m31_sub(b59, b32);
    b32 = 2u;
    b59 = stwo_m31_mul(b32, b19);
    b32 = stwo_m31_add(b59, b48);
    b59 = 4u;
    b48 = stwo_m31_mul(b59, b54);
    b59 = stwo_m31_sub(b32, b48);
    b48 = 64u;
    b32 = stwo_m31_mul(b48, b36);
    b48 = stwo_m31_add(b59, b32);
    b32 = 512u;
    b59 = stwo_m31_mul(b62, b32);
    b32 = stwo_m31_add(b47, b61);
    b47 = stwo_m31_sub(b59, b32);
    b32 = 512u;
    b59 = stwo_m31_mul(b63, b32);
    b32 = 136u;
    b63 = stwo_m31_mul(b32, b60);
    b32 = stwo_m31_sub(b48, b63);
    b63 = stwo_m31_add(b32, b62);
    b32 = stwo_m31_sub(b59, b63);
    StwoCairoQm31 e0 = { b47, b7, b7, b7 };
