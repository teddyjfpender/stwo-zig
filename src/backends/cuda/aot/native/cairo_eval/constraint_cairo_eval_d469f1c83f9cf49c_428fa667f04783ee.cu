...
stwo_cairo_cuda_eval_v1_4678516ec252aed3(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 56u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 57u, row, 0);
    ...
    unsigned b61 = stwo_trace_value(arena, *args, 1u, 112u, row, 0);
    unsigned b62 = stwo_trace_value(arena, *args, 1u, 113u, row, 0);
    unsigned b63 = stwo_trace_value(arena, *args, 1u, 118u, row, 0);
    unsigned b64 = stwo_trace_value(arena, *args, 1u, 119u, row, 0);
    unsigned b65 = stwo_trace_value(arena, *args, 1u, 120u, row, 0);
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 175u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 176u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 177u, row, 0);
    unsigned b97 = 0u;
    ...
    b29 = stwo_m31_mul(b72, b37);
    b28 = stwo_m31_add(b32, b29);
    b29 = stwo_m31_mul(b72, b38);
    b32 = stwo_m31_mul(b73, b43);
    b27 = stwo_m31_mul(b74, b42);
    b26 = stwo_m31_add(b32, b27);
    b27 = stwo_m31_mul(b75, b41);
    b32 = stwo_m31_add(b26, b27);
    b27 = stwo_m31_mul(b76, b40);
    b26 = stwo_m31_add(b32, b27);
    b27 = stwo_m31_mul(b77, b39);
    b32 = stwo_m31_add(b26, b27);
    ...
    b26 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b78, b45);
    b24 = stwo_m31_mul(b79, b44);
    b23 = stwo_m31_add(b27, b24);
    b24 = stwo_m31_mul(b79, b45);
    b27 = stwo_m31_add(b66, b73);
    ...
    b21 = stwo_m31_mul(b27, b43);
    b20 = stwo_m31_mul(b73, b42);
    b19 = stwo_m31_add(b21, b20);
    b20 = stwo_m31_mul(b74, b41);
    b21 = stwo_m31_add(b19, b20);
    b20 = stwo_m31_mul(b75, b40);
    b19 = stwo_m31_add(b21, b20);
    b20 = stwo_m31_mul(b76, b39);
    b21 = stwo_m31_add(b19, b20);
    b20 = stwo_m31_mul(b77, b22);
    b19 = stwo_m31_add(b21, b20);
    b20 = stwo_m31_sub(b19, b30);
    b19 = stwo_m31_sub(b20, b25);
    b20 = stwo_m31_add(b29, b19);
    b19 = stwo_m31_mul(b27, b44);
    b27 = stwo_m31_mul(b73, b43);
    b73 = stwo_m31_add(b19, b27);
    b27 = stwo_m31_mul(b74, b42);
    b42 = stwo_m31_add(b73, b27);
    b27 = stwo_m31_mul(b75, b41);
    b41 = stwo_m31_add(b42, b27);
    b27 = stwo_m31_mul(b76, b40);
    b40 = stwo_m31_add(b41, b27);
    b27 = stwo_m31_mul(b77, b39);
    b39 = stwo_m31_add(b40, b27);
    b27 = stwo_m31_mul(b78, b22);
    b22 = stwo_m31_add(b39, b27);
    b27 = stwo_m31_sub(b22, b31);
    b22 = stwo_m31_sub(b27, b26);
    b27 = stwo_m31_mul(b77, b44);
    b77 = stwo_m31_mul(b78, b43);
    b43 = stwo_m31_add(b27, b77);
    b77 = stwo_m31_sub(b43, b28);
    b43 = stwo_m31_sub(b77, b23);
    b77 = stwo_m31_add(b32, b43);
    b43 = stwo_m31_mul(b78, b44);
    b44 = stwo_m31_sub(b43, b29);
    b43 = stwo_m31_sub(b44, b24);
    b44 = stwo_m31_add(b25, b43);
    b43 = stwo_m31_mul(b80, b50);
    b25 = stwo_m31_mul(b81, b49);
    b29 = stwo_m31_add(b43, b25);
    b25 = stwo_m31_mul(b82, b48);
    b43 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b83, b47);
    b29 = stwo_m31_add(b43, b25);
    b25 = stwo_m31_mul(b84, b46);
    b43 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b80, b51);
    b29 = stwo_m31_mul(b81, b50);
    b78 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_mul(b82, b49);
    b25 = stwo_m31_add(b78, b29);
    b29 = stwo_m31_mul(b83, b48);
    b78 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_mul(b84, b47);
    b25 = stwo_m31_add(b78, b29);
    b29 = stwo_m31_mul(b85, b46);
    b78 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_mul(b80, b52);
    b25 = stwo_m31_mul(b81, b51);
    b32 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b82, b50);
    b29 = stwo_m31_add(b32, b25);
    b25 = stwo_m31_mul(b83, b49);
    b32 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b84, b48);
    b29 = stwo_m31_add(b32, b25);
    b25 = stwo_m31_mul(b85, b47);
    b32 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b86, b46);
    b29 = stwo_m31_add(b32, b25);
    b25 = stwo_m31_mul(b86, b52);
    b32 = stwo_m31_mul(b87, b58);
    b23 = stwo_m31_mul(b88, b57);
    b28 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b89, b56);
    b32 = stwo_m31_add(b28, b23);
    b23 = stwo_m31_mul(b90, b55);
    b28 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b91, b54);
    b32 = stwo_m31_add(b28, b23);
    b23 = stwo_m31_mul(b92, b53);
    b28 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b87, b59);
    b32 = stwo_m31_mul(b88, b58);
    b27 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b89, b57);
    b23 = stwo_m31_add(b27, b32);
    b32 = stwo_m31_mul(b90, b56);
    b27 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b91, b55);
    b23 = stwo_m31_add(b27, b32);
    b32 = stwo_m31_mul(b92, b54);
    b27 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b93, b53);
    b23 = stwo_m31_add(b27, b32);
    b32 = stwo_m31_mul(b93, b59);
    b27 = stwo_m31_add(b80, b87);
    b87 = stwo_m31_add(b81, b88);
    b88 = stwo_m31_add(b82, b89);
    b89 = stwo_m31_add(b83, b90);
    b90 = stwo_m31_add(b84, b91);
    b91 = stwo_m31_add(b85, b92);
    b92 = stwo_m31_add(b86, b93);
    b39 = stwo_m31_add(b46, b53);
    ...
    b40 = stwo_m31_mul(b27, b57);
    b41 = stwo_m31_mul(b87, b56);
    b76 = stwo_m31_add(b40, b41);
    b41 = stwo_m31_mul(b88, b55);
    b40 = stwo_m31_add(b76, b41);
    b41 = stwo_m31_mul(b89, b54);
    b76 = stwo_m31_add(b40, b41);
    b41 = stwo_m31_mul(b90, b53);
    b40 = stwo_m31_add(b76, b41);
    b41 = stwo_m31_mul(b91, b39);
    b76 = stwo_m31_add(b40, b41);
    b41 = stwo_m31_sub(b76, b78);
    b76 = stwo_m31_sub(b41, b28);
    b41 = stwo_m31_add(b25, b76);
    b76 = stwo_m31_mul(b27, b58);
    b58 = stwo_m31_mul(b87, b57);
    b57 = stwo_m31_add(b76, b58);
    b58 = stwo_m31_mul(b88, b56);
    b56 = stwo_m31_add(b57, b58);
    b58 = stwo_m31_mul(b89, b55);
    b55 = stwo_m31_add(b56, b58);
    b58 = stwo_m31_mul(b90, b54);
    b54 = stwo_m31_add(b55, b58);
    b58 = stwo_m31_mul(b91, b53);
    b53 = stwo_m31_add(b54, b58);
    b58 = stwo_m31_mul(b92, b39);
    b39 = stwo_m31_add(b53, b58);
    b58 = stwo_m31_sub(b39, b29);
    b39 = stwo_m31_sub(b58, b23);
    b58 = stwo_m31_add(b66, b80);
    ...
    b59 = stwo_m31_mul(b58, b49);
    b45 = stwo_m31_mul(b80, b48);
    b38 = stwo_m31_add(b59, b45);
    b45 = stwo_m31_mul(b81, b47);
    b59 = stwo_m31_add(b38, b45);
    b45 = stwo_m31_mul(b82, b46);
    b38 = stwo_m31_add(b59, b45);
    b45 = stwo_m31_mul(b83, b93);
    b59 = stwo_m31_add(b38, b45);
    b45 = stwo_m31_mul(b58, b50);
    b38 = stwo_m31_mul(b80, b49);
    b37 = stwo_m31_add(b45, b38);
    b38 = stwo_m31_mul(b81, b48);
    b45 = stwo_m31_add(b37, b38);
    b38 = stwo_m31_mul(b82, b47);
    b37 = stwo_m31_add(b45, b38);
    b38 = stwo_m31_mul(b83, b46);
    b45 = stwo_m31_add(b37, b38);
    b38 = stwo_m31_mul(b84, b93);
    b37 = stwo_m31_add(b45, b38);
    b38 = stwo_m31_mul(b58, b51);
    b51 = stwo_m31_mul(b80, b50);
    b50 = stwo_m31_add(b38, b51);
    b51 = stwo_m31_mul(b81, b49);
    b49 = stwo_m31_add(b50, b51);
    b51 = stwo_m31_mul(b82, b48);
    b48 = stwo_m31_add(b49, b51);
    b51 = stwo_m31_mul(b83, b47);
    b47 = stwo_m31_add(b48, b51);
    b51 = stwo_m31_mul(b84, b46);
    b46 = stwo_m31_add(b47, b51);
    b51 = stwo_m31_mul(b85, b93);
    b93 = stwo_m31_add(b46, b51);
    b51 = stwo_m31_mul(b86, b52);
    b52 = stwo_m31_sub(b59, b65);
    b59 = stwo_m31_sub(b52, b43);
    b52 = stwo_m31_add(b77, b59);
    b59 = stwo_m31_sub(b37, b30);
    b37 = stwo_m31_sub(b59, b78);
    b59 = stwo_m31_add(b44, b37);
    b37 = stwo_m31_sub(b93, b31);
    b93 = stwo_m31_sub(b37, b29);
    b37 = stwo_m31_add(b26, b93);
    b93 = stwo_m31_sub(b51, b24);
    b51 = stwo_m31_sub(b93, b32);
    b93 = stwo_m31_add(b41, b51);
    b51 = stwo_m31_sub(b20, b60);
    b20 = stwo_m31_sub(b22, b61);
    b22 = stwo_m31_sub(b52, b62);
    b52 = stwo_m31_sub(b59, b63);
    b59 = stwo_m31_sub(b37, b64);
    b37 = 2u;
    b64 = stwo_m31_mul(b37, b51);
    b37 = stwo_m31_add(b64, b22);
    b64 = 32u;
    b22 = stwo_m31_mul(b64, b52);
    b64 = stwo_m31_add(b37, b22);
    b22 = 4u;
    b37 = stwo_m31_mul(b22, b93);
    b22 = stwo_m31_sub(b64, b37);
    b37 = 2u;
    b64 = stwo_m31_mul(b37, b20);
    b37 = stwo_m31_add(b64, b52);
    b64 = 32u;
    b52 = stwo_m31_mul(b64, b59);
    b64 = stwo_m31_add(b37, b52);
    b52 = 4u;
    b37 = stwo_m31_mul(b52, b39);
    b52 = stwo_m31_sub(b64, b37);
    b37 = 512u;
    b64 = stwo_m31_mul(b95, b37);
    b37 = stwo_m31_add(b22, b94);
    b22 = stwo_m31_sub(b64, b37);
    b37 = 512u;
    b64 = stwo_m31_mul(b96, b37);
    b37 = stwo_m31_add(b52, b95);
    b52 = stwo_m31_sub(b64, b37);
