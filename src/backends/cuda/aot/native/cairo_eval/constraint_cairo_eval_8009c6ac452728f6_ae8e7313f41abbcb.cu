...
stwo_cairo_cuda_eval_v1_6a0cad17928cf7e1(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b42 = stwo_trace_value(arena, *args, 1u, 208u, row, 0);
    unsigned b43 = stwo_trace_value(arena, *args, 1u, 209u, row, 0);
    unsigned b44 = stwo_trace_value(arena, *args, 1u, 210u, row, 0);
    unsigned b45 = stwo_trace_value(arena, *args, 1u, 214u, row, 0);
    unsigned b46 = stwo_trace_value(arena, *args, 1u, 215u, row, 0);
    unsigned b47 = stwo_trace_value(arena, *args, 1u, 216u, row, 0);
    unsigned b48 = stwo_trace_value(arena, *args, 1u, 217u, row, 0);
    unsigned b49 = stwo_trace_value(arena, *args, 1u, 243u, row, 0);
    unsigned b50 = stwo_trace_value(arena, *args, 1u, 244u, row, 0);
    unsigned b51 = stwo_trace_value(arena, *args, 1u, 245u, row, 0);
    unsigned b52 = stwo_trace_value(arena, *args, 1u, 246u, row, 0);
    unsigned b53 = 0u;
