...
stwo_cairo_cuda_eval_v1_4bfd88d448f5343f(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 179u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 180u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 181u, row, 0);
    unsigned b97 = 0u;
