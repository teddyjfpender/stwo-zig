...
stwo_cairo_cuda_eval_v1_46ff0e8647eda5b3(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 159u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 160u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 161u, row, 0);
    unsigned b97 = 0u;
