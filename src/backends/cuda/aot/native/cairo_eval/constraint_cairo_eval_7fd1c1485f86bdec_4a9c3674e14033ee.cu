...
stwo_cairo_cuda_eval_v1_dec1cdb2a57d2d6f(
    unsigned *arena,
    u64 arena_words,
    ...
    b4 = 6332005u;
    b0 = stwo_m31_add(b5, b4);
    b4 = 0u;
    b5 = 1u;
    unsigned b6 = stwo_m31_add(b0, b5);
    b5 = 2u;
    unsigned b7 = stwo_m31_add(b0, b5);
    b5 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b8 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b9 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b10 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    unsigned b11 = stwo_trace_value(arena, *args, 2u, 4u, row, -1);
    unsigned b12 = stwo_trace_value(arena, *args, 2u, 4u, row, 0);
    unsigned b13 = stwo_trace_value(arena, *args, 2u, 5u, row, -1);
    unsigned b14 = stwo_trace_value(arena, *args, 2u, 5u, row, 0);
    unsigned b15 = stwo_trace_value(arena, *args, 2u, 6u, row, -1);
    unsigned b16 = stwo_trace_value(arena, *args, 2u, 6u, row, 0);
    unsigned b17 = stwo_trace_value(arena, *args, 2u, 7u, row, -1);
    unsigned b18 = stwo_trace_value(arena, *args, 2u, 7u, row, 0);
    StwoCairoQm31 e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e1 = { b0, b4, b4, b4 };
