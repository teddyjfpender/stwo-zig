...
stwo_cairo_cuda_eval_v1_68d782d6bc083433(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 54u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 55u, row, 0);
    unsigned b33 = stwo_trace_value(arena, *args, 1u, 61u, row, 0);
    unsigned b34 = stwo_trace_value(arena, *args, 1u, 62u, row, 0);
    unsigned b35 = stwo_trace_value(arena, *args, 1u, 63u, row, 0);
    ...
    b41 = stwo_m31_mul(b15, b18);
    unsigned b42 = stwo_m31_mul(b0, b1);
    unsigned b43 = stwo_m31_add(b41, b42);
    b42 = stwo_m31_mul(b16, b17);
    b41 = stwo_m31_add(b43, b42);
    b42 = stwo_m31_mul(b17, b16);
    b43 = stwo_m31_add(b41, b42);
    b42 = stwo_m31_mul(b1, b0);
    b41 = stwo_m31_add(b43, b42);
    b42 = stwo_m31_mul(b18, b15);
    b43 = stwo_m31_add(b41, b42);
    b42 = stwo_m31_mul(b15, b19);
    b41 = stwo_m31_mul(b0, b18);
    unsigned b44 = stwo_m31_add(b42, b41);
    b41 = stwo_m31_mul(b16, b1);
    b42 = stwo_m31_add(b44, b41);
    b41 = stwo_m31_mul(b17, b17);
    b44 = stwo_m31_add(b42, b41);
    b41 = stwo_m31_mul(b1, b16);
    b42 = stwo_m31_add(b44, b41);
    b41 = stwo_m31_mul(b18, b0);
    b44 = stwo_m31_add(b42, b41);
    b41 = stwo_m31_mul(b19, b15);
    b42 = stwo_m31_add(b44, b41);
    b41 = stwo_m31_mul(b19, b19);
    b44 = stwo_m31_add(b10, b15);
    unsigned b45 = stwo_m31_add(b11, b0);
    unsigned b46 = stwo_m31_add(b36, b16);
    unsigned b47 = stwo_m31_add(b12, b17);
    unsigned b48 = stwo_m31_add(b13, b1);
    unsigned b49 = stwo_m31_add(b37, b18);
    unsigned b50 = stwo_m31_add(b14, b19);
    unsigned b51 = stwo_m31_add(b10, b15);
    unsigned b52 = stwo_m31_add(b11, b0);
    unsigned b53 = stwo_m31_add(b36, b16);
    unsigned b54 = stwo_m31_add(b12, b17);
    unsigned b55 = stwo_m31_add(b13, b1);
    unsigned b56 = stwo_m31_add(b37, b18);
    unsigned b57 = stwo_m31_add(b14, b19);
    ...
    b60 = stwo_m31_add(b58, b59);
    b59 = stwo_m31_sub(b60, b40);
    b60 = stwo_m31_sub(b59, b43);
    b59 = stwo_m31_add(b38, b60);
    ...
    b57 = stwo_m31_sub(b51, b39);
    b51 = stwo_m31_sub(b57, b42);
    b57 = stwo_m31_mul(b2, b23);
    b42 = stwo_m31_mul(b20, b22);
    b52 = stwo_m31_add(b57, b42);
    b42 = stwo_m31_mul(b21, b3);
    b57 = stwo_m31_add(b52, b42);
    b42 = stwo_m31_mul(b3, b21);
    b52 = stwo_m31_add(b57, b42);
    b42 = stwo_m31_mul(b22, b20);
    b57 = stwo_m31_add(b52, b42);
    b42 = stwo_m31_mul(b23, b2);
    b52 = stwo_m31_add(b57, b42);
    b42 = stwo_m31_mul(b2, b4);
    b57 = stwo_m31_mul(b20, b23);
    b50 = stwo_m31_add(b42, b57);
    b57 = stwo_m31_mul(b21, b22);
    b42 = stwo_m31_add(b50, b57);
    b57 = stwo_m31_mul(b3, b3);
    b50 = stwo_m31_add(b42, b57);
    b57 = stwo_m31_mul(b22, b21);
    b42 = stwo_m31_add(b50, b57);
    b57 = stwo_m31_mul(b23, b20);
    b50 = stwo_m31_add(b42, b57);
    b57 = stwo_m31_mul(b4, b2);
    b42 = stwo_m31_add(b50, b57);
    b57 = stwo_m31_mul(b4, b4);
    b50 = stwo_m31_mul(b24, b6);
    b53 = stwo_m31_mul(b25, b27);
    b49 = stwo_m31_add(b50, b53);
    b53 = stwo_m31_mul(b5, b26);
    b50 = stwo_m31_add(b49, b53);
    b53 = stwo_m31_mul(b26, b5);
    b49 = stwo_m31_add(b50, b53);
    b53 = stwo_m31_mul(b27, b25);
    b50 = stwo_m31_add(b49, b53);
    b53 = stwo_m31_mul(b6, b24);
    b49 = stwo_m31_add(b50, b53);
    b53 = stwo_m31_mul(b24, b9);
    b50 = stwo_m31_mul(b25, b6);
    b54 = stwo_m31_add(b53, b50);
    b50 = stwo_m31_mul(b5, b27);
    b53 = stwo_m31_add(b54, b50);
    b50 = stwo_m31_mul(b26, b26);
    b54 = stwo_m31_add(b53, b50);
    b50 = stwo_m31_mul(b27, b5);
    b53 = stwo_m31_add(b54, b50);
    b50 = stwo_m31_mul(b6, b25);
    b54 = stwo_m31_add(b53, b50);
    b50 = stwo_m31_mul(b9, b24);
    b53 = stwo_m31_add(b54, b50);
    b50 = stwo_m31_mul(b9, b9);
    b54 = stwo_m31_add(b2, b24);
    b48 = stwo_m31_add(b20, b25);
    b55 = stwo_m31_add(b21, b5);
    b47 = stwo_m31_add(b3, b26);
    b56 = stwo_m31_add(b22, b27);
    b46 = stwo_m31_add(b23, b6);
    b60 = stwo_m31_add(b4, b9);
    b45 = stwo_m31_add(b2, b24);
    b44 = stwo_m31_add(b20, b25);
    b38 = stwo_m31_add(b21, b5);
    b43 = stwo_m31_add(b3, b26);
    b58 = stwo_m31_add(b22, b27);
    unsigned b61 = stwo_m31_add(b23, b6);
    unsigned b62 = stwo_m31_add(b4, b9);
    ...
    b62 = stwo_m31_mul(b56, b38);
    b38 = stwo_m31_add(b43, b62);
    b62 = stwo_m31_mul(b46, b44);
    b44 = stwo_m31_add(b38, b62);
    b62 = stwo_m31_mul(b60, b45);
    b45 = stwo_m31_add(b44, b62);
    b62 = stwo_m31_sub(b45, b42);
    b45 = stwo_m31_sub(b62, b53);
    b62 = stwo_m31_add(b10, b2);
    b53 = stwo_m31_add(b11, b20);
    b42 = stwo_m31_add(b36, b21);
    b44 = stwo_m31_add(b12, b3);
    b60 = stwo_m31_add(b13, b22);
    b38 = stwo_m31_add(b37, b23);
    b46 = stwo_m31_add(b14, b4);
    b43 = stwo_m31_add(b15, b24);
    b56 = stwo_m31_add(b0, b25);
    b58 = stwo_m31_add(b16, b5);
    b47 = stwo_m31_add(b17, b26);
    b61 = stwo_m31_add(b1, b27);
    b55 = stwo_m31_add(b18, b6);
    b65 = stwo_m31_add(b19, b9);
    ...
    b19 = stwo_m31_mul(b62, b22);
    b9 = stwo_m31_mul(b53, b3);
    b18 = stwo_m31_add(b19, b9);
    b9 = stwo_m31_mul(b42, b36);
    b19 = stwo_m31_add(b18, b9);
    b9 = stwo_m31_mul(b44, b20);
    b18 = stwo_m31_add(b19, b9);
    b9 = stwo_m31_mul(b60, b2);
    b19 = stwo_m31_add(b18, b9);
    b9 = stwo_m31_mul(b38, b48);
    b18 = stwo_m31_add(b19, b9);
    b9 = stwo_m31_mul(b62, b37);
    b19 = stwo_m31_mul(b53, b22);
    b27 = stwo_m31_add(b9, b19);
    b19 = stwo_m31_mul(b42, b3);
    b9 = stwo_m31_add(b27, b19);
    b19 = stwo_m31_mul(b44, b36);
    b27 = stwo_m31_add(b9, b19);
    b19 = stwo_m31_mul(b60, b20);
    b9 = stwo_m31_add(b27, b19);
    b19 = stwo_m31_mul(b38, b2);
    b27 = stwo_m31_add(b9, b19);
    b19 = stwo_m31_mul(b46, b48);
    b9 = stwo_m31_add(b27, b19);
    b19 = stwo_m31_mul(b46, b37);
    b27 = stwo_m31_mul(b43, b1);
    b17 = stwo_m31_mul(b56, b26);
    b16 = stwo_m31_add(b27, b17);
    b17 = stwo_m31_mul(b58, b5);
    b27 = stwo_m31_add(b16, b17);
    b17 = stwo_m31_mul(b47, b0);
    b16 = stwo_m31_add(b27, b17);
    b17 = stwo_m31_mul(b61, b24);
    b27 = stwo_m31_add(b16, b17);
    b17 = stwo_m31_mul(b55, b4);
    b16 = stwo_m31_add(b27, b17);
    b17 = stwo_m31_mul(b43, b6);
    b27 = stwo_m31_mul(b56, b1);
    b25 = stwo_m31_add(b17, b27);
    b27 = stwo_m31_mul(b58, b26);
    b17 = stwo_m31_add(b25, b27);
    b27 = stwo_m31_mul(b47, b5);
    b25 = stwo_m31_add(b17, b27);
    b27 = stwo_m31_mul(b61, b0);
    b17 = stwo_m31_add(b25, b27);
    b27 = stwo_m31_mul(b55, b24);
    b25 = stwo_m31_add(b17, b27);
    b27 = stwo_m31_mul(b65, b4);
    b17 = stwo_m31_add(b25, b27);
    b27 = stwo_m31_add(b62, b43);
    b43 = stwo_m31_add(b53, b56);
    b56 = stwo_m31_add(b42, b58);
    b58 = stwo_m31_add(b44, b47);
    b47 = stwo_m31_add(b60, b61);
    b61 = stwo_m31_add(b38, b55);
    b55 = stwo_m31_add(b46, b65);
    b65 = stwo_m31_add(b48, b4);
    ...
    b6 = stwo_m31_mul(b27, b26);
    b37 = stwo_m31_mul(b43, b5);
    b22 = stwo_m31_add(b6, b37);
    b37 = stwo_m31_mul(b56, b0);
    b6 = stwo_m31_add(b22, b37);
    b37 = stwo_m31_mul(b58, b24);
    b22 = stwo_m31_add(b6, b37);
    b37 = stwo_m31_mul(b47, b4);
    b6 = stwo_m31_add(b22, b37);
    b37 = stwo_m31_mul(b61, b65);
    b22 = stwo_m31_add(b6, b37);
    b37 = stwo_m31_sub(b22, b18);
    b22 = stwo_m31_sub(b37, b16);
    b37 = stwo_m31_add(b19, b22);
    b22 = stwo_m31_mul(b27, b1);
    b1 = stwo_m31_mul(b43, b26);
    b26 = stwo_m31_add(b22, b1);
    b1 = stwo_m31_mul(b56, b5);
    b5 = stwo_m31_add(b26, b1);
    b1 = stwo_m31_mul(b58, b0);
    b0 = stwo_m31_add(b5, b1);
    b1 = stwo_m31_mul(b47, b24);
    b24 = stwo_m31_add(b0, b1);
    b1 = stwo_m31_mul(b61, b4);
    b4 = stwo_m31_add(b24, b1);
    b1 = stwo_m31_mul(b55, b65);
    b65 = stwo_m31_add(b4, b1);
    b1 = stwo_m31_sub(b65, b9);
    b65 = stwo_m31_sub(b1, b17);
    b1 = stwo_m31_sub(b37, b59);
    b37 = stwo_m31_sub(b1, b64);
    b1 = stwo_m31_add(b41, b37);
    b37 = stwo_m31_sub(b65, b51);
    b65 = stwo_m31_sub(b37, b45);
    b37 = stwo_m31_sub(b8, b28);
    b8 = stwo_m31_sub(b40, b29);
    b40 = stwo_m31_sub(b39, b30);
    b39 = stwo_m31_sub(b1, b31);
    b1 = stwo_m31_sub(b65, b32);
    b65 = 32u;
    b32 = stwo_m31_mul(b65, b8);
    b65 = stwo_m31_add(b37, b32);
    b32 = 4u;
    b37 = stwo_m31_mul(b32, b39);
    b32 = stwo_m31_sub(b65, b37);
    b37 = 8u;
    b65 = stwo_m31_mul(b37, b50);
    b37 = stwo_m31_add(b32, b65);
    b65 = 32u;
    b32 = stwo_m31_mul(b65, b40);
    b65 = stwo_m31_add(b8, b32);
    b32 = 4u;
    b8 = stwo_m31_mul(b32, b1);
    b32 = stwo_m31_sub(b65, b8);
    b8 = 512u;
    b65 = stwo_m31_mul(b34, b8);
    b8 = stwo_m31_add(b37, b33);
    b37 = stwo_m31_sub(b65, b8);
    b8 = 512u;
    b65 = stwo_m31_mul(b35, b8);
    b8 = stwo_m31_add(b32, b34);
    b32 = stwo_m31_sub(b65, b8);
    StwoCairoQm31 e0 = { b37, b7, b7, b7 };
    StwoCairoQm31 e1 = { b32, b7, b7, b7 };
