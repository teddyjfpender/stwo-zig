...
stwo_cairo_cuda_eval_v1_34682d78fd82b520(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b61 = stwo_trace_value(arena, *args, 1u, 108u, row, 0);
    unsigned b62 = stwo_trace_value(arena, *args, 1u, 109u, row, 0);
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 193u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 194u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 195u, row, 0);
    unsigned b97 = 0u;
