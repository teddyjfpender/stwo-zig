...
stwo_cairo_cuda_eval_v1_b0ae50d3dd46634f(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 51u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 241u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 242u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 247u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 248u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 249u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 276u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 277u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 278u, row, 0);
    unsigned b97 = 0u;
