...
stwo_cairo_cuda_eval_v1_f809079a68237295(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b17 = stwo_trace_value(arena, *args, 1u, 0u, row, 0);
    unsigned b18 = 0u;
    unsigned b19 = stwo_trace_value(arena, *args, 2u, 0u, row, -1);
    unsigned b20 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b21 = stwo_trace_value(arena, *args, 2u, 1u, row, -1);
    unsigned b22 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b23 = stwo_trace_value(arena, *args, 2u, 2u, row, -1);
    unsigned b24 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b25 = stwo_trace_value(arena, *args, 2u, 3u, row, -1);
    unsigned b26 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    StwoCairoQm31 e0 = { b17, b18, b18, b18 };
    StwoCairoQm31 e1 = stwo_qm31_neg(e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e2 = { b0, b18, b18, b18 };
