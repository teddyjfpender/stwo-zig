...
stwo_cairo_cuda_eval_v1_5be58f5d6fedee96(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b20 = 0u;
    unsigned b21 = 262144u;
    unsigned b22 = stwo_m31_mul(b10, b21);
    b21 = stwo_m31_sub(b0, b22);
    b22 = stwo_m31_sub(b1, b11);
    unsigned b23 = 4194304u;
    unsigned b24 = stwo_m31_mul(b22, b23);
    b23 = 262144u;
    b22 = stwo_m31_mul(b12, b23);
    b23 = stwo_m31_sub(b2, b22);
    b22 = stwo_m31_sub(b3, b13);
    unsigned b25 = 4194304u;
    unsigned b26 = stwo_m31_mul(b22, b25);
    b25 = 262144u;
    b22 = stwo_m31_mul(b14, b25);
    b25 = stwo_m31_sub(b4, b22);
    b22 = stwo_m31_sub(b5, b15);
    unsigned b27 = 4194304u;
    unsigned b28 = stwo_m31_mul(b22, b27);
    b27 = 262144u;
    b22 = stwo_m31_mul(b16, b27);
    b27 = stwo_m31_sub(b6, b22);
    b22 = stwo_m31_sub(b7, b17);
    unsigned b29 = 4194304u;
    unsigned b30 = stwo_m31_mul(b22, b29);
    b29 = 262144u;
    b22 = stwo_m31_mul(b18, b29);
    b29 = stwo_m31_sub(b8, b22);
    b22 = stwo_m31_mul(b19, b19);
    unsigned b31 = stwo_m31_sub(b22, b19);
    b22 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    ...
    unsigned b43 = stwo_trace_value(arena, *args, 2u, 12u, row, 0);
    unsigned b44 = stwo_trace_value(arena, *args, 2u, 13u, row, 0);
    unsigned b45 = stwo_trace_value(arena, *args, 2u, 14u, row, 0);
    unsigned b46 = stwo_trace_value(arena, *args, 2u, 15u, row, 0);
    unsigned b47 = stwo_trace_value(arena, *args, 2u, 16u, row, 0);
    unsigned b48 = stwo_trace_value(arena, *args, 2u, 17u, row, 0);
    unsigned b49 = stwo_trace_value(arena, *args, 2u, 18u, row, 0);
    unsigned b50 = stwo_trace_value(arena, *args, 2u, 19u, row, 0);
    unsigned b51 = stwo_trace_value(arena, *args, 2u, 20u, row, 0);
    unsigned b52 = stwo_trace_value(arena, *args, 2u, 21u, row, 0);
    unsigned b53 = stwo_trace_value(arena, *args, 2u, 22u, row, 0);
    unsigned b54 = stwo_trace_value(arena, *args, 2u, 23u, row, 0);
    unsigned b55 = stwo_trace_value(arena, *args, 2u, 24u, row, 0);
    unsigned b56 = stwo_trace_value(arena, *args, 2u, 25u, row, 0);
    unsigned b57 = stwo_trace_value(arena, *args, 2u, 26u, row, 0);
    unsigned b58 = stwo_trace_value(arena, *args, 2u, 27u, row, 0);
    unsigned b59 = stwo_trace_value(arena, *args, 2u, 28u, row, -1);
    unsigned b60 = stwo_trace_value(arena, *args, 2u, 28u, row, 0);
    unsigned b61 = stwo_trace_value(arena, *args, 2u, 29u, row, -1);
    unsigned b62 = stwo_trace_value(arena, *args, 2u, 29u, row, 0);
    unsigned b63 = stwo_trace_value(arena, *args, 2u, 30u, row, -1);
    unsigned b64 = stwo_trace_value(arena, *args, 2u, 30u, row, 0);
    unsigned b65 = stwo_trace_value(arena, *args, 2u, 31u, row, -1);
    unsigned b66 = stwo_trace_value(arena, *args, 2u, 31u, row, 0);
    StwoCairoQm31 e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e1 = { b10, b20, b20, b20 };
    ...
    e2 = stwo_load_qm31(arena, args->ext_params + 11u * 4u);
    ...
    e12 = stwo_load_qm31(arena, args->ext_params + 38u * 4u);
    ...
    e18 = stwo_qm31_add(e15, e19);
    e19 = stwo_load_qm31(arena, args->ext_params + 52u * 4u);
    e15 = { b4, b20, b20, b20 };
    e17 = stwo_qm31_mul(e19, e15);
    e15 = stwo_qm31_add(e18, e17);
    e17 = stwo_load_qm31(arena, args->ext_params + 53u * 4u);
    e18 = { b5, b20, b20, b20 };
    e19 = stwo_qm31_mul(e17, e18);
    e18 = stwo_qm31_add(e15, e19);
    e19 = stwo_load_qm31(arena, args->ext_params + 54u * 4u);
    e15 = { b6, b20, b20, b20 };
    e17 = stwo_qm31_mul(e19, e15);
    e15 = stwo_qm31_add(e18, e17);
    ...
    e19 = stwo_qm31_mul(e17, e18);
    e18 = stwo_qm31_add(e15, e19);
    e19 = stwo_load_qm31(arena, args->ext_params + 56u * 4u);
    e15 = { b8, b20, b20, b20 };
    e17 = stwo_qm31_mul(e19, e15);
    e15 = stwo_qm31_add(e18, e17);
    e17 = stwo_load_qm31(arena, args->ext_params + 57u * 4u);
    e18 = { b9, b20, b20, b20 };
    e19 = stwo_qm31_mul(e17, e18);
    e18 = stwo_qm31_add(e15, e19);
    e19 = stwo_load_qm31(arena, args->ext_params + 58u * 4u);
    e15 = stwo_qm31_sub(e18, e19);
    e19 = stwo_load_qm31(arena, args->ext_params + 59u * 4u);
    e18 = stwo_qm31_mul(e1, e19);
    e19 = stwo_load_qm31(arena, args->ext_params + 60u * 4u);
    ...
    e7 = stwo_load_qm31(arena, args->ext_params + 65u * 4u);
    e2 = stwo_qm31_mul(e5, e7);
    e7 = stwo_load_qm31(arena, args->ext_params + 66u * 4u);
    ...
    e5 = stwo_load_qm31(arena, args->ext_params + 68u * 4u);
    e2 = stwo_qm31_mul(e10, e5);
    e5 = stwo_qm31_add(e6, e2);
    e2 = stwo_qm31_mul(e10, e9);
    e9 = stwo_load_qm31(arena, args->ext_params + 69u * 4u);
    e10 = stwo_qm31_mul(e13, e9);
    e9 = stwo_load_qm31(arena, args->ext_params + 70u * 4u);
    e6 = stwo_qm31_mul(e8, e9);
    e9 = stwo_qm31_add(e10, e6);
    e6 = stwo_qm31_mul(e8, e13);
    e13 = stwo_load_qm31(arena, args->ext_params + 71u * 4u);
    e8 = stwo_qm31_mul(e11, e13);
    e13 = stwo_load_qm31(arena, args->ext_params + 72u * 4u);
    ...
    e10 = stwo_load_qm31(arena, args->ext_params + 73u * 4u);
    e11 = stwo_qm31_add(e13, e10);
    e10 = stwo_qm31_mul(e11, e15);
    e11 = stwo_qm31_sub(e10, e16);
    StwoCairoQm31 part_acc = { 0u, 0u, 0u, 0u };
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e14, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 0u) * 4u)));
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e17, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 1u) * 4u)));
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e19, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 2u) * 4u)));
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e5, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 6u) * 4u)));
