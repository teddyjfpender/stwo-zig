...
stwo_cairo_cuda_eval_v1_c8365a4456d98a7f(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b6 = stwo_trace_value(arena, *args, 1u, 4u, row, 0);
    unsigned b7 = stwo_trace_value(arena, *args, 1u, 5u, row, 0);
    unsigned b8 = stwo_trace_value(arena, *args, 1u, 6u, row, 0);
    unsigned b9 = stwo_trace_value(arena, *args, 1u, 7u, row, 0);
    unsigned b10 = 0u;
    ...
    unsigned b19 = stwo_trace_value(arena, *args, 2u, 8u, row, 0);
    unsigned b20 = stwo_trace_value(arena, *args, 2u, 9u, row, 0);
    unsigned b21 = stwo_trace_value(arena, *args, 2u, 10u, row, 0);
    unsigned b22 = stwo_trace_value(arena, *args, 2u, 11u, row, 0);
    unsigned b23 = stwo_trace_value(arena, *args, 2u, 12u, row, -1);
    unsigned b24 = stwo_trace_value(arena, *args, 2u, 12u, row, 0);
    unsigned b25 = stwo_trace_value(arena, *args, 2u, 13u, row, -1);
    unsigned b26 = stwo_trace_value(arena, *args, 2u, 13u, row, 0);
    unsigned b27 = stwo_trace_value(arena, *args, 2u, 14u, row, -1);
    unsigned b28 = stwo_trace_value(arena, *args, 2u, 14u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 2u, 15u, row, -1);
    unsigned b30 = stwo_trace_value(arena, *args, 2u, 15u, row, 0);
    StwoCairoQm31 e0 = { b2, b10, b10, b10 };
    StwoCairoQm31 e1 = stwo_qm31_neg(e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e2 = { b0, b10, b10, b10 };
    ...
    e2 = { b0, b10, b10, b10 };
    StwoCairoQm31 e5 = stwo_qm31_mul(e4, e2);
    ...
    e2 = { b0, b10, b10, b10 };
    StwoCairoQm31 e9 = stwo_qm31_mul(e8, e2);
    ...
    e18 = stwo_load_qm31(arena, args->ext_params + 31u * 4u);
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e7, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 2u) * 4u)));
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e16, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 3u) * 4u)));
