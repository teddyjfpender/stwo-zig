...
stwo_cairo_cuda_eval_v1_ec09cd6b3b9c5223(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 573u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 574u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 579u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 580u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 581u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 608u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 609u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 610u, row, 0);
    unsigned b97 = 0u;
    ...
    b24 = stwo_m31_mul(b42, b72);
    b23 = stwo_m31_add(b27, b24);
    b24 = stwo_m31_mul(b43, b71);
    b27 = stwo_m31_add(b23, b24);
    b24 = stwo_m31_mul(b44, b70);
    b23 = stwo_m31_add(b27, b24);
    b24 = stwo_m31_mul(b45, b69);
    b27 = stwo_m31_add(b23, b24);
    b24 = stwo_m31_mul(b46, b68);
    b23 = stwo_m31_add(b27, b24);
    ...
    b66 = stwo_m31_mul(b24, b39);
    b21 = stwo_m31_sub(b66, b93);
    b66 = stwo_m31_sub(b21, b32);
    b21 = stwo_m31_add(b28, b66);
    b66 = stwo_m31_mul(b24, b64);
    b20 = stwo_m31_mul(b27, b63);
    b19 = stwo_m31_add(b66, b20);
    b20 = stwo_m31_mul(b34, b62);
    b66 = stwo_m31_add(b19, b20);
    b20 = stwo_m31_mul(b35, b61);
    b19 = stwo_m31_add(b66, b20);
    b20 = stwo_m31_mul(b36, b22);
    b66 = stwo_m31_add(b19, b20);
    b20 = stwo_m31_mul(b37, b39);
    b19 = stwo_m31_add(b66, b20);
    b20 = stwo_m31_sub(b19, b30);
    b19 = stwo_m31_sub(b20, b25);
    b20 = stwo_m31_add(b29, b19);
    b19 = stwo_m31_mul(b24, b65);
    b24 = stwo_m31_mul(b27, b64);
    ...
    b19 = stwo_m31_add(b29, b24);
    b24 = stwo_m31_mul(b37, b22);
    b29 = stwo_m31_add(b19, b24);
    b24 = stwo_m31_mul(b38, b39);
    b39 = stwo_m31_add(b29, b24);
    b24 = stwo_m31_sub(b39, b31);
    b39 = stwo_m31_sub(b24, b26);
    b24 = stwo_m31_mul(b27, b65);
    b65 = stwo_m31_mul(b34, b64);
    b64 = stwo_m31_add(b24, b65);
    b65 = stwo_m31_mul(b35, b63);
    b63 = stwo_m31_add(b64, b65);
    b65 = stwo_m31_mul(b36, b62);
    b62 = stwo_m31_add(b63, b65);
    b65 = stwo_m31_mul(b37, b61);
    b61 = stwo_m31_add(b62, b65);
    b65 = stwo_m31_mul(b38, b22);
    b22 = stwo_m31_add(b61, b65);
    b65 = stwo_m31_sub(b22, b28);
    b22 = stwo_m31_sub(b65, b23);
    b65 = stwo_m31_add(b32, b22);
    b22 = stwo_m31_mul(b47, b74);
    b32 = stwo_m31_mul(b47, b80);
    b28 = stwo_m31_mul(b48, b79);
    b61 = stwo_m31_add(b32, b28);
    b28 = stwo_m31_mul(b49, b78);
    b32 = stwo_m31_add(b61, b28);
    b28 = stwo_m31_mul(b50, b77);
    b61 = stwo_m31_add(b32, b28);
    b28 = stwo_m31_mul(b51, b76);
    b32 = stwo_m31_add(b61, b28);
    b28 = stwo_m31_mul(b52, b75);
    b61 = stwo_m31_add(b32, b28);
    b28 = stwo_m31_mul(b53, b74);
    b32 = stwo_m31_add(b61, b28);
    b28 = stwo_m31_mul(b48, b80);
    b80 = stwo_m31_mul(b49, b79);
    b79 = stwo_m31_add(b28, b80);
    b80 = stwo_m31_mul(b50, b78);
    b78 = stwo_m31_add(b79, b80);
    b80 = stwo_m31_mul(b51, b77);
    b77 = stwo_m31_add(b78, b80);
    b80 = stwo_m31_mul(b52, b76);
    b76 = stwo_m31_add(b77, b80);
    b80 = stwo_m31_mul(b53, b75);
    b75 = stwo_m31_add(b76, b80);
    b80 = stwo_m31_mul(b54, b81);
    b76 = stwo_m31_mul(b54, b87);
    b53 = stwo_m31_mul(b55, b86);
    b77 = stwo_m31_add(b76, b53);
    b53 = stwo_m31_mul(b56, b85);
    b76 = stwo_m31_add(b77, b53);
    ...
    b77 = stwo_m31_add(b76, b53);
    b53 = stwo_m31_mul(b60, b81);
    b76 = stwo_m31_add(b77, b53);
    b53 = stwo_m31_mul(b55, b87);
    b77 = stwo_m31_mul(b56, b86);
    b52 = stwo_m31_add(b53, b77);
    b77 = stwo_m31_mul(b57, b85);
    b53 = stwo_m31_add(b52, b77);
    b77 = stwo_m31_mul(b58, b84);
    b52 = stwo_m31_add(b53, b77);
    b77 = stwo_m31_mul(b59, b83);
    b53 = stwo_m31_add(b52, b77);
    b77 = stwo_m31_mul(b60, b82);
    b52 = stwo_m31_add(b53, b77);
    b77 = stwo_m31_add(b47, b54);
    b53 = stwo_m31_add(b74, b81);
    b78 = stwo_m31_mul(b77, b53);
    b53 = stwo_m31_sub(b78, b22);
    b78 = stwo_m31_sub(b53, b80);
    b53 = stwo_m31_add(b75, b78);
    b78 = stwo_m31_add(b33, b47);
    ...
    b60 = stwo_m31_mul(b47, b86);
    b47 = stwo_m31_mul(b54, b85);
    b78 = stwo_m31_add(b60, b47);
    b47 = stwo_m31_mul(b55, b84);
    b60 = stwo_m31_add(b78, b47);
    b47 = stwo_m31_mul(b56, b83);
    b78 = stwo_m31_add(b60, b47);
    b47 = stwo_m31_mul(b57, b82);
    b60 = stwo_m31_add(b78, b47);
    b47 = stwo_m31_mul(b58, b81);
    b78 = stwo_m31_add(b60, b47);
    b47 = stwo_m31_mul(b59, b74);
    b74 = stwo_m31_add(b78, b47);
    b47 = stwo_m31_mul(b54, b86);
    b86 = stwo_m31_mul(b55, b85);
    b85 = stwo_m31_add(b47, b86);
    ...
    b87 = stwo_m31_sub(b86, b22);
    b86 = stwo_m31_add(b65, b87);
    b87 = stwo_m31_sub(b74, b26);
    b74 = stwo_m31_sub(b87, b76);
    b87 = stwo_m31_add(b32, b74);
    b74 = stwo_m31_sub(b81, b23);
    b81 = stwo_m31_sub(b74, b52);
    b74 = stwo_m31_add(b53, b81);
    b81 = stwo_m31_sub(b31, b88);
    b31 = stwo_m31_sub(b21, b89);
    b21 = stwo_m31_sub(b20, b90);
    b20 = stwo_m31_sub(b39, b91);
    b39 = stwo_m31_sub(b86, b92);
    b86 = 2u;
    b92 = stwo_m31_mul(b86, b81);
    b86 = stwo_m31_add(b92, b21);
    b92 = 32u;
    b21 = stwo_m31_mul(b92, b20);
    b92 = stwo_m31_add(b86, b21);
    b21 = 4u;
    b86 = stwo_m31_mul(b21, b87);
    b21 = stwo_m31_sub(b92, b86);
    b86 = 2u;
    b92 = stwo_m31_mul(b86, b31);
    b86 = stwo_m31_add(b92, b20);
    b92 = 32u;
    b20 = stwo_m31_mul(b92, b39);
    b92 = stwo_m31_add(b86, b20);
    b20 = 4u;
    b86 = stwo_m31_mul(b20, b74);
    b20 = stwo_m31_sub(b92, b86);
    b86 = 512u;
    b92 = stwo_m31_mul(b95, b86);
    b86 = stwo_m31_add(b21, b94);
    b21 = stwo_m31_sub(b92, b86);
    b86 = 512u;
    b92 = stwo_m31_mul(b96, b86);
    b86 = stwo_m31_add(b20, b95);
    b20 = stwo_m31_sub(b92, b86);
