...
stwo_cairo_cuda_eval_v1_a18c269b92d81ce5(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b9 = stwo_trace_value(arena, *args, 1u, 89u, row, 0);
    unsigned b10 = stwo_trace_value(arena, *args, 1u, 90u, row, 0);
    unsigned b11 = stwo_trace_value(arena, *args, 1u, 91u, row, 0);
    ...
    unsigned b40 = stwo_trace_value(arena, *args, 1u, 202u, row, 0);
    unsigned b41 = stwo_trace_value(arena, *args, 1u, 203u, row, 0);
    unsigned b42 = stwo_trace_value(arena, *args, 1u, 204u, row, 0);
    unsigned b43 = stwo_trace_value(arena, *args, 1u, 223u, row, 0);
    unsigned b44 = stwo_trace_value(arena, *args, 1u, 224u, row, 0);
    unsigned b45 = stwo_trace_value(arena, *args, 1u, 225u, row, 0);
