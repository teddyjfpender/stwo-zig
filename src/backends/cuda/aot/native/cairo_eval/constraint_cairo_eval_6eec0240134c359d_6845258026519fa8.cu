...
stwo_cairo_cuda_eval_v1_b018d9ed382d06cf(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 0u, row, 0);
    unsigned b32 = 0u;
    unsigned b33 = stwo_trace_value(arena, *args, 2u, 0u, row, -1);
    unsigned b34 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b35 = stwo_trace_value(arena, *args, 2u, 1u, row, -1);
    unsigned b36 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b37 = stwo_trace_value(arena, *args, 2u, 2u, row, -1);
    unsigned b38 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b39 = stwo_trace_value(arena, *args, 2u, 3u, row, -1);
    unsigned b40 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    StwoCairoQm31 e0 = { b31, b32, b32, b32 };
    StwoCairoQm31 e1 = stwo_qm31_neg(e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e2 = { b0, b32, b32, b32 };
