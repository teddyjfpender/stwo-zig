...
stwo_cairo_cuda_eval_v1_83d6f5337c5d7c57(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b6 = stwo_trace_value(arena, *args, 1u, 80u, row, 0);
    unsigned b7 = stwo_trace_value(arena, *args, 1u, 81u, row, 0);
    unsigned b8 = stwo_trace_value(arena, *args, 1u, 82u, row, 0);
    unsigned b9 = stwo_trace_value(arena, *args, 1u, 86u, row, 0);
    ...
    unsigned b27 = stwo_trace_value(arena, *args, 1u, 161u, row, 0);
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 162u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 163u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 164u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 165u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 166u, row, 0);
    unsigned b33 = stwo_trace_value(arena, *args, 1u, 167u, row, 0);
    unsigned b34 = stwo_trace_value(arena, *args, 1u, 168u, row, 0);
    unsigned b35 = stwo_trace_value(arena, *args, 1u, 169u, row, 0);
    unsigned b36 = stwo_trace_value(arena, *args, 1u, 170u, row, 0);
    unsigned b37 = stwo_trace_value(arena, *args, 1u, 171u, row, 0);
    unsigned b38 = stwo_trace_value(arena, *args, 1u, 172u, row, 0);
    unsigned b39 = stwo_trace_value(arena, *args, 1u, 173u, row, 0);
    unsigned b40 = stwo_trace_value(arena, *args, 1u, 214u, row, 0);
    unsigned b41 = stwo_trace_value(arena, *args, 1u, 215u, row, 0);
    unsigned b42 = stwo_trace_value(arena, *args, 1u, 216u, row, 0);
    unsigned b43 = stwo_trace_value(arena, *args, 1u, 220u, row, 0);
    unsigned b44 = stwo_trace_value(arena, *args, 1u, 221u, row, 0);
    unsigned b45 = stwo_trace_value(arena, *args, 1u, 222u, row, 0);
    unsigned b46 = stwo_trace_value(arena, *args, 1u, 230u, row, 0);
    unsigned b47 = stwo_trace_value(arena, *args, 1u, 249u, row, 0);
    unsigned b48 = stwo_trace_value(arena, *args, 1u, 250u, row, 0);
    unsigned b49 = stwo_trace_value(arena, *args, 1u, 251u, row, 0);
    unsigned b50 = stwo_trace_value(arena, *args, 1u, 252u, row, 0);
    unsigned b51 = 0u;
    unsigned b52 = stwo_m31_add(b6, b0);
    b6 = stwo_m31_add(b52, b40);
    b52 = stwo_m31_add(b7, b1);
    b7 = stwo_m31_add(b52, b41);
    b52 = stwo_m31_add(b8, b2);
    b8 = stwo_m31_add(b52, b42);
    b52 = stwo_m31_add(b9, b3);
    b9 = stwo_m31_add(b52, b43);
    b52 = stwo_m31_add(b10, b4);
    b10 = stwo_m31_add(b52, b44);
    b52 = stwo_m31_add(b11, b5);
