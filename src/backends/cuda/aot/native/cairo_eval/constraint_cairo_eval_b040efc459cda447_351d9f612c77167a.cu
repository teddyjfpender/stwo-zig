...
stwo_cairo_cuda_eval_v1_1879bfbc5b389938(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 47u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 48u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 49u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 243u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 244u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 245u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 265u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 266u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 272u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 273u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 274u, row, 0);
    unsigned b97 = 0u;
    ...
    b25 = stwo_m31_add(b27, b26);
    b26 = stwo_m31_mul(b45, b73);
    b27 = stwo_m31_mul(b46, b72);
    b24 = stwo_m31_add(b26, b27);
    b27 = stwo_m31_mul(b46, b73);
    b73 = stwo_m31_add(b33, b40);
    b46 = stwo_m31_add(b34, b41);
    b26 = stwo_m31_add(b35, b42);
    b23 = stwo_m31_add(b36, b43);
    b22 = stwo_m31_add(b37, b44);
    b21 = stwo_m31_add(b38, b45);
    b20 = stwo_m31_add(b98, b67);
    b19 = stwo_m31_add(b61, b68);
    b18 = stwo_m31_add(b62, b69);
    b17 = stwo_m31_add(b63, b70);
    b16 = stwo_m31_add(b64, b71);
    b15 = stwo_m31_add(b65, b72);
    b14 = stwo_m31_mul(b73, b16);
    b13 = stwo_m31_mul(b46, b17);
    b12 = stwo_m31_add(b14, b13);
    b13 = stwo_m31_mul(b26, b18);
    b14 = stwo_m31_add(b12, b13);
    b13 = stwo_m31_mul(b23, b19);
    b12 = stwo_m31_add(b14, b13);
    b13 = stwo_m31_mul(b22, b20);
    b14 = stwo_m31_add(b12, b13);
    b13 = stwo_m31_sub(b14, b32);
    b14 = stwo_m31_sub(b13, b30);
    b13 = stwo_m31_add(b28, b14);
    b14 = stwo_m31_mul(b73, b15);
    b15 = stwo_m31_mul(b46, b16);
    b16 = stwo_m31_add(b14, b15);
    b15 = stwo_m31_mul(b26, b17);
    b17 = stwo_m31_add(b16, b15);
    b15 = stwo_m31_mul(b23, b18);
    b18 = stwo_m31_add(b17, b15);
    b15 = stwo_m31_mul(b22, b19);
    b19 = stwo_m31_add(b18, b15);
    b15 = stwo_m31_mul(b21, b20);
    b20 = stwo_m31_add(b19, b15);
    b15 = stwo_m31_sub(b20, b29);
    b20 = stwo_m31_sub(b15, b25);
    b15 = stwo_m31_add(b93, b20);
    b20 = stwo_m31_mul(b47, b78);
    b93 = stwo_m31_mul(b48, b77);
    b25 = stwo_m31_add(b20, b93);
    b93 = stwo_m31_mul(b49, b76);
    b20 = stwo_m31_add(b25, b93);
    b93 = stwo_m31_mul(b50, b75);
    b25 = stwo_m31_add(b20, b93);
    b93 = stwo_m31_mul(b51, b74);
    b20 = stwo_m31_add(b25, b93);
    b93 = stwo_m31_mul(b47, b79);
    b25 = stwo_m31_mul(b48, b78);
    b19 = stwo_m31_add(b93, b25);
    b25 = stwo_m31_mul(b49, b77);
    b93 = stwo_m31_add(b19, b25);
    ...
    b19 = stwo_m31_add(b93, b25);
    b25 = stwo_m31_mul(b52, b80);
    b93 = stwo_m31_mul(b53, b79);
    b21 = stwo_m31_add(b25, b93);
    b93 = stwo_m31_mul(b53, b80);
    b25 = stwo_m31_mul(b54, b85);
    b18 = stwo_m31_mul(b55, b84);
    b22 = stwo_m31_add(b25, b18);
    b18 = stwo_m31_mul(b56, b83);
    b25 = stwo_m31_add(b22, b18);
    b18 = stwo_m31_mul(b57, b82);
    b22 = stwo_m31_add(b25, b18);
    b18 = stwo_m31_mul(b58, b81);
    b25 = stwo_m31_add(b22, b18);
    b18 = stwo_m31_mul(b54, b86);
    b22 = stwo_m31_mul(b55, b85);
    b17 = stwo_m31_add(b18, b22);
    b22 = stwo_m31_mul(b56, b84);
    b18 = stwo_m31_add(b17, b22);
    b22 = stwo_m31_mul(b57, b83);
    b17 = stwo_m31_add(b18, b22);
    b22 = stwo_m31_mul(b58, b82);
    b18 = stwo_m31_add(b17, b22);
    b22 = stwo_m31_mul(b59, b81);
    b17 = stwo_m31_add(b18, b22);
    b22 = stwo_m31_mul(b59, b87);
    b18 = stwo_m31_mul(b60, b86);
    b23 = stwo_m31_add(b22, b18);
    b18 = stwo_m31_mul(b60, b87);
    b87 = stwo_m31_add(b47, b54);
    b60 = stwo_m31_add(b48, b55);
    b22 = stwo_m31_add(b49, b56);
    b16 = stwo_m31_add(b50, b57);
    b26 = stwo_m31_add(b51, b58);
    b14 = stwo_m31_add(b52, b59);
    b46 = stwo_m31_add(b74, b81);
    b73 = stwo_m31_add(b75, b82);
    b28 = stwo_m31_add(b76, b83);
    b30 = stwo_m31_add(b77, b84);
    b12 = stwo_m31_add(b78, b85);
    b11 = stwo_m31_add(b79, b86);
    b10 = stwo_m31_mul(b87, b12);
    b9 = stwo_m31_mul(b60, b30);
    b8 = stwo_m31_add(b10, b9);
    b9 = stwo_m31_mul(b22, b28);
    b10 = stwo_m31_add(b8, b9);
    b9 = stwo_m31_mul(b16, b73);
    b8 = stwo_m31_add(b10, b9);
    b9 = stwo_m31_mul(b26, b46);
    b10 = stwo_m31_add(b8, b9);
    b9 = stwo_m31_sub(b10, b20);
    b10 = stwo_m31_sub(b9, b25);
    b9 = stwo_m31_add(b21, b10);
    b10 = stwo_m31_mul(b87, b11);
    b11 = stwo_m31_mul(b60, b12);
    b12 = stwo_m31_add(b10, b11);
    b11 = stwo_m31_mul(b22, b30);
    b30 = stwo_m31_add(b12, b11);
    b11 = stwo_m31_mul(b16, b28);
    b28 = stwo_m31_add(b30, b11);
    b11 = stwo_m31_mul(b26, b73);
    b73 = stwo_m31_add(b28, b11);
    b11 = stwo_m31_mul(b14, b46);
    b46 = stwo_m31_add(b73, b11);
    b11 = stwo_m31_sub(b46, b19);
    b46 = stwo_m31_sub(b11, b17);
    b11 = stwo_m31_add(b93, b46);
    ...
    b86 = stwo_m31_mul(b46, b77);
    b72 = stwo_m31_mul(b47, b76);
    b71 = stwo_m31_add(b86, b72);
    b72 = stwo_m31_mul(b48, b75);
    b86 = stwo_m31_add(b71, b72);
    b72 = stwo_m31_mul(b49, b74);
    b71 = stwo_m31_add(b86, b72);
    b72 = stwo_m31_mul(b50, b59);
    b86 = stwo_m31_add(b71, b72);
    b72 = stwo_m31_mul(b46, b78);
    b71 = stwo_m31_mul(b47, b77);
    b70 = stwo_m31_add(b72, b71);
    b71 = stwo_m31_mul(b48, b76);
    b72 = stwo_m31_add(b70, b71);
    b71 = stwo_m31_mul(b49, b75);
    b70 = stwo_m31_add(b72, b71);
    b71 = stwo_m31_mul(b50, b74);
    b72 = stwo_m31_add(b70, b71);
    b71 = stwo_m31_mul(b51, b59);
    b70 = stwo_m31_add(b72, b71);
    b71 = stwo_m31_mul(b51, b79);
    b72 = stwo_m31_mul(b52, b78);
    b69 = stwo_m31_add(b71, b72);
    b72 = stwo_m31_mul(b52, b79);
    b79 = stwo_m31_mul(b53, b84);
    b52 = stwo_m31_mul(b54, b83);
    b71 = stwo_m31_add(b79, b52);
    b52 = stwo_m31_mul(b55, b82);
    b79 = stwo_m31_add(b71, b52);
    b52 = stwo_m31_mul(b56, b81);
    b71 = stwo_m31_add(b79, b52);
    b52 = stwo_m31_mul(b57, b80);
    b79 = stwo_m31_add(b71, b52);
    b52 = stwo_m31_mul(b53, b85);
    b71 = stwo_m31_mul(b54, b84);
    b68 = stwo_m31_add(b52, b71);
    b71 = stwo_m31_mul(b55, b83);
    b52 = stwo_m31_add(b68, b71);
    b71 = stwo_m31_mul(b56, b82);
    b68 = stwo_m31_add(b52, b71);
    b71 = stwo_m31_mul(b57, b81);
    b52 = stwo_m31_add(b68, b71);
    b71 = stwo_m31_mul(b58, b80);
    b68 = stwo_m31_add(b52, b71);
    b71 = stwo_m31_add(b46, b53);
    b53 = stwo_m31_add(b47, b54);
    b54 = stwo_m31_add(b48, b55);
    b55 = stwo_m31_add(b49, b56);
    b56 = stwo_m31_add(b50, b57);
    b57 = stwo_m31_add(b51, b58);
    b58 = stwo_m31_add(b59, b80);
    b80 = stwo_m31_add(b74, b81);
    b81 = stwo_m31_add(b75, b82);
    b82 = stwo_m31_add(b76, b83);
    b83 = stwo_m31_add(b77, b84);
    b84 = stwo_m31_add(b78, b85);
    b85 = stwo_m31_mul(b71, b83);
    b78 = stwo_m31_mul(b53, b82);
    b77 = stwo_m31_add(b85, b78);
    b78 = stwo_m31_mul(b54, b81);
    b85 = stwo_m31_add(b77, b78);
    b78 = stwo_m31_mul(b55, b80);
    b77 = stwo_m31_add(b85, b78);
    b78 = stwo_m31_mul(b56, b58);
    b85 = stwo_m31_add(b77, b78);
    b78 = stwo_m31_sub(b85, b86);
    b85 = stwo_m31_sub(b78, b79);
    b78 = stwo_m31_add(b69, b85);
    b85 = stwo_m31_mul(b71, b84);
    b84 = stwo_m31_mul(b53, b83);
    b83 = stwo_m31_add(b85, b84);
    b84 = stwo_m31_mul(b54, b82);
    b82 = stwo_m31_add(b83, b84);
    b84 = stwo_m31_mul(b55, b81);
    b81 = stwo_m31_add(b82, b84);
    b84 = stwo_m31_mul(b56, b80);
    b80 = stwo_m31_add(b81, b84);
    b84 = stwo_m31_mul(b57, b58);
    b58 = stwo_m31_add(b80, b84);
    b84 = stwo_m31_sub(b58, b70);
    b58 = stwo_m31_sub(b84, b68);
    b84 = stwo_m31_add(b72, b58);
    b58 = stwo_m31_sub(b78, b13);
    b78 = stwo_m31_sub(b58, b9);
    b58 = stwo_m31_add(b24, b78);
    b78 = stwo_m31_sub(b84, b15);
    b84 = stwo_m31_sub(b78, b11);
    b78 = stwo_m31_add(b27, b84);
    b84 = stwo_m31_sub(b31, b88);
    b31 = stwo_m31_sub(b32, b89);
    b32 = stwo_m31_sub(b29, b90);
    b29 = stwo_m31_sub(b58, b91);
    b58 = stwo_m31_sub(b78, b92);
    b78 = 32u;
    b92 = stwo_m31_mul(b78, b31);
    b78 = stwo_m31_add(b84, b92);
    b92 = 4u;
    b84 = stwo_m31_mul(b92, b29);
    b92 = stwo_m31_sub(b78, b84);
    b84 = 8u;
    b78 = stwo_m31_mul(b84, b23);
    b84 = stwo_m31_add(b92, b78);
    b78 = 32u;
    b92 = stwo_m31_mul(b78, b32);
    b78 = stwo_m31_add(b31, b92);
    b92 = 4u;
    b31 = stwo_m31_mul(b92, b58);
    b92 = stwo_m31_sub(b78, b31);
    b31 = 8u;
    b78 = stwo_m31_mul(b31, b18);
    b31 = stwo_m31_add(b92, b78);
    b78 = 512u;
    b92 = stwo_m31_mul(b95, b78);
    b78 = stwo_m31_add(b84, b94);
    b84 = stwo_m31_sub(b92, b78);
    b78 = 512u;
    b92 = stwo_m31_mul(b96, b78);
    b78 = stwo_m31_add(b31, b95);
    b31 = stwo_m31_sub(b92, b78);
    StwoCairoQm31 e0 = { b84, b97, b97, b97 };
