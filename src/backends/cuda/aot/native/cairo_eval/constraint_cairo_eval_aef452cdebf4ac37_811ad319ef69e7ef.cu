...
stwo_cairo_cuda_eval_v1_d1984a08a6ae3b53(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 53u, row, 0);
    ...
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 249u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 250u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 251u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 278u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 279u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 280u, row, 0);
    unsigned b97 = 0u;
