...
stwo_cairo_cuda_eval_v1_b3cd9072753e25ed(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 123u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 258u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 263u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 264u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 265u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 285u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 292u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 293u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 294u, row, 0);
    unsigned b97 = 0u;
