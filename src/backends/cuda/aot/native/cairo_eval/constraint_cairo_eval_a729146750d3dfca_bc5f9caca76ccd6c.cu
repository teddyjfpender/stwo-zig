...
stwo_cairo_cuda_eval_v1_15f21794542a8577(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b2 = stwo_trace_value(arena, *args, 1u, 68u, row, 0);
    unsigned b3 = stwo_trace_value(arena, *args, 1u, 69u, row, 0);
    unsigned b4 = stwo_trace_value(arena, *args, 1u, 70u, row, 0);
    unsigned b5 = stwo_trace_value(arena, *args, 1u, 71u, row, 0);
    ...
    unsigned b9 = stwo_trace_value(arena, *args, 1u, 75u, row, 0);
    unsigned b10 = stwo_trace_value(arena, *args, 1u, 76u, row, 0);
    unsigned b11 = stwo_trace_value(arena, *args, 1u, 77u, row, 0);
    unsigned b12 = stwo_trace_value(arena, *args, 1u, 78u, row, 0);
    unsigned b13 = stwo_trace_value(arena, *args, 1u, 79u, row, 0);
    unsigned b14 = stwo_trace_value(arena, *args, 1u, 80u, row, 0);
    unsigned b15 = stwo_trace_value(arena, *args, 1u, 81u, row, 0);
    unsigned b16 = stwo_trace_value(arena, *args, 1u, 82u, row, 0);
    unsigned b17 = stwo_trace_value(arena, *args, 1u, 83u, row, 0);
    unsigned b18 = stwo_trace_value(arena, *args, 1u, 84u, row, 0);
    unsigned b19 = stwo_trace_value(arena, *args, 1u, 85u, row, 0);
    unsigned b20 = stwo_trace_value(arena, *args, 1u, 86u, row, 0);
    unsigned b21 = stwo_trace_value(arena, *args, 1u, 87u, row, 0);
    ...
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 117u, row, 0);
    ...
    unsigned b88 = stwo_trace_value(arena, *args, 1u, 230u, row, 0);
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 256u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 257u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 258u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 279u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 286u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 287u, row, 0);
    unsigned b95 = 0u;
    unsigned b96 = stwo_m31_add(b21, b0);
    b0 = stwo_m31_add(b96, b79);
    b96 = stwo_m31_add(b22, b1);
    b1 = stwo_m31_add(b96, b80);
    ...
    b113 = stwo_m31_sub(b119, b0);
    b119 = stwo_m31_sub(b122, b1);
    b122 = 2u;
    b1 = stwo_m31_mul(b122, b113);
    b122 = 4u;
    b113 = stwo_m31_mul(b122, b108);
    b122 = stwo_m31_sub(b1, b113);
    b113 = 2u;
    b1 = stwo_m31_mul(b113, b107);
    b113 = stwo_m31_add(b122, b1);
    b1 = 64u;
    b122 = stwo_m31_mul(b1, b106);
    b1 = stwo_m31_add(b113, b122);
    b122 = 2u;
    ...
    b113 = stwo_m31_add(b1, b89);
    b1 = stwo_m31_sub(b122, b113);
    b113 = 256u;
    b122 = stwo_m31_mul(b113, b88);
    b113 = stwo_m31_sub(b119, b122);
    b122 = stwo_m31_add(b113, b90);
    b113 = stwo_m31_sub(b2, b60);
    b60 = stwo_m31_sub(b3, b61);
    b61 = stwo_m31_sub(b4, b62);
    b62 = stwo_m31_sub(b5, b63);
    b63 = stwo_m31_sub(b6, b64);
    b64 = stwo_m31_sub(b7, b65);
    b65 = stwo_m31_sub(b8, b66);
    b66 = stwo_m31_sub(b9, b67);
    b67 = stwo_m31_sub(b10, b68);
    b68 = stwo_m31_sub(b11, b69);
    b69 = stwo_m31_sub(b12, b70);
    b70 = stwo_m31_sub(b13, b71);
    b71 = stwo_m31_sub(b14, b72);
    b72 = stwo_m31_sub(b15, b73);
    b73 = stwo_m31_sub(b16, b74);
    b74 = stwo_m31_sub(b17, b75);
    b75 = stwo_m31_sub(b18, b76);
    b76 = stwo_m31_sub(b19, b77);
    b77 = stwo_m31_sub(b20, b78);
    b78 = stwo_m31_sub(b21, b79);
    b79 = stwo_m31_sub(b22, b80);
    b80 = stwo_m31_sub(b23, b81);
    b81 = stwo_m31_sub(b24, b82);
    b82 = stwo_m31_sub(b25, b83);
    b83 = stwo_m31_sub(b26, b84);
    b84 = stwo_m31_sub(b27, b85);
    b85 = stwo_m31_sub(b28, b86);
    b86 = stwo_m31_sub(b29, b87);
    b87 = stwo_m31_add(b30, b91);
    ...
    b31 = stwo_m31_add(b29, b30);
    b30 = stwo_m31_mul(b38, b60);
    b29 = stwo_m31_add(b31, b30);
    b30 = stwo_m31_mul(b39, b66);
    b31 = stwo_m31_mul(b40, b72);
    b72 = stwo_m31_mul(b41, b71);
    b71 = stwo_m31_add(b31, b72);
    ...
    b45 = stwo_m31_sub(b68, b30);
    b68 = stwo_m31_add(b29, b45);
    b45 = stwo_m31_mul(b46, b73);
    b29 = stwo_m31_mul(b47, b79);
    b30 = stwo_m31_mul(b48, b78);
    b72 = stwo_m31_add(b29, b30);
    b30 = stwo_m31_mul(b49, b77);
    b29 = stwo_m31_add(b72, b30);
    b30 = stwo_m31_mul(b50, b76);
    b72 = stwo_m31_add(b29, b30);
    b30 = stwo_m31_mul(b51, b75);
    b29 = stwo_m31_add(b72, b30);
    b30 = stwo_m31_mul(b52, b74);
    b72 = stwo_m31_add(b29, b30);
    b30 = stwo_m31_mul(b53, b80);
    b29 = stwo_m31_mul(b54, b86);
    b86 = stwo_m31_mul(b55, b85);
    b85 = stwo_m31_add(b29, b86);
    ...
    StwoCairoQm31 e0 = { b1, b95, b95, b95 };
