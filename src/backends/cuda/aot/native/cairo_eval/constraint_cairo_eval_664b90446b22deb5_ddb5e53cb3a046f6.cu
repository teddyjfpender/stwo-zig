...
stwo_cairo_cuda_eval_v1_d4598ce2471c5065(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b38 = stwo_trace_value(arena, *args, 1u, 185u, row, 0);
    unsigned b39 = stwo_trace_value(arena, *args, 1u, 186u, row, 0);
    unsigned b40 = stwo_trace_value(arena, *args, 1u, 191u, row, 0);
    unsigned b41 = stwo_trace_value(arena, *args, 1u, 192u, row, 0);
