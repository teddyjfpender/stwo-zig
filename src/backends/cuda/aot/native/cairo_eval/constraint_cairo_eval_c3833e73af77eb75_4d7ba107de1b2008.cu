...
stwo_cairo_cuda_eval_v1_c479fc615e8d95a5(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 107u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 108u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 113u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 114u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 115u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 269u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 270u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 275u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 276u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 277u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 304u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 305u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 306u, row, 0);
    unsigned b97 = 0u;
    ...
    b66 = stwo_m31_mul(b93, b70);
    b18 = stwo_m31_mul(b40, b69);
    b17 = stwo_m31_add(b66, b18);
    b18 = stwo_m31_mul(b41, b68);
    b66 = stwo_m31_add(b17, b18);
    b18 = stwo_m31_mul(b42, b67);
    b17 = stwo_m31_add(b66, b18);
    b18 = stwo_m31_mul(b43, b39);
    b66 = stwo_m31_add(b17, b18);
    b18 = stwo_m31_sub(b66, b32);
    b66 = stwo_m31_sub(b18, b26);
    b18 = stwo_m31_add(b27, b66);
    b66 = stwo_m31_mul(b93, b71);
    b93 = stwo_m31_mul(b40, b70);
    b40 = stwo_m31_add(b66, b93);
    b93 = stwo_m31_mul(b41, b69);
    b69 = stwo_m31_add(b40, b93);
    b93 = stwo_m31_mul(b42, b68);
    b68 = stwo_m31_add(b69, b93);
    b93 = stwo_m31_mul(b43, b67);
    b67 = stwo_m31_add(b68, b93);
    b93 = stwo_m31_mul(b44, b39);
    b39 = stwo_m31_add(b67, b93);
    b93 = stwo_m31_sub(b39, b29);
    b39 = stwo_m31_sub(b93, b23);
    b93 = stwo_m31_add(b28, b39);
    b39 = stwo_m31_mul(b43, b19);
    b43 = stwo_m31_mul(b44, b71);
    b67 = stwo_m31_add(b39, b43);
    b43 = stwo_m31_mul(b20, b70);
    b70 = stwo_m31_add(b67, b43);
    b43 = stwo_m31_sub(b70, b30);
    b70 = stwo_m31_sub(b43, b24);
    b43 = stwo_m31_add(b25, b70);
    b70 = stwo_m31_mul(b44, b19);
    b44 = stwo_m31_mul(b20, b71);
    b71 = stwo_m31_add(b70, b44);
    b44 = stwo_m31_sub(b71, b27);
    b71 = stwo_m31_sub(b44, b21);
    b44 = stwo_m31_add(b26, b71);
    b71 = stwo_m31_mul(b20, b19);
    b19 = stwo_m31_sub(b71, b28);
    b71 = stwo_m31_sub(b19, b22);
    b19 = stwo_m31_add(b23, b71);
    b71 = stwo_m31_mul(b47, b77);
    b23 = stwo_m31_mul(b48, b76);
    b28 = stwo_m31_add(b71, b23);
    b23 = stwo_m31_mul(b49, b75);
    b71 = stwo_m31_add(b28, b23);
    b23 = stwo_m31_mul(b50, b74);
    b28 = stwo_m31_add(b71, b23);
    b23 = stwo_m31_mul(b47, b78);
    b71 = stwo_m31_mul(b48, b77);
    b20 = stwo_m31_add(b23, b71);
    b71 = stwo_m31_mul(b49, b76);
    b23 = stwo_m31_add(b20, b71);
    b71 = stwo_m31_mul(b50, b75);
    b20 = stwo_m31_add(b23, b71);
    b71 = stwo_m31_mul(b51, b74);
    b23 = stwo_m31_add(b20, b71);
    b71 = stwo_m31_mul(b47, b79);
    b20 = stwo_m31_mul(b48, b78);
    b26 = stwo_m31_add(b71, b20);
    b20 = stwo_m31_mul(b49, b77);
    b71 = stwo_m31_add(b26, b20);
    b20 = stwo_m31_mul(b50, b76);
    b26 = stwo_m31_add(b71, b20);
    b20 = stwo_m31_mul(b51, b75);
    b71 = stwo_m31_add(b26, b20);
    b20 = stwo_m31_mul(b52, b74);
    b26 = stwo_m31_add(b71, b20);
    b20 = stwo_m31_mul(b52, b80);
    b71 = stwo_m31_mul(b53, b79);
    b27 = stwo_m31_add(b20, b71);
    b71 = stwo_m31_mul(b53, b80);
    b80 = stwo_m31_mul(b54, b85);
    b53 = stwo_m31_mul(b55, b84);
    b20 = stwo_m31_add(b80, b53);
    b53 = stwo_m31_mul(b56, b83);
    b80 = stwo_m31_add(b20, b53);
    b53 = stwo_m31_mul(b57, b82);
    b20 = stwo_m31_add(b80, b53);
    b53 = stwo_m31_mul(b58, b81);
    b80 = stwo_m31_add(b20, b53);
    b53 = stwo_m31_mul(b54, b86);
    b20 = stwo_m31_mul(b55, b85);
    b70 = stwo_m31_add(b53, b20);
    b20 = stwo_m31_mul(b56, b84);
    b53 = stwo_m31_add(b70, b20);
    b20 = stwo_m31_mul(b57, b83);
    b70 = stwo_m31_add(b53, b20);
    b20 = stwo_m31_mul(b58, b82);
    b53 = stwo_m31_add(b70, b20);
    b20 = stwo_m31_mul(b59, b81);
    b70 = stwo_m31_add(b53, b20);
    b20 = stwo_m31_mul(b59, b87);
    b53 = stwo_m31_mul(b60, b86);
    b25 = stwo_m31_add(b20, b53);
    b53 = stwo_m31_mul(b60, b87);
    b20 = stwo_m31_add(b47, b54);
    ...
    b30 = stwo_m31_mul(b20, b84);
    b67 = stwo_m31_mul(b54, b83);
    b39 = stwo_m31_add(b30, b67);
    b67 = stwo_m31_mul(b55, b82);
    b30 = stwo_m31_add(b39, b67);
    b67 = stwo_m31_mul(b56, b81);
    b39 = stwo_m31_add(b30, b67);
    b67 = stwo_m31_mul(b57, b24);
    b30 = stwo_m31_add(b39, b67);
    b67 = stwo_m31_sub(b30, b23);
    b30 = stwo_m31_sub(b67, b80);
    b67 = stwo_m31_add(b27, b30);
    b30 = stwo_m31_mul(b20, b85);
    b85 = stwo_m31_mul(b54, b84);
    b84 = stwo_m31_add(b30, b85);
    ...
    b85 = stwo_m31_mul(b58, b24);
    b24 = stwo_m31_add(b81, b85);
    b85 = stwo_m31_sub(b24, b26);
    b24 = stwo_m31_sub(b85, b70);
    b85 = stwo_m31_add(b71, b24);
    b24 = stwo_m31_add(b33, b47);
    ...
    b79 = stwo_m31_add(b72, b86);
    b86 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b24, b76);
    b73 = stwo_m31_mul(b47, b75);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b48, b74);
    b87 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_mul(b49, b60);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b24, b77);
    b87 = stwo_m31_mul(b47, b76);
    b65 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b48, b75);
    b73 = stwo_m31_add(b65, b87);
    b87 = stwo_m31_mul(b49, b74);
    b65 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b50, b60);
    b73 = stwo_m31_add(b65, b87);
    b87 = stwo_m31_mul(b24, b78);
    b78 = stwo_m31_mul(b47, b77);
    b77 = stwo_m31_add(b87, b78);
    ...
    b78 = stwo_m31_mul(b51, b60);
    b60 = stwo_m31_add(b74, b78);
    b78 = stwo_m31_mul(b52, b86);
    b52 = stwo_m31_mul(b59, b79);
    b79 = stwo_m31_add(b78, b52);
    b52 = stwo_m31_mul(b59, b86);
    b86 = stwo_m31_sub(b72, b31);
    b72 = stwo_m31_sub(b86, b28);
    b86 = stwo_m31_add(b43, b72);
    b72 = stwo_m31_sub(b73, b32);
    b73 = stwo_m31_sub(b72, b23);
    b72 = stwo_m31_add(b44, b73);
    b73 = stwo_m31_sub(b60, b29);
    b60 = stwo_m31_sub(b73, b26);
    b73 = stwo_m31_add(b19, b60);
    b60 = stwo_m31_sub(b79, b21);
    b79 = stwo_m31_sub(b60, b25);
    b60 = stwo_m31_add(b67, b79);
    b79 = stwo_m31_sub(b52, b22);
    b52 = stwo_m31_sub(b79, b53);
    b79 = stwo_m31_add(b85, b52);
    b52 = stwo_m31_sub(b18, b88);
    b18 = stwo_m31_sub(b93, b89);
    b93 = stwo_m31_sub(b86, b90);
    b86 = stwo_m31_sub(b72, b91);
    b72 = stwo_m31_sub(b73, b92);
    b73 = 2u;
    b92 = stwo_m31_mul(b73, b52);
