...
stwo_cairo_cuda_eval_v1_ac46325d56000e5f(
    unsigned *arena,
    u64 arena_words,
    ...
    b12 = 256u;
    unsigned b15 = stwo_m31_add(b14, b12);
    b12 = 32768u;
    ...
    b12 = stwo_m31_sub(b14, b8);
    b14 = 2u;
    b4 = stwo_m31_add(b0, b14);
    b14 = stwo_m31_add(b1, b5);
    b5 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    unsigned b18 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b19 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b20 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    unsigned b21 = stwo_trace_value(arena, *args, 2u, 4u, row, 0);
    unsigned b22 = stwo_trace_value(arena, *args, 2u, 5u, row, 0);
    unsigned b23 = stwo_trace_value(arena, *args, 2u, 6u, row, 0);
    unsigned b24 = stwo_trace_value(arena, *args, 2u, 7u, row, 0);
    unsigned b25 = stwo_trace_value(arena, *args, 2u, 8u, row, -1);
    unsigned b26 = stwo_trace_value(arena, *args, 2u, 8u, row, 0);
    unsigned b27 = stwo_trace_value(arena, *args, 2u, 9u, row, -1);
    unsigned b28 = stwo_trace_value(arena, *args, 2u, 9u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 2u, 10u, row, -1);
    unsigned b30 = stwo_trace_value(arena, *args, 2u, 10u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 2u, 11u, row, -1);
    unsigned b32 = stwo_trace_value(arena, *args, 2u, 11u, row, 0);
    ...
    e8 = { b12, b10, b10, b10 };
    e3 = stwo_load_qm31(arena, args->ext_params + 16u * 4u);
    e6 = { b0, b10, b10, b10 };
    ...
    e10 = { b4, b10, b10, b10 };
    StwoCairoQm31 e11 = stwo_qm31_mul(e6, e10);
    e10 = stwo_load_qm31(arena, args->ext_params + 22u * 4u);
    e6 = stwo_qm31_add(e10, e11);
    e10 = stwo_load_qm31(arena, args->ext_params + 23u * 4u);
    e11 = { b14, b10, b10, b10 };
    ...
    e10 = stwo_load_qm31(arena, args->ext_params + 26u * 4u);
    ...
    e4 = stwo_load_qm31(arena, args->ext_params + 28u * 4u);
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e7, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 6u) * 4u)));
