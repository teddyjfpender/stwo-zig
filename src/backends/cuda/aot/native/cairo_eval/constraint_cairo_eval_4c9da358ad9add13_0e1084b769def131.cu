...
stwo_cairo_cuda_eval_v1_086e70d15da296b1(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b0 = stwo_trace_value(arena, *args, 1u, 4u, row, 0);
    unsigned b1 = stwo_trace_value(arena, *args, 1u, 5u, row, 0);
    unsigned b2 = stwo_trace_value(arena, *args, 1u, 12u, row, 0);
    unsigned b3 = stwo_trace_value(arena, *args, 1u, 13u, row, 0);
    unsigned b4 = stwo_trace_value(arena, *args, 1u, 14u, row, 0);
    unsigned b5 = stwo_trace_value(arena, *args, 1u, 15u, row, 0);
    unsigned b6 = stwo_trace_value(arena, *args, 1u, 16u, row, 0);
    unsigned b7 = stwo_trace_value(arena, *args, 1u, 17u, row, 0);
    unsigned b8 = stwo_trace_value(arena, *args, 1u, 18u, row, 0);
    unsigned b9 = stwo_trace_value(arena, *args, 1u, 19u, row, 0);
    unsigned b10 = stwo_trace_value(arena, *args, 1u, 20u, row, 0);
    unsigned b11 = stwo_trace_value(arena, *args, 1u, 21u, row, 0);
    unsigned b12 = stwo_trace_value(arena, *args, 1u, 22u, row, 0);
    unsigned b13 = stwo_trace_value(arena, *args, 1u, 23u, row, 0);
    unsigned b14 = stwo_trace_value(arena, *args, 1u, 24u, row, 0);
    unsigned b15 = stwo_trace_value(arena, *args, 1u, 25u, row, 0);
    unsigned b16 = stwo_trace_value(arena, *args, 1u, 26u, row, 0);
    unsigned b17 = stwo_trace_value(arena, *args, 1u, 27u, row, 0);
    unsigned b18 = stwo_trace_value(arena, *args, 1u, 28u, row, 0);
    unsigned b19 = stwo_trace_value(arena, *args, 1u, 29u, row, 0);
    unsigned b20 = stwo_trace_value(arena, *args, 1u, 30u, row, 0);
    unsigned b21 = stwo_trace_value(arena, *args, 1u, 31u, row, 0);
    ...
    unsigned b63 = 0u;
    unsigned b64 = 32768u;
    unsigned b65 = stwo_m31_sub(b0, b64);
    b64 = 32768u;
    b0 = stwo_m31_sub(b1, b64);
    b64 = stwo_m31_add(b2, b65);
    b65 = stwo_m31_add(b3, b0);
    b0 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    b3 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    b2 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    b1 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    unsigned b66 = stwo_trace_value(arena, *args, 2u, 4u, row, 0);
    unsigned b67 = stwo_trace_value(arena, *args, 2u, 5u, row, 0);
    unsigned b68 = stwo_trace_value(arena, *args, 2u, 6u, row, 0);
    unsigned b69 = stwo_trace_value(arena, *args, 2u, 7u, row, 0);
    unsigned b70 = stwo_trace_value(arena, *args, 2u, 8u, row, 0);
    unsigned b71 = stwo_trace_value(arena, *args, 2u, 9u, row, 0);
    unsigned b72 = stwo_trace_value(arena, *args, 2u, 10u, row, 0);
    unsigned b73 = stwo_trace_value(arena, *args, 2u, 11u, row, 0);
    StwoCairoQm31 e0 = stwo_load_qm31(arena, args->ext_params + 12u * 4u);
    StwoCairoQm31 e1 = { b4, b63, b63, b63 };
    ...
    e1 = stwo_load_qm31(arena, args->ext_params + 43u * 4u);
    e0 = { b64, b63, b63, b63 };
    e3 = stwo_qm31_mul(e1, e0);
    e0 = stwo_load_qm31(arena, args->ext_params + 44u * 4u);
    ...
    e3 = stwo_load_qm31(arena, args->ext_params + 48u * 4u);
    ...
    e5 = stwo_load_qm31(arena, args->ext_params + 50u * 4u);
    e4 = { b35, b63, b63, b63 };
    ...
    e0 = stwo_qm31_add(e4, e5);
    e5 = stwo_load_qm31(arena, args->ext_params + 52u * 4u);
    e4 = { b37, b63, b63, b63 };
    e3 = stwo_qm31_mul(e5, e4);
    e4 = stwo_qm31_add(e0, e3);
    ...
    e5 = stwo_qm31_mul(e3, e0);
    e0 = stwo_qm31_add(e4, e5);
    e5 = stwo_load_qm31(arena, args->ext_params + 56u * 4u);
    e4 = { b41, b63, b63, b63 };
    e3 = stwo_qm31_mul(e5, e4);
    e4 = stwo_qm31_add(e0, e3);
    ...
    e3 = stwo_qm31_mul(e5, e4);
    e4 = stwo_qm31_add(e0, e3);
    e3 = stwo_load_qm31(arena, args->ext_params + 61u * 4u);
    e0 = { b46, b63, b63, b63 };
    e5 = stwo_qm31_mul(e3, e0);
    e0 = stwo_qm31_add(e4, e5);
    e5 = stwo_load_qm31(arena, args->ext_params + 62u * 4u);
    e4 = { b47, b63, b63, b63 };
    e3 = stwo_qm31_mul(e5, e4);
    e4 = stwo_qm31_add(e0, e3);
    ...
    e5 = stwo_qm31_mul(e3, e0);
    e0 = stwo_qm31_add(e4, e5);
    e5 = stwo_load_qm31(arena, args->ext_params + 70u * 4u);
    e4 = { b55, b63, b63, b63 };
    e3 = stwo_qm31_mul(e5, e4);
    e4 = stwo_qm31_add(e0, e3);
    ...
    e5 = stwo_qm31_mul(e3, e0);
    e0 = stwo_qm31_add(e4, e5);
    e5 = stwo_load_qm31(arena, args->ext_params + 76u * 4u);
    e4 = { b61, b63, b63, b63 };
    e3 = stwo_qm31_mul(e5, e4);
    e4 = stwo_qm31_add(e0, e3);
    ...
    e2 = stwo_qm31_sub(e3, e6);
    e3 = { b70, b71, b72, b73 };
    e6 = stwo_qm31_sub(e3, e0);
    e3 = stwo_qm31_mul(e6, e5);
    e6 = stwo_qm31_sub(e3, e1);
