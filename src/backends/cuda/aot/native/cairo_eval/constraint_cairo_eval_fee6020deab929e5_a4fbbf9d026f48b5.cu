...
stwo_cairo_cuda_eval_v1_91ff16df44804d1a(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b61 = stwo_trace_value(arena, *args, 1u, 110u, row, 0);
    unsigned b62 = stwo_trace_value(arena, *args, 1u, 111u, row, 0);
    unsigned b63 = stwo_trace_value(arena, *args, 1u, 116u, row, 0);
    unsigned b64 = stwo_trace_value(arena, *args, 1u, 117u, row, 0);
    unsigned b65 = stwo_trace_value(arena, *args, 1u, 118u, row, 0);
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 173u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 174u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 175u, row, 0);
    unsigned b97 = 0u;
