...
stwo_cairo_cuda_eval_v1_75429938c9d58600(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b61 = stwo_trace_value(arena, *args, 1u, 98u, row, 0);
    unsigned b62 = stwo_trace_value(arena, *args, 1u, 99u, row, 0);
    unsigned b63 = stwo_trace_value(arena, *args, 1u, 100u, row, 0);
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 177u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 178u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 179u, row, 0);
    unsigned b97 = 0u;
    ...
    b31 = stwo_m31_add(b29, b32);
    b32 = stwo_m31_mul(b70, b38);
    b29 = stwo_m31_mul(b71, b37);
    b28 = stwo_m31_add(b32, b29);
    b29 = stwo_m31_mul(b72, b36);
    b32 = stwo_m31_add(b28, b29);
    b29 = stwo_m31_mul(b71, b38);
    b28 = stwo_m31_mul(b72, b37);
    b27 = stwo_m31_add(b29, b28);
    b28 = stwo_m31_mul(b73, b42);
    b29 = stwo_m31_mul(b74, b41);
    b26 = stwo_m31_add(b28, b29);
    b29 = stwo_m31_mul(b75, b40);
    b28 = stwo_m31_add(b26, b29);
    b29 = stwo_m31_mul(b76, b39);
    b26 = stwo_m31_add(b28, b29);
    b29 = stwo_m31_mul(b73, b43);
    b28 = stwo_m31_mul(b74, b42);
    b25 = stwo_m31_add(b29, b28);
    b28 = stwo_m31_mul(b75, b41);
    b29 = stwo_m31_add(b25, b28);
    b28 = stwo_m31_mul(b76, b40);
    b25 = stwo_m31_add(b29, b28);
    b28 = stwo_m31_mul(b77, b39);
    b29 = stwo_m31_add(b25, b28);
    b28 = stwo_m31_mul(b77, b45);
    b25 = stwo_m31_mul(b78, b44);
    b24 = stwo_m31_add(b28, b25);
    b25 = stwo_m31_mul(b79, b43);
    b28 = stwo_m31_add(b24, b25);
    b25 = stwo_m31_mul(b78, b45);
    b45 = stwo_m31_mul(b79, b44);
    b44 = stwo_m31_add(b25, b45);
    b45 = stwo_m31_add(b66, b73);
    b25 = stwo_m31_add(b67, b74);
    b79 = stwo_m31_add(b68, b75);
    b78 = stwo_m31_add(b69, b76);
    b24 = stwo_m31_add(b70, b77);
    b23 = stwo_m31_add(b98, b39);
    b22 = stwo_m31_add(b33, b40);
    b21 = stwo_m31_add(b34, b41);
    b20 = stwo_m31_add(b35, b42);
    b19 = stwo_m31_add(b36, b43);
    b18 = stwo_m31_mul(b45, b20);
    b17 = stwo_m31_mul(b25, b21);
    b16 = stwo_m31_add(b18, b17);
    b17 = stwo_m31_mul(b79, b22);
    b18 = stwo_m31_add(b16, b17);
    b17 = stwo_m31_mul(b78, b23);
    b16 = stwo_m31_add(b18, b17);
    b17 = stwo_m31_sub(b16, b30);
    b16 = stwo_m31_sub(b17, b26);
    b17 = stwo_m31_add(b32, b16);
    b16 = stwo_m31_mul(b45, b19);
    b19 = stwo_m31_mul(b25, b20);
    b20 = stwo_m31_add(b16, b19);
    b19 = stwo_m31_mul(b79, b21);
    b21 = stwo_m31_add(b20, b19);
    b19 = stwo_m31_mul(b78, b22);
    ...
    b27 = stwo_m31_mul(b81, b48);
    b29 = stwo_m31_add(b23, b27);
    b27 = stwo_m31_mul(b82, b47);
    b23 = stwo_m31_add(b29, b27);
    b27 = stwo_m31_mul(b83, b46);
    b29 = stwo_m31_add(b23, b27);
    b27 = stwo_m31_mul(b80, b50);
    b23 = stwo_m31_mul(b81, b49);
    b22 = stwo_m31_add(b27, b23);
    b23 = stwo_m31_mul(b82, b48);
    b27 = stwo_m31_add(b22, b23);
    b23 = stwo_m31_mul(b83, b47);
    b22 = stwo_m31_add(b27, b23);
    b23 = stwo_m31_mul(b84, b46);
    b27 = stwo_m31_add(b22, b23);
    b23 = stwo_m31_mul(b84, b52);
    b22 = stwo_m31_mul(b85, b51);
    b24 = stwo_m31_add(b23, b22);
    b22 = stwo_m31_mul(b86, b50);
    b23 = stwo_m31_add(b24, b22);
    b22 = stwo_m31_mul(b85, b52);
    b24 = stwo_m31_mul(b86, b51);
    b21 = stwo_m31_add(b22, b24);
    b24 = stwo_m31_mul(b87, b56);
    b22 = stwo_m31_mul(b88, b55);
    b78 = stwo_m31_add(b24, b22);
    b22 = stwo_m31_mul(b89, b54);
    b24 = stwo_m31_add(b78, b22);
    b22 = stwo_m31_mul(b90, b53);
    b78 = stwo_m31_add(b24, b22);
    b22 = stwo_m31_mul(b87, b57);
    b24 = stwo_m31_mul(b88, b56);
    b20 = stwo_m31_add(b22, b24);
    b24 = stwo_m31_mul(b89, b55);
    b22 = stwo_m31_add(b20, b24);
    b24 = stwo_m31_mul(b90, b54);
    b20 = stwo_m31_add(b22, b24);
    b24 = stwo_m31_mul(b91, b53);
    b22 = stwo_m31_add(b20, b24);
    b24 = stwo_m31_mul(b91, b59);
    b20 = stwo_m31_mul(b92, b58);
    b79 = stwo_m31_add(b24, b20);
    b20 = stwo_m31_mul(b93, b57);
    b24 = stwo_m31_add(b79, b20);
    b20 = stwo_m31_mul(b92, b59);
    b59 = stwo_m31_mul(b93, b58);
    b58 = stwo_m31_add(b20, b59);
    b59 = stwo_m31_add(b80, b87);
    b20 = stwo_m31_add(b81, b88);
    b93 = stwo_m31_add(b82, b89);
    b92 = stwo_m31_add(b83, b90);
    b79 = stwo_m31_add(b84, b91);
    b16 = stwo_m31_add(b46, b53);
    b25 = stwo_m31_add(b47, b54);
    b45 = stwo_m31_add(b48, b55);
    b32 = stwo_m31_add(b49, b56);
    b26 = stwo_m31_add(b50, b57);
    b18 = stwo_m31_mul(b59, b32);
    b15 = stwo_m31_mul(b20, b45);
    b14 = stwo_m31_add(b18, b15);
    b15 = stwo_m31_mul(b93, b25);
    b18 = stwo_m31_add(b14, b15);
    b15 = stwo_m31_mul(b92, b16);
    b14 = stwo_m31_add(b18, b15);
    b15 = stwo_m31_sub(b14, b29);
    b14 = stwo_m31_sub(b15, b78);
    b15 = stwo_m31_add(b23, b14);
    b14 = stwo_m31_mul(b59, b26);
    b26 = stwo_m31_mul(b20, b32);
    b32 = stwo_m31_add(b14, b26);
    b26 = stwo_m31_mul(b93, b45);
    b45 = stwo_m31_add(b32, b26);
    b26 = stwo_m31_mul(b92, b25);
    b25 = stwo_m31_add(b45, b26);
    b26 = stwo_m31_mul(b79, b16);
    b16 = stwo_m31_add(b25, b26);
    b26 = stwo_m31_sub(b16, b27);
    b16 = stwo_m31_sub(b26, b22);
    b26 = stwo_m31_add(b21, b16);
    b16 = stwo_m31_add(b66, b80);
    ...
    b57 = stwo_m31_mul(b16, b48);
    b43 = stwo_m31_mul(b80, b47);
    b42 = stwo_m31_add(b57, b43);
    b43 = stwo_m31_mul(b81, b46);
    b57 = stwo_m31_add(b42, b43);
    b43 = stwo_m31_mul(b82, b91);
    b42 = stwo_m31_add(b57, b43);
    b43 = stwo_m31_mul(b16, b49);
    b57 = stwo_m31_mul(b80, b48);
    b41 = stwo_m31_add(b43, b57);
    b57 = stwo_m31_mul(b81, b47);
    b43 = stwo_m31_add(b41, b57);
    b57 = stwo_m31_mul(b82, b46);
    b41 = stwo_m31_add(b43, b57);
    b57 = stwo_m31_mul(b83, b91);
    b43 = stwo_m31_add(b41, b57);
    b57 = stwo_m31_mul(b83, b51);
    b41 = stwo_m31_mul(b84, b50);
    b40 = stwo_m31_add(b57, b41);
    b41 = stwo_m31_mul(b85, b49);
    b57 = stwo_m31_add(b40, b41);
    b41 = stwo_m31_mul(b84, b51);
    b51 = stwo_m31_mul(b85, b50);
    b50 = stwo_m31_add(b41, b51);
    b51 = stwo_m31_mul(b86, b55);
    b41 = stwo_m31_mul(b87, b54);
    b85 = stwo_m31_add(b51, b41);
    b41 = stwo_m31_mul(b88, b53);
    b51 = stwo_m31_add(b85, b41);
    b41 = stwo_m31_mul(b89, b52);
    b85 = stwo_m31_add(b51, b41);
    b41 = stwo_m31_mul(b86, b56);
    b51 = stwo_m31_mul(b87, b55);
    b84 = stwo_m31_add(b41, b51);
    b51 = stwo_m31_mul(b88, b54);
    b41 = stwo_m31_add(b84, b51);
    b51 = stwo_m31_mul(b89, b53);
    b84 = stwo_m31_add(b41, b51);
    b51 = stwo_m31_mul(b90, b52);
    b41 = stwo_m31_add(b84, b51);
    b51 = stwo_m31_add(b16, b86);
    b86 = stwo_m31_add(b80, b87);
    b87 = stwo_m31_add(b81, b88);
    b88 = stwo_m31_add(b82, b89);
    b89 = stwo_m31_add(b83, b90);
    b90 = stwo_m31_add(b91, b52);
    b52 = stwo_m31_add(b46, b53);
    b53 = stwo_m31_add(b47, b54);
    b54 = stwo_m31_add(b48, b55);
    b55 = stwo_m31_add(b49, b56);
    b56 = stwo_m31_mul(b51, b54);
    b49 = stwo_m31_mul(b86, b53);
    b48 = stwo_m31_add(b56, b49);
    b49 = stwo_m31_mul(b87, b52);
    b56 = stwo_m31_add(b48, b49);
    b49 = stwo_m31_mul(b88, b90);
    b48 = stwo_m31_add(b56, b49);
    b49 = stwo_m31_sub(b48, b42);
    b48 = stwo_m31_sub(b49, b85);
    b49 = stwo_m31_add(b57, b48);
    b48 = stwo_m31_mul(b51, b55);
    b55 = stwo_m31_mul(b86, b54);
    b54 = stwo_m31_add(b48, b55);
    b55 = stwo_m31_mul(b87, b53);
    b53 = stwo_m31_add(b54, b55);
    b55 = stwo_m31_mul(b88, b52);
    b52 = stwo_m31_add(b53, b55);
    b55 = stwo_m31_mul(b89, b90);
    b90 = stwo_m31_add(b52, b55);
    b55 = stwo_m31_sub(b90, b43);
    b90 = stwo_m31_sub(b55, b41);
    b55 = stwo_m31_add(b50, b90);
    b90 = stwo_m31_sub(b49, b17);
    b49 = stwo_m31_sub(b90, b15);
    b90 = stwo_m31_add(b28, b49);
    b49 = stwo_m31_sub(b55, b19);
    b55 = stwo_m31_sub(b49, b26);
    b49 = stwo_m31_add(b44, b55);
    b55 = stwo_m31_sub(b65, b60);
    b65 = stwo_m31_sub(b30, b61);
    b30 = stwo_m31_sub(b31, b62);
    b31 = stwo_m31_sub(b90, b63);
    b90 = stwo_m31_sub(b49, b64);
    b49 = 32u;
    b64 = stwo_m31_mul(b49, b65);
    b49 = stwo_m31_add(b55, b64);
    b64 = 4u;
    b55 = stwo_m31_mul(b64, b31);
    b64 = stwo_m31_sub(b49, b55);
    b55 = 8u;
    b49 = stwo_m31_mul(b55, b24);
    b55 = stwo_m31_add(b64, b49);
    b49 = 32u;
    b64 = stwo_m31_mul(b49, b30);
    b49 = stwo_m31_add(b65, b64);
    b64 = 4u;
    b65 = stwo_m31_mul(b64, b90);
    b64 = stwo_m31_sub(b49, b65);
    b65 = 8u;
    b49 = stwo_m31_mul(b65, b58);
    b65 = stwo_m31_add(b64, b49);
    b49 = 512u;
    b64 = stwo_m31_mul(b95, b49);
    b49 = stwo_m31_add(b55, b94);
    b55 = stwo_m31_sub(b64, b49);
    b49 = 512u;
    b64 = stwo_m31_mul(b96, b49);
    b49 = stwo_m31_add(b65, b95);
    b65 = stwo_m31_sub(b64, b49);
    StwoCairoQm31 e0 = { b55, b97, b97, b97 };
    StwoCairoQm31 e1 = { b65, b97, b97, b97 };
