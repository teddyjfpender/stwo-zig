...
stwo_cairo_cuda_eval_v1_34541d1f17ebafd7(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 101u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 121u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 122u, row, 0);
    ...
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 263u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 283u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 284u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 290u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 291u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 292u, row, 0);
    unsigned b97 = 0u;
