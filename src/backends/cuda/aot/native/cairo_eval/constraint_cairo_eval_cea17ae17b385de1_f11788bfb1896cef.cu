...
stwo_cairo_cuda_eval_v1_469fdb5fa60f5ac7(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 55u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 56u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 251u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 252u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 257u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 258u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 259u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 286u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 287u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 288u, row, 0);
    unsigned b97 = 0u;
