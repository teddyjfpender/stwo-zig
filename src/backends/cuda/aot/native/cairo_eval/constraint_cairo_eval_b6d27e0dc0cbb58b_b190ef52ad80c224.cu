...
stwo_cairo_cuda_eval_v1_81c5b9cd98c73d80(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b88 = stwo_trace_value(arena, *args, 1u, 584u, row, 0);
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 585u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 586u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 587u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 595u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 619u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 620u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 621u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 622u, row, 0);
    unsigned b97 = 0u;
    ...
    b91 = stwo_m31_mul(b32, b62);
    b31 = stwo_m31_mul(b33, b61);
    b30 = stwo_m31_add(b91, b31);
    b31 = stwo_m31_mul(b34, b60);
    b91 = stwo_m31_add(b30, b31);
    b31 = stwo_m31_mul(b35, b98);
    b30 = stwo_m31_add(b91, b31);
    b31 = stwo_m31_mul(b32, b63);
    b91 = stwo_m31_mul(b33, b62);
    b29 = stwo_m31_add(b31, b91);
    b91 = stwo_m31_mul(b34, b61);
    b31 = stwo_m31_add(b29, b91);
    b91 = stwo_m31_mul(b35, b60);
    b29 = stwo_m31_add(b31, b91);
    b91 = stwo_m31_mul(b36, b98);
    b31 = stwo_m31_add(b29, b91);
    b91 = stwo_m31_mul(b32, b64);
    b29 = stwo_m31_mul(b33, b63);
    b28 = stwo_m31_add(b91, b29);
    b29 = stwo_m31_mul(b34, b62);
    b91 = stwo_m31_add(b28, b29);
    b29 = stwo_m31_mul(b35, b61);
    b28 = stwo_m31_add(b91, b29);
    b29 = stwo_m31_mul(b36, b60);
    b91 = stwo_m31_add(b28, b29);
    b29 = stwo_m31_mul(b37, b98);
    b28 = stwo_m31_add(b91, b29);
    b29 = stwo_m31_mul(b32, b65);
    b91 = stwo_m31_mul(b33, b64);
    b27 = stwo_m31_add(b29, b91);
    b91 = stwo_m31_mul(b34, b63);
    b29 = stwo_m31_add(b27, b91);
    b91 = stwo_m31_mul(b35, b62);
    b27 = stwo_m31_add(b29, b91);
    b91 = stwo_m31_mul(b36, b61);
    b29 = stwo_m31_add(b27, b91);
    b91 = stwo_m31_mul(b37, b60);
    b27 = stwo_m31_add(b29, b91);
    b91 = stwo_m31_mul(b38, b98);
    b29 = stwo_m31_add(b27, b91);
    b91 = stwo_m31_mul(b36, b65);
    b27 = stwo_m31_mul(b37, b64);
    b26 = stwo_m31_add(b91, b27);
    b27 = stwo_m31_mul(b38, b63);
    b91 = stwo_m31_add(b26, b27);
    b27 = stwo_m31_mul(b37, b65);
    b26 = stwo_m31_mul(b38, b64);
    b25 = stwo_m31_add(b27, b26);
    b26 = stwo_m31_mul(b38, b65);
    b27 = stwo_m31_mul(b39, b69);
    b24 = stwo_m31_mul(b40, b68);
    b23 = stwo_m31_add(b27, b24);
    b24 = stwo_m31_mul(b41, b67);
    b27 = stwo_m31_add(b23, b24);
    b24 = stwo_m31_mul(b42, b66);
    b23 = stwo_m31_add(b27, b24);
    b24 = stwo_m31_mul(b39, b70);
    b27 = stwo_m31_mul(b40, b69);
    b22 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b41, b68);
    b24 = stwo_m31_add(b22, b27);
    b27 = stwo_m31_mul(b42, b67);
    b22 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b43, b66);
    b24 = stwo_m31_add(b22, b27);
    b27 = stwo_m31_mul(b39, b71);
    b22 = stwo_m31_mul(b40, b70);
    b21 = stwo_m31_add(b27, b22);
    b22 = stwo_m31_mul(b41, b69);
    b27 = stwo_m31_add(b21, b22);
    b22 = stwo_m31_mul(b42, b68);
    b21 = stwo_m31_add(b27, b22);
    b22 = stwo_m31_mul(b43, b67);
    b27 = stwo_m31_add(b21, b22);
    b22 = stwo_m31_mul(b44, b66);
    b21 = stwo_m31_add(b27, b22);
    b22 = stwo_m31_mul(b39, b72);
    b39 = stwo_m31_mul(b40, b71);
    b40 = stwo_m31_add(b22, b39);
    b39 = stwo_m31_mul(b41, b70);
    b41 = stwo_m31_add(b40, b39);
    b39 = stwo_m31_mul(b42, b69);
    b69 = stwo_m31_add(b41, b39);
    ...
    b39 = stwo_m31_mul(b43, b72);
    b67 = stwo_m31_mul(b44, b71);
    b68 = stwo_m31_add(b39, b67);
    b67 = stwo_m31_mul(b45, b70);
    b39 = stwo_m31_add(b68, b67);
    b67 = stwo_m31_mul(b44, b72);
    b68 = stwo_m31_mul(b45, b71);
    b69 = stwo_m31_add(b67, b68);
    b68 = stwo_m31_mul(b45, b72);
    b67 = stwo_m31_add(b36, b43);
    b43 = stwo_m31_add(b37, b44);
    b44 = stwo_m31_add(b38, b45);
    b45 = stwo_m31_add(b63, b70);
    b70 = stwo_m31_add(b64, b71);
    b71 = stwo_m31_add(b65, b72);
    b72 = stwo_m31_mul(b67, b71);
    b67 = stwo_m31_mul(b43, b70);
    b41 = stwo_m31_add(b72, b67);
    b67 = stwo_m31_mul(b44, b45);
    b45 = stwo_m31_add(b41, b67);
    b67 = stwo_m31_sub(b45, b91);
    b45 = stwo_m31_sub(b67, b39);
    b67 = stwo_m31_add(b23, b45);
    b45 = stwo_m31_mul(b43, b71);
    b43 = stwo_m31_mul(b44, b70);
    b70 = stwo_m31_add(b45, b43);
    b43 = stwo_m31_sub(b70, b25);
    b70 = stwo_m31_sub(b43, b69);
    b43 = stwo_m31_add(b24, b70);
    b70 = stwo_m31_mul(b44, b71);
    b71 = stwo_m31_sub(b70, b26);
    b70 = stwo_m31_sub(b71, b68);
    b71 = stwo_m31_add(b21, b70);
    b70 = stwo_m31_mul(b46, b76);
    b21 = stwo_m31_mul(b47, b75);
    b68 = stwo_m31_add(b70, b21);
    b21 = stwo_m31_mul(b48, b74);
    b70 = stwo_m31_add(b68, b21);
    b21 = stwo_m31_mul(b49, b73);
    b68 = stwo_m31_add(b70, b21);
    b21 = stwo_m31_mul(b46, b77);
    b70 = stwo_m31_mul(b47, b76);
    b26 = stwo_m31_add(b21, b70);
    b70 = stwo_m31_mul(b48, b75);
    b21 = stwo_m31_add(b26, b70);
    b70 = stwo_m31_mul(b49, b74);
    b26 = stwo_m31_add(b21, b70);
    b70 = stwo_m31_mul(b50, b73);
    b21 = stwo_m31_add(b26, b70);
    b70 = stwo_m31_mul(b46, b78);
    b26 = stwo_m31_mul(b47, b77);
    b44 = stwo_m31_add(b70, b26);
    b26 = stwo_m31_mul(b48, b76);
    b70 = stwo_m31_add(b44, b26);
    b26 = stwo_m31_mul(b49, b75);
    b44 = stwo_m31_add(b70, b26);
    b26 = stwo_m31_mul(b50, b74);
    b70 = stwo_m31_add(b44, b26);
    b26 = stwo_m31_mul(b51, b73);
    b44 = stwo_m31_add(b70, b26);
    b26 = stwo_m31_mul(b46, b79);
    b70 = stwo_m31_mul(b47, b78);
    b24 = stwo_m31_add(b26, b70);
    b70 = stwo_m31_mul(b48, b77);
    b26 = stwo_m31_add(b24, b70);
    b70 = stwo_m31_mul(b49, b76);
    b24 = stwo_m31_add(b26, b70);
    b70 = stwo_m31_mul(b50, b75);
    b26 = stwo_m31_add(b24, b70);
    b70 = stwo_m31_mul(b51, b74);
    b24 = stwo_m31_add(b26, b70);
    b70 = stwo_m31_mul(b52, b73);
    b26 = stwo_m31_add(b24, b70);
    b70 = stwo_m31_mul(b50, b79);
    b24 = stwo_m31_mul(b51, b78);
    b69 = stwo_m31_add(b70, b24);
    b24 = stwo_m31_mul(b52, b77);
    b70 = stwo_m31_add(b69, b24);
    b24 = stwo_m31_mul(b51, b79);
    b69 = stwo_m31_mul(b52, b78);
    b25 = stwo_m31_add(b24, b69);
    b69 = stwo_m31_mul(b52, b79);
    b24 = stwo_m31_mul(b53, b83);
    b45 = stwo_m31_mul(b54, b82);
    b23 = stwo_m31_add(b24, b45);
    b45 = stwo_m31_mul(b55, b81);
    b24 = stwo_m31_add(b23, b45);
    b45 = stwo_m31_mul(b56, b80);
    b23 = stwo_m31_add(b24, b45);
    b45 = stwo_m31_mul(b53, b84);
    b24 = stwo_m31_mul(b54, b83);
    b39 = stwo_m31_add(b45, b24);
    b24 = stwo_m31_mul(b55, b82);
    b45 = stwo_m31_add(b39, b24);
    b24 = stwo_m31_mul(b56, b81);
    b39 = stwo_m31_add(b45, b24);
    b24 = stwo_m31_mul(b57, b80);
    b45 = stwo_m31_add(b39, b24);
    b24 = stwo_m31_mul(b53, b85);
    b39 = stwo_m31_mul(b54, b84);
    b91 = stwo_m31_add(b24, b39);
    b39 = stwo_m31_mul(b55, b83);
    b24 = stwo_m31_add(b91, b39);
    b39 = stwo_m31_mul(b56, b82);
    b91 = stwo_m31_add(b24, b39);
    b39 = stwo_m31_mul(b57, b81);
    b24 = stwo_m31_add(b91, b39);
    b39 = stwo_m31_mul(b58, b80);
    b91 = stwo_m31_add(b24, b39);
    b39 = stwo_m31_mul(b53, b86);
    b53 = stwo_m31_mul(b54, b85);
    b54 = stwo_m31_add(b39, b53);
    b53 = stwo_m31_mul(b55, b84);
    b55 = stwo_m31_add(b54, b53);
    b53 = stwo_m31_mul(b56, b83);
    b54 = stwo_m31_add(b55, b53);
    b53 = stwo_m31_mul(b57, b82);
    b82 = stwo_m31_add(b54, b53);
    b53 = stwo_m31_mul(b58, b81);
    b81 = stwo_m31_add(b82, b53);
    b53 = stwo_m31_mul(b59, b80);
    b80 = stwo_m31_add(b81, b53);
    b53 = stwo_m31_mul(b56, b86);
    b56 = stwo_m31_mul(b57, b85);
    b81 = stwo_m31_add(b53, b56);
    b56 = stwo_m31_mul(b58, b84);
    b53 = stwo_m31_add(b81, b56);
    b56 = stwo_m31_mul(b59, b83);
    b83 = stwo_m31_add(b53, b56);
    b56 = stwo_m31_mul(b57, b86);
    b53 = stwo_m31_mul(b58, b85);
    b81 = stwo_m31_add(b56, b53);
    b53 = stwo_m31_mul(b59, b84);
    b56 = stwo_m31_add(b81, b53);
    b53 = stwo_m31_mul(b58, b86);
    b81 = stwo_m31_mul(b59, b85);
    b82 = stwo_m31_add(b53, b81);
    b81 = stwo_m31_mul(b59, b86);
    b53 = stwo_m31_add(b50, b57);
    b57 = stwo_m31_add(b51, b58);
    b58 = stwo_m31_add(b52, b59);
    b59 = stwo_m31_add(b77, b84);
    ...
    b59 = stwo_m31_add(b54, b53);
    b53 = stwo_m31_sub(b59, b70);
    b59 = stwo_m31_sub(b53, b56);
    b53 = stwo_m31_add(b23, b59);
    b59 = stwo_m31_mul(b57, b85);
    b57 = stwo_m31_mul(b58, b84);
    b84 = stwo_m31_add(b59, b57);
    b57 = stwo_m31_sub(b84, b25);
    b84 = stwo_m31_sub(b57, b82);
    b57 = stwo_m31_add(b45, b84);
    b84 = stwo_m31_mul(b58, b85);
    b85 = stwo_m31_sub(b84, b69);
    b84 = stwo_m31_sub(b85, b81);
    b85 = stwo_m31_add(b91, b84);
    b84 = stwo_m31_add(b32, b46);
    ...
    b79 = stwo_m31_mul(b84, b75);
    b65 = stwo_m31_mul(b46, b74);
    b64 = stwo_m31_add(b79, b65);
    b65 = stwo_m31_mul(b47, b73);
    b79 = stwo_m31_add(b64, b65);
    b65 = stwo_m31_mul(b48, b52);
    b64 = stwo_m31_add(b79, b65);
    b65 = stwo_m31_mul(b84, b76);
    b79 = stwo_m31_mul(b46, b75);
    b63 = stwo_m31_add(b65, b79);
    b79 = stwo_m31_mul(b47, b74);
    b65 = stwo_m31_add(b63, b79);
    b79 = stwo_m31_mul(b48, b73);
    b63 = stwo_m31_add(b65, b79);
    b79 = stwo_m31_mul(b49, b52);
    b65 = stwo_m31_add(b63, b79);
    b79 = stwo_m31_mul(b84, b77);
    b63 = stwo_m31_mul(b46, b76);
    b62 = stwo_m31_add(b79, b63);
    b63 = stwo_m31_mul(b47, b75);
    b79 = stwo_m31_add(b62, b63);
    b63 = stwo_m31_mul(b48, b74);
    b62 = stwo_m31_add(b79, b63);
    b63 = stwo_m31_mul(b49, b73);
    b79 = stwo_m31_add(b62, b63);
    b63 = stwo_m31_mul(b50, b52);
    b62 = stwo_m31_add(b79, b63);
    b63 = stwo_m31_mul(b84, b78);
    b78 = stwo_m31_mul(b46, b77);
    b77 = stwo_m31_add(b63, b78);
    ...
    b78 = stwo_m31_sub(b64, b30);
    b64 = stwo_m31_sub(b78, b68);
    b78 = stwo_m31_add(b67, b64);
    b64 = stwo_m31_sub(b65, b31);
    b65 = stwo_m31_sub(b64, b21);
    b64 = stwo_m31_add(b43, b65);
    b65 = stwo_m31_sub(b62, b28);
    b62 = stwo_m31_sub(b65, b44);
    b65 = stwo_m31_add(b71, b62);
    b62 = stwo_m31_sub(b52, b29);
    b52 = stwo_m31_sub(b62, b26);
    b62 = stwo_m31_add(b66, b52);
    b52 = stwo_m31_sub(b78, b87);
    b78 = stwo_m31_sub(b64, b88);
    b64 = stwo_m31_sub(b65, b89);
    b65 = stwo_m31_sub(b62, b90);
    b62 = 2u;
    b90 = stwo_m31_mul(b62, b52);
    b62 = 4u;
    b52 = stwo_m31_mul(b62, b53);
    b62 = stwo_m31_sub(b90, b52);
    b52 = 2u;
    b90 = stwo_m31_mul(b52, b83);
    b52 = stwo_m31_add(b62, b90);
    b90 = 64u;
    b62 = stwo_m31_mul(b90, b56);
    b90 = stwo_m31_add(b52, b62);
    b62 = 2u;
    b52 = stwo_m31_mul(b62, b78);
    b62 = 4u;
    b78 = stwo_m31_mul(b62, b57);
    b62 = stwo_m31_sub(b52, b78);
    b78 = 2u;
    b52 = stwo_m31_mul(b78, b56);
    b78 = stwo_m31_add(b62, b52);
    b52 = 64u;
    b62 = stwo_m31_mul(b52, b82);
    b52 = stwo_m31_add(b78, b62);
    b62 = 2u;
    b78 = stwo_m31_mul(b62, b64);
    b62 = 4u;
    b64 = stwo_m31_mul(b62, b85);
    b62 = stwo_m31_sub(b78, b64);
    b64 = 2u;
    b78 = stwo_m31_mul(b64, b82);
    b64 = stwo_m31_add(b62, b78);
    b78 = 64u;
    b62 = stwo_m31_mul(b78, b81);
    b78 = stwo_m31_add(b64, b62);
    b62 = 2u;
    b64 = stwo_m31_mul(b62, b65);
    b62 = 4u;
    b65 = stwo_m31_mul(b62, b80);
    b62 = stwo_m31_sub(b64, b65);
    b65 = 2u;
    b64 = stwo_m31_mul(b65, b81);
    b65 = stwo_m31_add(b62, b64);
    b64 = 512u;
    b62 = stwo_m31_mul(b94, b64);
    b64 = stwo_m31_add(b90, b93);
    b90 = stwo_m31_sub(b62, b64);
    b64 = 512u;
    b62 = stwo_m31_mul(b95, b64);
    b64 = stwo_m31_add(b52, b94);
    b52 = stwo_m31_sub(b62, b64);
    b64 = 512u;
    b62 = stwo_m31_mul(b96, b64);
    b64 = stwo_m31_add(b78, b95);
    b78 = stwo_m31_sub(b62, b64);
    b64 = 256u;
    b62 = stwo_m31_mul(b64, b92);
    b64 = stwo_m31_sub(b65, b62);
    b62 = stwo_m31_add(b64, b96);
    StwoCairoQm31 e0 = { b90, b97, b97, b97 };
    StwoCairoQm31 e1 = { b52, b97, b97, b97 };
    StwoCairoQm31 e2 = { b78, b97, b97, b97 };
    StwoCairoQm31 e3 = { b62, b97, b97, b97 };
