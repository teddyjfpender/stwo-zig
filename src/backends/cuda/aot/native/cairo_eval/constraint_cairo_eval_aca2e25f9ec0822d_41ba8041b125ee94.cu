...
stwo_cairo_cuda_eval_v1_669abd5a1c8e2cee(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 171u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 172u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 173u, row, 0);
    unsigned b97 = 0u;
    ...
    b27 = stwo_m31_mul(b70, b37);
    b26 = stwo_m31_add(b32, b27);
    b27 = stwo_m31_mul(b71, b36);
    b32 = stwo_m31_add(b26, b27);
    b27 = stwo_m31_mul(b72, b35);
    b26 = stwo_m31_add(b32, b27);
    b27 = stwo_m31_mul(b73, b39);
    b32 = stwo_m31_mul(b73, b40);
    b25 = stwo_m31_mul(b74, b39);
    b24 = stwo_m31_add(b32, b25);
    b25 = stwo_m31_mul(b73, b41);
    b32 = stwo_m31_mul(b74, b40);
    b23 = stwo_m31_add(b25, b32);
    b32 = stwo_m31_mul(b75, b39);
    b25 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b74, b45);
    b23 = stwo_m31_mul(b75, b44);
    b22 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b76, b43);
    b32 = stwo_m31_add(b22, b23);
    b23 = stwo_m31_mul(b77, b42);
    b22 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b78, b41);
    b32 = stwo_m31_add(b22, b23);
    b23 = stwo_m31_mul(b79, b40);
    b22 = stwo_m31_add(b32, b23);
    b23 = stwo_m31_mul(b75, b45);
    b32 = stwo_m31_mul(b76, b44);
    b21 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b77, b43);
    b23 = stwo_m31_add(b21, b32);
    b32 = stwo_m31_mul(b78, b42);
    b21 = stwo_m31_add(b23, b32);
    b32 = stwo_m31_mul(b79, b41);
    b23 = stwo_m31_add(b21, b32);
    b32 = stwo_m31_mul(b76, b45);
    b21 = stwo_m31_mul(b77, b44);
    b20 = stwo_m31_add(b32, b21);
    b21 = stwo_m31_mul(b78, b43);
    b32 = stwo_m31_add(b20, b21);
    b21 = stwo_m31_mul(b79, b42);
    b20 = stwo_m31_add(b32, b21);
    b21 = stwo_m31_add(b66, b73);
    b73 = stwo_m31_add(b67, b74);
    b74 = stwo_m31_add(b68, b75);
    b32 = stwo_m31_add(b69, b76);
    ...
    b19 = stwo_m31_add(b35, b42);
    b35 = stwo_m31_add(b36, b43);
    b36 = stwo_m31_add(b37, b44);
    b37 = stwo_m31_add(b38, b45);
    b38 = stwo_m31_mul(b21, b39);
    b18 = stwo_m31_mul(b73, b72);
    b17 = stwo_m31_add(b38, b18);
    b18 = stwo_m31_sub(b17, b30);
    b17 = stwo_m31_sub(b18, b24);
    b18 = stwo_m31_add(b29, b17);
    b17 = stwo_m31_mul(b21, b40);
    b21 = stwo_m31_mul(b73, b39);
    b38 = stwo_m31_add(b17, b21);
    b21 = stwo_m31_mul(b74, b72);
    b72 = stwo_m31_add(b38, b21);
    b21 = stwo_m31_sub(b72, b31);
    b72 = stwo_m31_sub(b21, b25);
    b21 = stwo_m31_add(b26, b72);
    b72 = stwo_m31_mul(b73, b37);
    b73 = stwo_m31_mul(b74, b36);
    b38 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_mul(b32, b35);
    b72 = stwo_m31_add(b38, b73);
    b73 = stwo_m31_mul(b69, b19);
    b38 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_mul(b70, b40);
    b72 = stwo_m31_add(b38, b73);
    b73 = stwo_m31_mul(b71, b39);
    b39 = stwo_m31_add(b72, b73);
    b73 = stwo_m31_sub(b39, b28);
    b39 = stwo_m31_sub(b73, b22);
    b73 = stwo_m31_add(b27, b39);
    b39 = stwo_m31_mul(b74, b37);
    b74 = stwo_m31_mul(b32, b36);
    b27 = stwo_m31_add(b39, b74);
    b74 = stwo_m31_mul(b69, b35);
    b39 = stwo_m31_add(b27, b74);
    b74 = stwo_m31_mul(b70, b19);
    b27 = stwo_m31_add(b39, b74);
    b74 = stwo_m31_mul(b71, b40);
    b40 = stwo_m31_add(b27, b74);
    b74 = stwo_m31_sub(b40, b29);
    b40 = stwo_m31_sub(b74, b23);
    b74 = stwo_m31_add(b24, b40);
    b40 = stwo_m31_mul(b32, b37);
    b37 = stwo_m31_mul(b69, b36);
    b36 = stwo_m31_add(b40, b37);
    b37 = stwo_m31_mul(b70, b35);
    b35 = stwo_m31_add(b36, b37);
    b37 = stwo_m31_mul(b71, b19);
    b19 = stwo_m31_add(b35, b37);
    b37 = stwo_m31_sub(b19, b26);
    b19 = stwo_m31_sub(b37, b20);
    b37 = stwo_m31_add(b25, b19);
    b19 = stwo_m31_mul(b80, b46);
    b25 = stwo_m31_mul(b80, b47);
    b26 = stwo_m31_mul(b81, b46);
    b35 = stwo_m31_add(b25, b26);
    ...
    b71 = stwo_m31_mul(b83, b51);
    b36 = stwo_m31_add(b25, b71);
    b71 = stwo_m31_mul(b84, b50);
    b25 = stwo_m31_add(b36, b71);
    b71 = stwo_m31_mul(b85, b49);
    b36 = stwo_m31_add(b25, b71);
    b71 = stwo_m31_mul(b86, b48);
    b25 = stwo_m31_add(b36, b71);
    b71 = stwo_m31_mul(b83, b52);
    b52 = stwo_m31_mul(b84, b51);
    b51 = stwo_m31_add(b71, b52);
    b52 = stwo_m31_mul(b85, b50);
    b50 = stwo_m31_add(b51, b52);
    b52 = stwo_m31_mul(b86, b49);
    b49 = stwo_m31_add(b50, b52);
    b52 = stwo_m31_mul(b87, b54);
    b50 = stwo_m31_mul(b88, b53);
    b86 = stwo_m31_add(b52, b50);
    b50 = stwo_m31_mul(b87, b55);
    b52 = stwo_m31_mul(b88, b54);
    b51 = stwo_m31_add(b50, b52);
    b52 = stwo_m31_mul(b89, b53);
    b50 = stwo_m31_add(b51, b52);
    b52 = stwo_m31_mul(b89, b59);
    b51 = stwo_m31_mul(b90, b58);
    b85 = stwo_m31_add(b52, b51);
    b51 = stwo_m31_mul(b91, b57);
    b52 = stwo_m31_add(b85, b51);
    b51 = stwo_m31_mul(b92, b56);
    b85 = stwo_m31_add(b52, b51);
    b51 = stwo_m31_mul(b93, b55);
    b52 = stwo_m31_add(b85, b51);
    b51 = stwo_m31_mul(b90, b59);
    b85 = stwo_m31_mul(b91, b58);
    b71 = stwo_m31_add(b51, b85);
    b85 = stwo_m31_mul(b92, b57);
    b51 = stwo_m31_add(b71, b85);
    b85 = stwo_m31_mul(b93, b56);
    b71 = stwo_m31_add(b51, b85);
    b85 = stwo_m31_add(b80, b87);
    b87 = stwo_m31_add(b81, b88);
    b88 = stwo_m31_add(b82, b89);
    b51 = stwo_m31_add(b46, b53);
    b53 = stwo_m31_add(b47, b54);
    b54 = stwo_m31_add(b48, b55);
    b84 = stwo_m31_mul(b85, b53);
    b83 = stwo_m31_mul(b87, b51);
    b36 = stwo_m31_add(b84, b83);
    b83 = stwo_m31_sub(b36, b35);
    b36 = stwo_m31_sub(b83, b86);
    b83 = stwo_m31_add(b25, b36);
    b36 = stwo_m31_mul(b85, b54);
    b54 = stwo_m31_mul(b87, b53);
    b53 = stwo_m31_add(b36, b54);
    b54 = stwo_m31_mul(b88, b51);
    b51 = stwo_m31_add(b53, b54);
    b54 = stwo_m31_sub(b51, b26);
    b51 = stwo_m31_sub(b54, b50);
    b54 = stwo_m31_add(b49, b51);
    b51 = stwo_m31_add(b66, b80);
    b80 = stwo_m31_add(b67, b81);
    b81 = stwo_m31_add(b68, b82);
    b82 = stwo_m31_add(b75, b89);
    ...
    b59 = stwo_m31_mul(b51, b93);
    b45 = stwo_m31_mul(b51, b46);
    b44 = stwo_m31_mul(b80, b93);
    b43 = stwo_m31_add(b45, b44);
    b44 = stwo_m31_mul(b51, b47);
    b47 = stwo_m31_mul(b80, b46);
    b46 = stwo_m31_add(b44, b47);
    b47 = stwo_m31_mul(b81, b93);
    b93 = stwo_m31_add(b46, b47);
    b47 = stwo_m31_mul(b82, b58);
    b82 = stwo_m31_mul(b89, b57);
    b46 = stwo_m31_add(b47, b82);
    b82 = stwo_m31_mul(b90, b56);
    b47 = stwo_m31_add(b46, b82);
    b82 = stwo_m31_mul(b91, b55);
    b46 = stwo_m31_add(b47, b82);
    b82 = stwo_m31_mul(b92, b48);
    b48 = stwo_m31_add(b46, b82);
    b82 = stwo_m31_mul(b89, b58);
    b58 = stwo_m31_mul(b90, b57);
    b57 = stwo_m31_add(b82, b58);
    b58 = stwo_m31_mul(b91, b56);
    b56 = stwo_m31_add(b57, b58);
    b58 = stwo_m31_mul(b92, b55);
    b55 = stwo_m31_add(b56, b58);
    b58 = stwo_m31_sub(b59, b65);
    b59 = stwo_m31_sub(b58, b19);
    b58 = stwo_m31_add(b73, b59);
    b59 = stwo_m31_sub(b43, b30);
    b43 = stwo_m31_sub(b59, b35);
    b59 = stwo_m31_add(b74, b43);
    b43 = stwo_m31_sub(b93, b31);
    b93 = stwo_m31_sub(b43, b26);
    b43 = stwo_m31_add(b37, b93);
    b93 = stwo_m31_sub(b48, b23);
    b48 = stwo_m31_sub(b93, b52);
    b93 = stwo_m31_add(b83, b48);
    b48 = stwo_m31_sub(b55, b20);
    b55 = stwo_m31_sub(b48, b71);
    b48 = stwo_m31_add(b54, b55);
    b55 = stwo_m31_sub(b18, b60);
    b18 = stwo_m31_sub(b21, b61);
    b21 = stwo_m31_sub(b58, b62);
    b58 = stwo_m31_sub(b59, b63);
    b59 = stwo_m31_sub(b43, b64);
    b43 = 2u;
    b64 = stwo_m31_mul(b43, b55);
