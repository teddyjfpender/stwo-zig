...
stwo_cairo_cuda_eval_v1_819ef423b971a30b(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 103u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 104u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 109u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 110u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 111u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 265u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 266u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 271u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 272u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 273u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 300u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 301u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 302u, row, 0);
    unsigned b97 = 0u;
    ...
    b27 = stwo_m31_mul(b43, b72);
    b22 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b44, b71);
    b24 = stwo_m31_add(b22, b27);
    b27 = stwo_m31_mul(b45, b70);
    b22 = stwo_m31_add(b24, b27);
    b27 = stwo_m31_mul(b46, b69);
    b24 = stwo_m31_add(b22, b27);
    b27 = stwo_m31_add(b33, b40);
    b40 = stwo_m31_add(b34, b41);
    b22 = stwo_m31_add(b35, b42);
    ...
    b66 = stwo_m31_mul(b27, b39);
    b20 = stwo_m31_sub(b66, b93);
    b66 = stwo_m31_sub(b20, b32);
    b20 = stwo_m31_add(b28, b66);
    b66 = stwo_m31_mul(b27, b67);
    b19 = stwo_m31_mul(b40, b39);
    b18 = stwo_m31_add(b66, b19);
    b19 = stwo_m31_sub(b18, b30);
    b18 = stwo_m31_sub(b19, b25);
    b19 = stwo_m31_add(b29, b18);
    b18 = stwo_m31_mul(b27, b65);
    b27 = stwo_m31_mul(b40, b64);
    b66 = stwo_m31_add(b18, b27);
    b27 = stwo_m31_mul(b22, b63);
    b18 = stwo_m31_add(b66, b27);
    b27 = stwo_m31_mul(b35, b62);
    b66 = stwo_m31_add(b18, b27);
    b27 = stwo_m31_mul(b36, b21);
    b18 = stwo_m31_add(b66, b27);
    b27 = stwo_m31_mul(b37, b67);
    b66 = stwo_m31_add(b18, b27);
    b27 = stwo_m31_mul(b38, b39);
    b39 = stwo_m31_add(b66, b27);
    b27 = stwo_m31_sub(b39, b31);
    b39 = stwo_m31_sub(b27, b26);
    b27 = stwo_m31_mul(b40, b65);
    b40 = stwo_m31_mul(b22, b64);
    b26 = stwo_m31_add(b27, b40);
    b40 = stwo_m31_mul(b35, b63);
    b27 = stwo_m31_add(b26, b40);
    b40 = stwo_m31_mul(b36, b62);
    b26 = stwo_m31_add(b27, b40);
    b40 = stwo_m31_mul(b37, b21);
    b27 = stwo_m31_add(b26, b40);
    b40 = stwo_m31_mul(b38, b67);
    b67 = stwo_m31_add(b27, b40);
    b40 = stwo_m31_sub(b67, b28);
    b67 = stwo_m31_sub(b40, b23);
    b40 = stwo_m31_add(b32, b67);
    b67 = stwo_m31_mul(b22, b65);
    b65 = stwo_m31_mul(b35, b64);
    b64 = stwo_m31_add(b67, b65);
    b65 = stwo_m31_mul(b36, b63);
    b63 = stwo_m31_add(b64, b65);
    b65 = stwo_m31_mul(b37, b62);
    b62 = stwo_m31_add(b63, b65);
    b65 = stwo_m31_mul(b38, b21);
    b21 = stwo_m31_add(b62, b65);
    b65 = stwo_m31_sub(b21, b29);
    b21 = stwo_m31_sub(b65, b24);
    b65 = stwo_m31_add(b25, b21);
    b21 = stwo_m31_mul(b47, b74);
    b25 = stwo_m31_mul(b47, b75);
    b29 = stwo_m31_mul(b48, b74);
    b62 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_mul(b48, b80);
    b25 = stwo_m31_mul(b49, b79);
    b38 = stwo_m31_add(b29, b25);
    b25 = stwo_m31_mul(b50, b78);
    b29 = stwo_m31_add(b38, b25);
    ...
    b79 = stwo_m31_add(b25, b80);
    b80 = stwo_m31_mul(b51, b78);
    b78 = stwo_m31_add(b79, b80);
    b80 = stwo_m31_mul(b52, b77);
    b77 = stwo_m31_add(b78, b80);
    b80 = stwo_m31_mul(b53, b76);
    b76 = stwo_m31_add(b77, b80);
    b80 = stwo_m31_mul(b54, b81);
    b77 = stwo_m31_mul(b54, b82);
    b53 = stwo_m31_mul(b55, b81);
    b78 = stwo_m31_add(b77, b53);
    ...
    b52 = stwo_m31_add(b53, b77);
    b77 = stwo_m31_mul(b56, b87);
    b53 = stwo_m31_mul(b57, b86);
    b79 = stwo_m31_add(b77, b53);
    b53 = stwo_m31_mul(b58, b85);
    b77 = stwo_m31_add(b79, b53);
    b53 = stwo_m31_mul(b59, b84);
    b79 = stwo_m31_add(b77, b53);
    b53 = stwo_m31_mul(b60, b83);
    b77 = stwo_m31_add(b79, b53);
    b53 = stwo_m31_add(b47, b54);
    b54 = stwo_m31_add(b48, b55);
    b79 = stwo_m31_add(b74, b81);
    b81 = stwo_m31_add(b75, b82);
    b51 = stwo_m31_mul(b53, b79);
    b25 = stwo_m31_sub(b51, b21);
    b51 = stwo_m31_sub(b25, b80);
    b25 = stwo_m31_add(b38, b51);
    b51 = stwo_m31_mul(b53, b81);
    b81 = stwo_m31_mul(b54, b79);
    b79 = stwo_m31_add(b51, b81);
    b81 = stwo_m31_sub(b79, b62);
    b79 = stwo_m31_sub(b81, b78);
    b81 = stwo_m31_add(b76, b79);
    b79 = stwo_m31_add(b33, b47);
    b47 = stwo_m31_add(b34, b48);
    b48 = stwo_m31_add(b41, b55);
    ...
    b74 = stwo_m31_mul(b47, b60);
    b60 = stwo_m31_add(b73, b74);
    b74 = stwo_m31_mul(b48, b86);
    b48 = stwo_m31_mul(b55, b85);
    b73 = stwo_m31_add(b74, b48);
    b48 = stwo_m31_mul(b56, b84);
    b74 = stwo_m31_add(b73, b48);
    b48 = stwo_m31_mul(b57, b83);
    b73 = stwo_m31_add(b74, b48);
    b48 = stwo_m31_mul(b58, b82);
    b74 = stwo_m31_add(b73, b48);
    b48 = stwo_m31_mul(b59, b75);
    b75 = stwo_m31_add(b74, b48);
    b48 = stwo_m31_mul(b55, b86);
    b86 = stwo_m31_mul(b56, b85);
    b85 = stwo_m31_add(b48, b86);
    b86 = stwo_m31_mul(b57, b84);
    b84 = stwo_m31_add(b85, b86);
    b86 = stwo_m31_mul(b58, b83);
    b83 = stwo_m31_add(b84, b86);
    b86 = stwo_m31_mul(b59, b82);
    b82 = stwo_m31_add(b83, b86);
    b86 = stwo_m31_sub(b87, b93);
    b87 = stwo_m31_sub(b86, b21);
    b86 = stwo_m31_add(b40, b87);
    b87 = stwo_m31_sub(b60, b30);
    b60 = stwo_m31_sub(b87, b62);
    b87 = stwo_m31_add(b65, b60);
    b60 = stwo_m31_sub(b75, b23);
    b75 = stwo_m31_sub(b60, b52);
    b60 = stwo_m31_add(b25, b75);
    b75 = stwo_m31_sub(b82, b24);
    b82 = stwo_m31_sub(b75, b77);
    b75 = stwo_m31_add(b81, b82);
    b82 = stwo_m31_sub(b20, b88);
    b20 = stwo_m31_sub(b19, b89);
    b19 = stwo_m31_sub(b39, b90);
    b39 = stwo_m31_sub(b86, b91);
    b86 = stwo_m31_sub(b87, b92);
    b87 = 2u;
    b92 = stwo_m31_mul(b87, b82);
    b87 = stwo_m31_add(b92, b19);
    b92 = 32u;
    b19 = stwo_m31_mul(b92, b39);
    b92 = stwo_m31_add(b87, b19);
    b19 = 4u;
    b87 = stwo_m31_mul(b19, b60);
    b19 = stwo_m31_sub(b92, b87);
    b87 = 2u;
    b92 = stwo_m31_mul(b87, b20);
    b87 = stwo_m31_add(b92, b39);
    b92 = 32u;
    b39 = stwo_m31_mul(b92, b86);
    b92 = stwo_m31_add(b87, b39);
    b39 = 4u;
    b87 = stwo_m31_mul(b39, b75);
    b39 = stwo_m31_sub(b92, b87);
    b87 = 512u;
    b92 = stwo_m31_mul(b95, b87);
    b87 = stwo_m31_add(b19, b94);
    b19 = stwo_m31_sub(b92, b87);
    b87 = 512u;
    b92 = stwo_m31_mul(b96, b87);
    b87 = stwo_m31_add(b39, b95);
    b39 = stwo_m31_sub(b92, b87);
    StwoCairoQm31 e0 = { b19, b97, b97, b97 };
    StwoCairoQm31 e1 = { b39, b97, b97, b97 };
