...
stwo_cairo_cuda_eval_v1_a5509d28f2d6d914(
    unsigned *arena,
    u64 arena_words,
    ...
    b20 = 0u;
    unsigned b21 = 1u;
    unsigned b22 = stwo_m31_sub(b21, b7);
    b21 = stwo_m31_mul(b7, b22);
    b22 = 1u;
    unsigned b23 = stwo_m31_sub(b22, b8);
    b22 = stwo_m31_mul(b8, b23);
    b23 = 8u;
    unsigned b24 = stwo_m31_mul(b6, b23);
    b23 = 16u;
    unsigned b25 = stwo_m31_mul(b7, b23);
    b23 = stwo_m31_add(b24, b25);
    b25 = 32u;
    b24 = stwo_m31_mul(b8, b25);
    b25 = 256u;
    unsigned b26 = stwo_m31_add(b24, b25);
    b25 = 32768u;
    b24 = stwo_m31_sub(b3, b25);
    b25 = 32768u;
    unsigned b27 = stwo_m31_sub(b4, b25);
    b25 = 32768u;
    unsigned b28 = stwo_m31_sub(b5, b25);
    b25 = stwo_m31_mul(b6, b2);
    unsigned b29 = 1u;
    unsigned b30 = stwo_m31_sub(b29, b6);
    b29 = stwo_m31_mul(b30, b1);
    b30 = stwo_m31_add(b25, b29);
    b29 = stwo_m31_sub(b9, b30);
    b30 = stwo_m31_mul(b7, b2);
    b25 = 1u;
    b6 = stwo_m31_sub(b25, b7);
    b25 = stwo_m31_mul(b6, b1);
    b6 = stwo_m31_add(b30, b25);
    b25 = stwo_m31_sub(b10, b6);
    b6 = stwo_m31_add(b10, b27);
    b27 = 1u;
    b10 = stwo_m31_sub(b27, b16);
    b27 = stwo_m31_mul(b16, b10);
    b10 = 1u;
    b30 = stwo_m31_mul(b27, b10);
    b10 = 2u;
    b27 = stwo_m31_mul(b16, b10);
    b10 = stwo_m31_sub(b15, b27);
    b27 = 1u;
    b16 = stwo_m31_sub(b27, b10);
    b27 = stwo_m31_mul(b10, b16);
    b16 = 1u;
    b10 = stwo_m31_mul(b27, b16);
    b16 = stwo_m31_add(b9, b24);
    b24 = 512u;
    b9 = stwo_m31_mul(b13, b24);
    b24 = stwo_m31_add(b12, b9);
    b9 = 262144u;
    b27 = stwo_m31_mul(b14, b9);
    b9 = stwo_m31_add(b24, b27);
    b27 = 134217728u;
    b24 = stwo_m31_mul(b15, b27);
    b27 = stwo_m31_add(b9, b24);
    b24 = stwo_m31_add(b27, b28);
    b27 = stwo_m31_mul(b18, b18);
    b28 = stwo_m31_sub(b27, b18);
    b27 = 1u;
    b9 = stwo_m31_add(b0, b27);
    b27 = stwo_m31_add(b1, b8);
    b8 = stwo_trace_value(arena, *args, 2u, 0u, row, 0);
    b7 = stwo_trace_value(arena, *args, 2u, 1u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 2u, 2u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 2u, 3u, row, 0);
    unsigned b33 = stwo_trace_value(arena, *args, 2u, 4u, row, 0);
    unsigned b34 = stwo_trace_value(arena, *args, 2u, 5u, row, 0);
    unsigned b35 = stwo_trace_value(arena, *args, 2u, 6u, row, 0);
    unsigned b36 = stwo_trace_value(arena, *args, 2u, 7u, row, 0);
    unsigned b37 = stwo_trace_value(arena, *args, 2u, 8u, row, 0);
    unsigned b38 = stwo_trace_value(arena, *args, 2u, 9u, row, 0);
    unsigned b39 = stwo_trace_value(arena, *args, 2u, 10u, row, 0);
    unsigned b40 = stwo_trace_value(arena, *args, 2u, 11u, row, 0);
    unsigned b41 = stwo_trace_value(arena, *args, 2u, 12u, row, -1);
    unsigned b42 = stwo_trace_value(arena, *args, 2u, 12u, row, 0);
    unsigned b43 = stwo_trace_value(arena, *args, 2u, 13u, row, -1);
    unsigned b44 = stwo_trace_value(arena, *args, 2u, 13u, row, 0);
    unsigned b45 = stwo_trace_value(arena, *args, 2u, 14u, row, -1);
    unsigned b46 = stwo_trace_value(arena, *args, 2u, 14u, row, 0);
    unsigned b47 = stwo_trace_value(arena, *args, 2u, 15u, row, -1);
    unsigned b48 = stwo_trace_value(arena, *args, 2u, 15u, row, 0);
    StwoCairoQm31 e0 = { b19, b20, b20, b20 };
    StwoCairoQm31 e1 = { b21, b20, b20, b20 };
    StwoCairoQm31 e2 = { b22, b20, b20, b20 };
    StwoCairoQm31 e3 = stwo_load_qm31(arena, args->ext_params + 0u * 4u);
    StwoCairoQm31 e4 = { b0, b20, b20, b20 };
    ...
    e5 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(arena, args->ext_params + 5u * 4u);
    e3 = { b23, b20, b20, b20 };
    e4 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e5, e4);
    ...
    e6 = stwo_qm31_mul(e4, e5);
    e5 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(arena, args->ext_params + 7u * 4u);
    e3 = stwo_qm31_sub(e5, e6);
    e6 = { b29, b20, b20, b20 };
    e5 = { b25, b20, b20, b20 };
    e4 = stwo_load_qm31(arena, args->ext_params + 8u * 4u);
    StwoCairoQm31 e7 = { b6, b20, b20, b20 };
    ...
    StwoCairoQm31 e10 = { b11, b20, b20, b20 };
    StwoCairoQm31 e11 = stwo_qm31_mul(e7, e10);
    e10 = stwo_load_qm31(arena, args->ext_params + 13u * 4u);
    e7 = stwo_qm31_add(e10, e11);
    e10 = stwo_load_qm31(arena, args->ext_params + 14u * 4u);
    e11 = { b12, b20, b20, b20 };
    StwoCairoQm31 e12 = stwo_qm31_mul(e10, e11);
    e11 = stwo_qm31_add(e7, e12);
    e12 = stwo_load_qm31(arena, args->ext_params + 15u * 4u);
    e7 = { b13, b20, b20, b20 };
    e10 = stwo_qm31_mul(e12, e7);
    e7 = stwo_qm31_add(e11, e10);
    e10 = stwo_load_qm31(arena, args->ext_params + 16u * 4u);
    e11 = { b14, b20, b20, b20 };
    e12 = stwo_qm31_mul(e10, e11);
    e11 = stwo_qm31_add(e7, e12);
    e12 = stwo_load_qm31(arena, args->ext_params + 17u * 4u);
    e7 = { b15, b20, b20, b20 };
    e10 = stwo_qm31_mul(e12, e7);
    e7 = stwo_qm31_add(e11, e10);
    e10 = stwo_load_qm31(arena, args->ext_params + 18u * 4u);
    e11 = stwo_qm31_sub(e7, e10);
    e10 = stwo_load_qm31(arena, args->ext_params + 19u * 4u);
    e7 = { b16, b20, b20, b20 };
    ...
    e16 = stwo_load_qm31(arena, args->ext_params + 38u * 4u);
    ...
    e10 = stwo_load_qm31(arena, args->ext_params + 41u * 4u);
    ...
    part_acc = stwo_qm31_add(part_acc, stwo_qm31_mul(e14, stwo_load_qm31(arena, args->random_coeffs + (args->rc_base + 7u) * 4u)));
