...
stwo_cairo_cuda_eval_v1_41ba6ac4be83bd5a(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 169u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 170u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 171u, row, 0);
    unsigned b97 = 0u;
