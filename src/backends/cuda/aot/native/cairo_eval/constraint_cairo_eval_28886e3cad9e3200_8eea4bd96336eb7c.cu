...
stwo_cairo_cuda_eval_v1_14c5633eeaca546d(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 51u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 52u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 57u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 58u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 59u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 247u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 248u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 253u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 254u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 255u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 282u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 283u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 284u, row, 0);
    unsigned b97 = 0u;
