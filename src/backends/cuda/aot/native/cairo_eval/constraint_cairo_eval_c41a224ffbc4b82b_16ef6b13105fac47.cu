...
stwo_cairo_cuda_eval_v1_3a29875e5a8d04b9(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 263u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 264u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 269u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 270u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 271u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 298u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 299u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 300u, row, 0);
    unsigned b97 = 0u;
