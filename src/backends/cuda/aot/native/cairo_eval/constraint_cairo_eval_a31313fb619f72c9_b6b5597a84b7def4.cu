...
stwo_cairo_cuda_eval_v1_5832ec17e7c988a7(
    unsigned *arena,
    u64 arena_words,
    ...
    unsigned b28 = stwo_trace_value(arena, *args, 1u, 105u, row, 0);
    unsigned b29 = stwo_trace_value(arena, *args, 1u, 106u, row, 0);
    unsigned b30 = stwo_trace_value(arena, *args, 1u, 111u, row, 0);
    unsigned b31 = stwo_trace_value(arena, *args, 1u, 112u, row, 0);
    unsigned b32 = stwo_trace_value(arena, *args, 1u, 113u, row, 0);
    ...
    unsigned b89 = stwo_trace_value(arena, *args, 1u, 267u, row, 0);
    unsigned b90 = stwo_trace_value(arena, *args, 1u, 268u, row, 0);
    unsigned b91 = stwo_trace_value(arena, *args, 1u, 273u, row, 0);
    unsigned b92 = stwo_trace_value(arena, *args, 1u, 274u, row, 0);
    unsigned b93 = stwo_trace_value(arena, *args, 1u, 275u, row, 0);
    unsigned b94 = stwo_trace_value(arena, *args, 1u, 302u, row, 0);
    unsigned b95 = stwo_trace_value(arena, *args, 1u, 303u, row, 0);
    unsigned b96 = stwo_trace_value(arena, *args, 1u, 304u, row, 0);
    unsigned b97 = 0u;
    ...
    b23 = stwo_m31_add(b93, b24);
    b24 = stwo_m31_mul(b42, b73);
    b93 = stwo_m31_mul(b43, b72);
    b22 = stwo_m31_add(b24, b93);
    b93 = stwo_m31_mul(b44, b71);
    b24 = stwo_m31_add(b22, b93);
    b93 = stwo_m31_mul(b45, b70);
    b22 = stwo_m31_add(b24, b93);
    b93 = stwo_m31_mul(b46, b69);
    b24 = stwo_m31_add(b22, b93);
    b93 = stwo_m31_mul(b43, b73);
    b22 = stwo_m31_mul(b44, b72);
    b21 = stwo_m31_add(b93, b22);
    b22 = stwo_m31_mul(b45, b71);
    b93 = stwo_m31_add(b21, b22);
    b22 = stwo_m31_mul(b46, b70);
    b21 = stwo_m31_add(b93, b22);
    b22 = stwo_m31_mul(b44, b73);
    b93 = stwo_m31_mul(b45, b72);
    b20 = stwo_m31_add(b22, b93);
    b93 = stwo_m31_mul(b46, b71);
    b22 = stwo_m31_add(b20, b93);
    b93 = stwo_m31_add(b33, b40);
    ...
    b66 = stwo_m31_mul(b93, b68);
    b18 = stwo_m31_mul(b40, b67);
    b17 = stwo_m31_add(b66, b18);
    b18 = stwo_m31_mul(b41, b39);
    b66 = stwo_m31_add(b17, b18);
    b18 = stwo_m31_sub(b66, b32);
    b66 = stwo_m31_sub(b18, b26);
    b18 = stwo_m31_add(b27, b66);
    b66 = stwo_m31_mul(b93, b69);
    b93 = stwo_m31_mul(b40, b68);
    b40 = stwo_m31_add(b66, b93);
    b93 = stwo_m31_mul(b41, b67);
    b67 = stwo_m31_add(b40, b93);
    b93 = stwo_m31_mul(b42, b39);
    b39 = stwo_m31_add(b67, b93);
    b93 = stwo_m31_sub(b39, b29);
    b39 = stwo_m31_sub(b93, b23);
    b93 = stwo_m31_add(b28, b39);
    b39 = stwo_m31_mul(b41, b65);
    b41 = stwo_m31_mul(b42, b64);
    b67 = stwo_m31_add(b39, b41);
    b41 = stwo_m31_mul(b20, b19);
    b39 = stwo_m31_add(b67, b41);
    b41 = stwo_m31_mul(b37, b69);
    b67 = stwo_m31_add(b39, b41);
    b41 = stwo_m31_mul(b38, b68);
    b68 = stwo_m31_add(b67, b41);
    b41 = stwo_m31_sub(b68, b30);
    b68 = stwo_m31_sub(b41, b24);
    b41 = stwo_m31_add(b25, b68);
    b68 = stwo_m31_mul(b42, b65);
    b42 = stwo_m31_mul(b20, b64);
    b25 = stwo_m31_add(b68, b42);
    b42 = stwo_m31_mul(b37, b19);
    b68 = stwo_m31_add(b25, b42);
    b42 = stwo_m31_mul(b38, b69);
    b69 = stwo_m31_add(b68, b42);
    b42 = stwo_m31_sub(b69, b27);
    b69 = stwo_m31_sub(b42, b21);
    b42 = stwo_m31_add(b26, b69);
    b69 = stwo_m31_mul(b20, b65);
    b65 = stwo_m31_mul(b37, b64);
    b64 = stwo_m31_add(b69, b65);
    b65 = stwo_m31_mul(b38, b19);
    b19 = stwo_m31_add(b64, b65);
    b65 = stwo_m31_sub(b19, b28);
    b19 = stwo_m31_sub(b65, b22);
    b65 = stwo_m31_add(b23, b19);
    b19 = stwo_m31_mul(b47, b75);
    b23 = stwo_m31_mul(b48, b74);
    b28 = stwo_m31_add(b19, b23);
    b23 = stwo_m31_mul(b47, b76);
    b19 = stwo_m31_mul(b48, b75);
    b64 = stwo_m31_add(b23, b19);
    b19 = stwo_m31_mul(b49, b74);
    b23 = stwo_m31_add(b64, b19);
    b19 = stwo_m31_mul(b47, b77);
    b64 = stwo_m31_mul(b48, b76);
    b38 = stwo_m31_add(b19, b64);
    b64 = stwo_m31_mul(b49, b75);
    b19 = stwo_m31_add(b38, b64);
    b64 = stwo_m31_mul(b50, b74);
    b38 = stwo_m31_add(b19, b64);
    b64 = stwo_m31_mul(b50, b80);
    b19 = stwo_m31_mul(b51, b79);
    b69 = stwo_m31_add(b64, b19);
    b19 = stwo_m31_mul(b52, b78);
    b64 = stwo_m31_add(b69, b19);
    b19 = stwo_m31_mul(b53, b77);
    b69 = stwo_m31_add(b64, b19);
    b19 = stwo_m31_mul(b51, b80);
    b80 = stwo_m31_mul(b52, b79);
    b79 = stwo_m31_add(b19, b80);
    b80 = stwo_m31_mul(b53, b78);
    b78 = stwo_m31_add(b79, b80);
    b80 = stwo_m31_mul(b54, b83);
    b79 = stwo_m31_mul(b55, b82);
    b53 = stwo_m31_add(b80, b79);
    b79 = stwo_m31_mul(b56, b81);
    b80 = stwo_m31_add(b53, b79);
    b79 = stwo_m31_mul(b54, b84);
    b53 = stwo_m31_mul(b55, b83);
    b19 = stwo_m31_add(b79, b53);
    b53 = stwo_m31_mul(b56, b82);
    b79 = stwo_m31_add(b19, b53);
    b53 = stwo_m31_mul(b57, b81);
    b19 = stwo_m31_add(b79, b53);
    b53 = stwo_m31_mul(b57, b87);
    b79 = stwo_m31_mul(b58, b86);
    b52 = stwo_m31_add(b53, b79);
    b79 = stwo_m31_mul(b59, b85);
    b53 = stwo_m31_add(b52, b79);
    b79 = stwo_m31_mul(b60, b84);
    b52 = stwo_m31_add(b53, b79);
    b79 = stwo_m31_mul(b58, b87);
    b53 = stwo_m31_mul(b59, b86);
    b51 = stwo_m31_add(b79, b53);
    b53 = stwo_m31_mul(b60, b85);
    b79 = stwo_m31_add(b51, b53);
    b53 = stwo_m31_add(b47, b54);
    b54 = stwo_m31_add(b48, b55);
    b55 = stwo_m31_add(b49, b56);
    b56 = stwo_m31_add(b50, b57);
    b51 = stwo_m31_add(b74, b81);
    b81 = stwo_m31_add(b75, b82);
    b82 = stwo_m31_add(b76, b83);
    b83 = stwo_m31_add(b77, b84);
    b64 = stwo_m31_mul(b53, b82);
    b37 = stwo_m31_mul(b54, b81);
    b20 = stwo_m31_add(b64, b37);
    b37 = stwo_m31_mul(b55, b51);
    b64 = stwo_m31_add(b20, b37);
    b37 = stwo_m31_sub(b64, b23);
    b64 = stwo_m31_sub(b37, b80);
    b37 = stwo_m31_add(b69, b64);
    b64 = stwo_m31_mul(b53, b83);
    b83 = stwo_m31_mul(b54, b82);
    b82 = stwo_m31_add(b64, b83);
    b83 = stwo_m31_mul(b55, b81);
    b81 = stwo_m31_add(b82, b83);
    b83 = stwo_m31_mul(b56, b51);
    b51 = stwo_m31_add(b81, b83);
    b83 = stwo_m31_sub(b51, b38);
    b51 = stwo_m31_sub(b83, b19);
    b83 = stwo_m31_add(b78, b51);
    b51 = stwo_m31_add(b33, b47);
    ...
    b77 = stwo_m31_add(b70, b84);
    b84 = stwo_m31_add(b71, b85);
    b85 = stwo_m31_add(b72, b86);
    b86 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b51, b74);
    b73 = stwo_m31_mul(b47, b60);
    b72 = stwo_m31_add(b87, b73);
    b73 = stwo_m31_mul(b51, b75);
    b87 = stwo_m31_mul(b47, b74);
    b71 = stwo_m31_add(b73, b87);
    b87 = stwo_m31_mul(b48, b60);
    b73 = stwo_m31_add(b71, b87);
    b87 = stwo_m31_mul(b51, b76);
    b76 = stwo_m31_mul(b47, b75);
    b75 = stwo_m31_add(b87, b76);
    b76 = stwo_m31_mul(b48, b74);
    b74 = stwo_m31_add(b75, b76);
    b76 = stwo_m31_mul(b49, b60);
    b60 = stwo_m31_add(b74, b76);
    b76 = stwo_m31_mul(b50, b86);
    b50 = stwo_m31_mul(b57, b85);
    b74 = stwo_m31_add(b76, b50);
    b50 = stwo_m31_mul(b58, b84);
    b76 = stwo_m31_add(b74, b50);
    b50 = stwo_m31_mul(b59, b77);
    b77 = stwo_m31_add(b76, b50);
    b50 = stwo_m31_mul(b57, b86);
    b86 = stwo_m31_mul(b58, b85);
    b85 = stwo_m31_add(b50, b86);
    b86 = stwo_m31_mul(b59, b84);
    b84 = stwo_m31_add(b85, b86);
    b86 = stwo_m31_sub(b72, b31);
    b72 = stwo_m31_sub(b86, b28);
    b86 = stwo_m31_add(b41, b72);
    b72 = stwo_m31_sub(b73, b32);
    b73 = stwo_m31_sub(b72, b23);
    b72 = stwo_m31_add(b42, b73);
    b73 = stwo_m31_sub(b60, b29);
    b60 = stwo_m31_sub(b73, b38);
    b73 = stwo_m31_add(b65, b60);
    b60 = stwo_m31_sub(b77, b21);
    b77 = stwo_m31_sub(b60, b52);
    b60 = stwo_m31_add(b37, b77);
    b77 = stwo_m31_sub(b84, b22);
    b84 = stwo_m31_sub(b77, b79);
    b77 = stwo_m31_add(b83, b84);
    b84 = stwo_m31_sub(b18, b88);
    b18 = stwo_m31_sub(b93, b89);
    b93 = stwo_m31_sub(b86, b90);
    b86 = stwo_m31_sub(b72, b91);
    b72 = stwo_m31_sub(b73, b92);
    b73 = 2u;
    b92 = stwo_m31_mul(b73, b84);
    b73 = stwo_m31_add(b92, b93);
    b92 = 32u;
    b93 = stwo_m31_mul(b92, b86);
    b92 = stwo_m31_add(b73, b93);
    b93 = 4u;
    b73 = stwo_m31_mul(b93, b60);
    b93 = stwo_m31_sub(b92, b73);
    b73 = 2u;
    b92 = stwo_m31_mul(b73, b18);
    b73 = stwo_m31_add(b92, b86);
    b92 = 32u;
    b86 = stwo_m31_mul(b92, b72);
    b92 = stwo_m31_add(b73, b86);
    b86 = 4u;
    b73 = stwo_m31_mul(b86, b77);
    b86 = stwo_m31_sub(b92, b73);
    b73 = 512u;
    b92 = stwo_m31_mul(b95, b73);
    b73 = stwo_m31_add(b93, b94);
    b93 = stwo_m31_sub(b92, b73);
    b73 = 512u;
    b92 = stwo_m31_mul(b96, b73);
    b73 = stwo_m31_add(b86, b95);
    b86 = stwo_m31_sub(b92, b73);
    StwoCairoQm31 e0 = { b93, b97, b97, b97 };
