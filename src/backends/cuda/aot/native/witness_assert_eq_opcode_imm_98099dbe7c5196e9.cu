...
extern "C" __global__ void __launch_bounds__(256) stwo_jit_witness_e17e872ded26ebd1(
    ...
    unsigned r50 = stwo_m31_add(r49, r6);
    ...
    unsigned r55 = stwo_m31_add(r54, r6);
    lookup_words[6u * row_count + row] = r55;
    unsigned r56 = stwo_m31_sub(r25, r8);
    out_cols[3u][row] = r25;
    ...
    lookup_words[13u * row_count + row] = r62;
    ...
    unsigned r65 = stwo_m31_add(r14, r1);
    sub_words[8u * row_count + row] = r65;
    unsigned r66 = stwo_m31_add(r14, r1);
    lookup_words[12u * row_count + row] = r66;
    lookup_words[22u * row_count + row] = r1;
    unsigned r67 = input_cols[3u][row];
    out_cols[8u][row] = r67;
    lookup_words[23u * row_count + row] = r67;
    unsigned r68 = stwo_m31_add(r14, r2);
    out_cols[0u][row] = r14;
    sub_words[0u * row_count + row] = r14;
    lookup_words[1u * row_count + row] = r14;
    lookup_words[15u * row_count + row] = r14;
    lookup_words[19u * row_count + row] = r68;
    unsigned r69 = stwo_m31_add(r15, r45);
    out_cols[1u][row] = r15;
    out_cols[5u][row] = r45;
    lookup_words[16u * row_count + row] = r15;
    lookup_words[20u * row_count + row] = r69;
}
