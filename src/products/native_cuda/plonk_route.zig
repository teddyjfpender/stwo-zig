//! Plonk policy for the shared Native CUDA proof lifecycle.

const std = @import("std");
const stwo = @import("stwo_native_cuda");
const cli = @import("cli.zig");

pub const cuda = stwo.integrations.native_cuda.plonk;
pub const application = "plonk";
pub const protocol_name = cli.plonk_protocol_name;
...
pub fn verify(
    ...
    try stwo.examples.plonk.verify(
        allocator,
        pcs_config,
        geometry.statement,
        proof,
...
test "Plonk route seals the production protocol" {
