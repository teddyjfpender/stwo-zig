//! Reusable host authority for canonical state-machine proof inputs.
...
pub const Pack = struct {
    ...
    coefficient_log_sizes: [geometry_mod.coefficient_log_count]u32,
...
test "canonical state-machine ingress is exact and reusable" {
