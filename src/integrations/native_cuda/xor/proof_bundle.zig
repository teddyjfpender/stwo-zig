//! XOR statement policy for the shared one-read resident proof bundle.
...
const Descriptor = struct {
    ...
    pub fn fixedHeader(
        ...
        header[4] = geometry.statement.log_size;
        header[5] = geometry.statement.log_step;
...
test "XOR bundle preserves exact four-tree wire cardinalities" {
    ...
    const geometry = try geometry_mod.admit(
        .{ .log_size = 16, .log_step = 3, .offset = 0x1_0000_0005 },
