//! Native Blake statement policy for the shared transcript schedule.
...
pub const Schedule = struct {
    ...
    pub fn init(geometry: geometry_mod.Geometry) !Schedule {
        ...
        try seed.mix(geometry.statement.n_rounds);
...
test "Blake schedule binds rows rounds and operation order" {
