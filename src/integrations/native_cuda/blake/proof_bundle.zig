//! Native Blake header policy for the shared resident proof bundle.
...
const Descriptor = struct {
    ...
    pub fn fixedHeader(
        ...
        header[5] = geometry.statement.n_rounds;
        ...
        header[13] = try shared.u32Count(
            geometry.fri_tree_count,
        );
        header[14] = try shared.u32Count(
...
test "Blake bundle preserves exact CPU proof cardinalities" {
    ...
    try std.testing.expectEqual(@as(u32, 10), bundle.static_header[5]);
