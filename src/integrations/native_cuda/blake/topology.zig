//! Native Blake aliases for the shared uniform proof topology.
...
test "Blake topology opens main composition and every FRI tree" {
    ...
    try std.testing.expectEqual(@as(u32, 968), quotient.source_count);
