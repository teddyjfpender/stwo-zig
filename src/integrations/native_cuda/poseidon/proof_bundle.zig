//! Native Poseidon header policy for the shared resident proof bundle.
...
const Descriptor = struct {
    ...
    pub fn fixedHeader(
        ...
        header[4] = geometry.log_n_rows;
        header[5] = geometry.statement.log_n_instances;
...
test "Poseidon bundle preserves exact CPU proof cardinalities" {
