//! Verifier-rerecorded composition capture for a campaign canonical-empty wrapper.
//!
...
const CAPTURE_DOMAIN =
    "stwo-zig/common-canonical-empty-campaign-composition-capture/v2\x00";
...
fn validateTransaction(
    ...
    if (session.source_kind != .canonical_empty_campaign_v2 or
