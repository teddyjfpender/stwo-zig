...
const Writer = struct {
    ...
    fn mix(self: Writer, context: Context, source: Source, item: usize, count: usize) !void {
    ...
    fn mixWords(self: Writer, context: Context, source: Source, item: usize, values: []const u32) !void {
    ...
    fn mixCanonicalWords(self: Writer, context: Context, source: Source, item: usize, values: []const u32) !void {
    ...
    fn mixDigest(self: Writer, context: Context, source: Source, digest: [32]u8) !void {
    ...
    fn draw(self: Writer, context: Context, kind: Draw, item: usize, count: usize) !void {
        try self.list.append(self.allocator, .{
            .context = context,
            .effect = .draw,
            .draw = kind,
    ...
    fn pow(self: Writer, context: Context, item: u32, bits: u32) !void {
        try self.list.append(self.allocator, .{
            .context = context,
            .effect = .pow,
            .payload_words = 4,
