...
pub const statementClaim = frontend.recursion.detached_segment_public_inputs_v1.statementClaim;
pub const emitStatementTerms = frontend.recursion.detached_segment_public_inputs_v1.emitStatementTerms;
pub const verifyStatementClaim = frontend.recursion.detached_segment_public_inputs_v1.verifyStatementClaim;
