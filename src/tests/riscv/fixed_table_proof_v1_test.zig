...
const air = @import("stwo_riscv_frontend").testing.component_proof.program_commitment;
const interaction = @import("stwo_riscv_frontend").testing.component_proof.program_interaction;
const fixed = @import("stwo_riscv_frontend").testing.component_proof.fixed_program_table;
const Component = @import("stwo_riscv_frontend").testing.component_proof.trace_component.RiscVTraceComponent;
