...
| `load_store` | 50 | 311 → 309 | 2 | 63 | 17 / 9 / 36 | 3 / 1 / 1 / 3 | 1 / 1 | `registers_state`×2, `memory_access`×6, `program_access`×1, `range_check_20`×4, `range_check_8_8`×1, `range_check_m31`×3 |
...
| **Independent-family sum / maximum** | **646** | **3058 → 3056** | **2** | **545** | **243 / 156 / 624** | **3 / 2 / 2 / 3** | **1 / 1** | — |
